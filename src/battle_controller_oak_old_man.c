...
static const u8 sText_OakNoRunningFromATrainer[] = _("OAK: No! Non si scappa\nda una lotta con un ALLENATORE!\p");
static const u8 sText_TheTrainerThat[] = _("Vince l'ALLENATORE che manda KO\ni POKéMON dell'altro ALLENATORE\lportandogli i PS a “0.”\p");
static const u8 sText_TryBattling[] = _("Ma invece di parlarne,\nimparerai di più provando.\pLotta e vedrai da te.\p");
static const u8 sText_WinEarnsPrizeMoney[] = _("OAK: Hm! Ottimo!\pSe vinci, guadagni soldi,\ne i tuoi POKéMON crescono!\pLotta con altri ALLENATORI e\nrendi forti i POKéMON!\p");
static const u8 gText_WhatWillOldManDo[] = _("Cosa farà il\nvecchio?");
