...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNALREADYASLEEP]                    = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} dorme già!"),
    ...
    [STRINGID_ITHURTCONFUSION]                      = COMPOUND_STRING("Si è ferito da solo nella confusione!"),
    ...
    [STRINGID_TOXICSPIKESBADLYPOISONED]             = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} è gravemente avvelenato!"),
    ...
    [STRINGID_PKMNHURTBYFROSTBITE]                  = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} soffre per il congelamento!"),
    [STRINGID_PKMNGOTFROSTBITE]                     = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX} si è congelato!"),
    [STRINGID_PKMNSITEMHEALEDFROSTBITE]             = COMPOUND_STRING("{B_LAST_ITEM} di {B_SCR_NAME_WITH_PREFIX} ne ha curato il congelamento!"),
    ...
    [STRINGID_PKMNFROSTBITEHEALED]                  = COMPOUND_STRING("Il congelamento di {B_SCR_NAME_WITH_PREFIX} è stato curato!"),
    [STRINGID_PKMNFROSTBITEHEALEDBY]                = COMPOUND_STRING("{B_CURRENT_MOVE} di {B_SCR_NAME_WITH_PREFIX} ne ha curato il congelamento!"),
