...
static const struct RegionMapLocation sRegionMapEntries_Johto[] = {
    [MAPSEC_VIOLET_CITY]       = { 7,  5,  1, 1, COMPOUND_STRING("VIOLETTA") },
    [MAPSEC_AZALEA_TOWN]       = { 6,  12, 1, 1, COMPOUND_STRING("AZALEA") },
    [MAPSEC_GOLDENROD_CITY]    = { 5,  7,  1, 2, COMPOUND_STRING("FIORDARGENTO") },
    [MAPSEC_ECRUTEAK_CITY]     = { 6,  3,  1, 1, COMPOUND_STRING("AMARANTOPO") },
    [MAPSEC_OLIVINE_CITY]      = { 3,  6,  1, 1, COMPOUND_STRING("OLIVINPOLI") },
    [MAPSEC_CIANWOOD_CITY]     = { 1,  9,  1, 1, COMPOUND_STRING("FIORLISOPOLI") },
    [MAPSEC_SAFARI_ZONE_GATE]  = { 0,  7,  1, 1, COMPOUND_STRING("INGRESSO ZONA SAFARI") },
    [MAPSEC_MAHOGANY_TOWN]     = { 9,  3,  1, 1, COMPOUND_STRING("MOGANIAPOLI") },
    [MAPSEC_BLACKTHORN_CITY]   = { 12, 3,  1, 1, COMPOUND_STRING("SPINAVETRO") },
    [MAPSEC_CHERRYGROVE_CITY]  = { 9,  11, 1, 1, COMPOUND_STRING("CILIANWOOD") },
    [MAPSEC_NEW_BARK_TOWN]     = { 13, 11, 1, 1, COMPOUND_STRING("FIORNETO") },
    [MAPSEC_INDIGO_PLATEAU]    = { 16, 2,  1, 2, COMPOUND_STRING("ALTOPIANO INDIGO") },
    [MAPSEC_BATTLE_FRONTIER]   = { 12, 14, 1, 1, COMPOUND_STRING("PARCO LOTTA") },
    [MAPSEC_ROUTE_26]          = { 16, 8,  1, 4, COMPOUND_STRING("PERCORSO 26") },
    [MAPSEC_ROUTE_27]          = { 14, 11, 3, 1, COMPOUND_STRING("PERCORSO 27") },
    [MAPSEC_ROUTE_28]          = { 15, 7,  1, 1, COMPOUND_STRING("PERCORSO 28") },
    [MAPSEC_ROUTE_29]          = { 10, 11, 3, 1, COMPOUND_STRING("PERCORSO 29") },
    [MAPSEC_ROUTE_30]          = { 9,  6,  1, 5, COMPOUND_STRING("PERCORSO 30") },
    [MAPSEC_ROUTE_31]          = { 8,  5,  2, 1, COMPOUND_STRING("PERCORSO 31") },
    [MAPSEC_ROUTE_32]          = { 7,  6,  1, 5, COMPOUND_STRING("PERCORSO 32") },
    [MAPSEC_ROUTE_33]          = { 7,  12, 1, 1, COMPOUND_STRING("PERCORSO 33") },
    [MAPSEC_ROUTE_34]          = { 5,  9,  1, 2, COMPOUND_STRING("PERCORSO 34") },
    [MAPSEC_ROUTE_35]          = { 5,  6,  1, 1, COMPOUND_STRING("PERCORSO 35") },
    [MAPSEC_ROUTE_36]          = { 6,  5,  1, 1, COMPOUND_STRING("PERCORSO 36") },
    [MAPSEC_ROUTE_37]          = { 6,  4,  1, 1, COMPOUND_STRING("PERCORSO 37") },
    [MAPSEC_ROUTE_38]          = { 4,  3,  2, 1, COMPOUND_STRING("PERCORSO 38") },
    [MAPSEC_ROUTE_39]          = { 3,  3,  1, 3, COMPOUND_STRING("PERCORSO 39") },
    [MAPSEC_ROUTE_40]          = { 2,  6,  1, 3, COMPOUND_STRING("PERCORSO 40") },
    [MAPSEC_ROUTE_41]          = { 2,  9,  1, 1, COMPOUND_STRING("PERCORSO 41") },
    [MAPSEC_ROUTE_42]          = { 7,  3,  2, 1, COMPOUND_STRING("PERCORSO 42") },
    [MAPSEC_ROUTE_43]          = { 9,  2,  1, 1, COMPOUND_STRING("PERCORSO 43") },
    [MAPSEC_ROUTE_44]          = { 10, 3,  2, 1, COMPOUND_STRING("PERCORSO 44") },
    [MAPSEC_ROUTE_45]          = { 12, 4,  1, 5, COMPOUND_STRING("PERCORSO 45") },
    [MAPSEC_ROUTE_46]          = { 11, 8,  1, 3, COMPOUND_STRING("PERCORSO 46") },
    [MAPSEC_ROUTE_47]          = { 0,  9,  1, 1, COMPOUND_STRING("PERCORSO 47") },
    [MAPSEC_ROUTE_48]          = { 0,  8,  1, 1, COMPOUND_STRING("PERCORSO 48") },
    [MAPSEC_SAFARI_ZONE]       = { 0,  6,  1, 1, COMPOUND_STRING("ZONA SAFARI") },
    [MAPSEC_VICTORY_ROAD_HNS]  = { 16, 4,  1, 4, COMPOUND_STRING("VIA VITTORIA") },
    [MAPSEC_PALLET_TOWN]       = { 19, 11, 1, 1, COMPOUND_STRING("BIANCAVILLA") },
    [MAPSEC_VIRIDIAN_CITY]     = { 19, 7,  1, 1, COMPOUND_STRING("SMERALDOPOLI") },
    [MAPSEC_PEWTER_CITY]       = { 19, 2,  1, 1, COMPOUND_STRING("PLUMBEOPOLI") },
    [MAPSEC_CERULEAN_CITY]     = { 24, 2,  1, 1, COMPOUND_STRING("CELESTOPOLI") },
    [MAPSEC_LAVENDER_TOWN]     = { 27, 5,  1, 1, COMPOUND_STRING("LAVANDONIA") },
    [MAPSEC_VERMILION_CITY]    = { 24, 7,  1, 1, COMPOUND_STRING("ARANCIONOPOLI") },
    [MAPSEC_CELADON_CITY]      = { 22, 5,  1, 1, COMPOUND_STRING("AZZURROPOLI") },
    [MAPSEC_FUCHSIA_CITY]      = { 24, 11, 1, 1, COMPOUND_STRING("FUCHSIA") },
    [MAPSEC_SOUTHERN_ISLAND]   = { 9,  14, 1, 1, COMPOUND_STRING("ISOLA MERIDIONALE") },
    [MAPSEC_FARAWAY_ISLAND]    = { 9,  14, 1, 1, COMPOUND_STRING("ISOLA LONTANA") },
    [MAPSEC_BIRTH_ISLAND]      = { 9,  14, 1, 1, COMPOUND_STRING("ISOLA NASCITA") },
    [MAPSEC_CINNABAR_ISLAND]   = { 19, 13, 1, 1, COMPOUND_STRING("ISOLA CANNELLA") },
    [MAPSEC_SAFFRON_CITY]      = { 24, 5,  1, 1, COMPOUND_STRING("ZAFFERANO") },
    [MAPSEC_ROUTE_1]           = { 19, 8,  1, 3, COMPOUND_STRING("PERCORSO 1") },
    [MAPSEC_ROUTE_2]           = { 19, 3,  1, 4, COMPOUND_STRING("PERCORSO 2") },
    [MAPSEC_ROUTE_3]           = { 20, 2,  2, 1, COMPOUND_STRING("PERCORSO 3") },
    [MAPSEC_ROUTE_4]           = { 21, 2,  1, 1, COMPOUND_STRING("PERCORSO 4") },
    [MAPSEC_ROUTE_5]           = { 24, 3,  1, 2, COMPOUND_STRING("PERCORSO 5") },
    [MAPSEC_ROUTE_6]           = { 24, 6,  1, 1, COMPOUND_STRING("PERCORSO 6") },
    [MAPSEC_ROUTE_7]           = { 23, 5,  1, 1, COMPOUND_STRING("PERCORSO 7") },
    [MAPSEC_ROUTE_8]           = { 25, 5,  2, 1, COMPOUND_STRING("PERCORSO 8") },
    [MAPSEC_ROUTE_9]           = { 25, 2,  3, 1, COMPOUND_STRING("PERCORSO 9") },
    [MAPSEC_ROUTE_10]          = { 27, 3,  1, 1, COMPOUND_STRING("PERCORSO 10") },
    [MAPSEC_ROUTE_11]          = { 25, 7,  2, 1, COMPOUND_STRING("PERCORSO 11") },
    [MAPSEC_ROUTE_12]          = { 27, 6,  1, 4, COMPOUND_STRING("PERCORSO 12") },
    [MAPSEC_ROUTE_13]          = { 26, 10, 2, 1, COMPOUND_STRING("PERCORSO 13") },
    [MAPSEC_ROUTE_14]          = { 26, 11, 1, 1, COMPOUND_STRING("PERCORSO 14") },
    [MAPSEC_ROUTE_15]          = { 25, 11, 1, 1, COMPOUND_STRING("PERCORSO 15") },
    [MAPSEC_ROUTE_16]          = { 21, 5,  1, 1, COMPOUND_STRING("PERCORSO 16") },
    [MAPSEC_ROUTE_17]          = { 21, 6,  1, 6, COMPOUND_STRING("PERCORSO 17") },
    [MAPSEC_ROUTE_18]          = { 22, 11, 2, 1, COMPOUND_STRING("PERCORSO 18") },
    [MAPSEC_ROUTE_19]          = { 22, 12, 3, 2, COMPOUND_STRING("PERCORSO 19") },
    [MAPSEC_ROUTE_20]          = { 20, 13, 2, 1, COMPOUND_STRING("PERCORSO 20") },
    [MAPSEC_ROUTE_21]          = { 19, 12, 1, 1, COMPOUND_STRING("PERCORSO 21") },
    [MAPSEC_ROUTE_22]          = { 17, 7,  2, 1, COMPOUND_STRING("PERCORSO 22") },
    [MAPSEC_ROUTE_24]          = { 24, 0,  1, 2, COMPOUND_STRING("PERCORSO 24") },
    [MAPSEC_ROUTE_25]          = { 25, 0,  1, 1, COMPOUND_STRING("PERCORSO 25") },
    [MAPSEC_VIRIDIAN_FOREST]   = { 19, 4,  1, 2, COMPOUND_STRING("FORESTA DI VIRIDIAN") },
    [MAPSEC_MT_MOON]           = { 22, 2,  1, 1, COMPOUND_STRING("MT. MOON") },
    [MAPSEC_DIGLETTS_CAVE]     = { 20, 3,  6, 4, COMPOUND_STRING("GROTTA DIGLETT") },
    [MAPSEC_ROCKET_HIDEOUT_HNS] = { 9,  3,  1, 1, COMPOUND_STRING("NASCONDIGLIO ROCKET") },
    [MAPSEC_ROCK_TUNNEL]       = { 27, 3,  1, 1, COMPOUND_STRING("GALLERIA ROCCIA") },
    [MAPSEC_SEAFOAM_ISLANDS]   = { 22, 13, 1, 1, COMPOUND_STRING("ISOLE SPUMA") },
    [MAPSEC_CERULEAN_CAVE]     = { 23, 1,  1, 1, COMPOUND_STRING("GROTTA CELESTE") },
    [MAPSEC_POWER_PLANT]       = { 27, 3,  1, 1, COMPOUND_STRING("CENTRALE ELETTRICA") },
    [MAPSEC_DARK_CAVE]         = { 10, 5,  1, 1, COMPOUND_STRING("GROTTA BUIO") },
    [MAPSEC_UNION_CAVE]        = { 7,  11, 1, 2, COMPOUND_STRING("GROTTA UNION") },
    [MAPSEC_ILEX_FOREST]       = { 5,  11, 1, 2, COMPOUND_STRING("FORESTA ILEX") },
    [MAPSEC_NATIONAL_PARK]     = { 5,  5,  1, 1, COMPOUND_STRING("PARCO NAZIONALE") },
    [MAPSEC_WHIRL_ISLANDS]     = { 2,  9,  1, 1, COMPOUND_STRING("ISOLE VORTICE") },
    [MAPSEC_CLIFF_CAVE]        = { 0,  9,  1, 1, COMPOUND_STRING("GROTTA DIRUPO") },
    [MAPSEC_MT_MORTAR]         = { 10, 3,  1, 1, COMPOUND_STRING("MT MORTAR") },
    [MAPSEC_LAKE_OF_RAGE]      = { 9,  1,  1, 1, COMPOUND_STRING("LAGO D'IRA") },
    [MAPSEC_ICE_PATH]          = { 11, 2,  2, 1, COMPOUND_STRING("VIA GHIACCIO") },
    [MAPSEC_MT_SILVER]         = { 14, 7,  1, 1, COMPOUND_STRING("MT. ARGENTO") },
    [MAPSEC_SNOWSWEPT_CAVERN]  = { 14, 6,  1, 1, COMPOUND_STRING("CAVERNA NEVOSA") },
    [MAPSEC_ROUTE_49]          = { 14, 6,  1, 1, COMPOUND_STRING("PERCORSO 49") },
    [MAPSEC_NEW_SINJOH]        = { 14, 5,  1, 1, COMPOUND_STRING("NUOVA SINJOH") },
    [MAPSEC_ROUTE_50]          = { 14, 4,  1, 1, COMPOUND_STRING("PERCORSO 50") },
    [MAPSEC_SINJOH_RUINS]      = { 14, 3,  1, 1, COMPOUND_STRING("ROVINE SINJOH") },
    [MAPSEC_TOHJO_FALLS]       = { 14, 10, 1, 1, COMPOUND_STRING("CASCATE TOHJO") },
    [MAPSEC_SPROUT_TOWER]      = { 7,  5,  1, 1, COMPOUND_STRING("TORRE SPROUT") },
    [MAPSEC_SLOWPOKE_WELL]     = { 6,  12, 1, 1, COMPOUND_STRING("POZZO SLOWPOKE") },
    [MAPSEC_BURNED_TOWER]      = { 6,  3,  1, 1, COMPOUND_STRING("TORRE BRUCIATA") },
    [MAPSEC_TIN_TOWER]         = { 6,  2,  1, 1, COMPOUND_STRING("TORRE DI LATTONE") },
    [MAPSEC_DRAGONS_DEN]       = { 12, 2,  1, 1, COMPOUND_STRING("TANA DRAGO") },
    [MAPSEC_RUINS_OF_ALPH]     = { 6,  6,  1, 1, COMPOUND_STRING("ROVINE D'ALPH") },
    [MAPSEC_SS_AQUA]           = { 9,  14, 10, 1, COMPOUND_STRING("S.S. AQUA") },
    [MAPSEC_EMBEDDED_TOWER]    = { 1,  10, 1, 1, COMPOUND_STRING("TORRE INCASTRATA") },
    [MAPSEC_OLIVINE_LIGHTHOUSE] = { 3, 6,  1, 1, COMPOUND_STRING("FARO") },
    [MAPSEC_TRAINER_HILL]      = { 2,  5,  1, 1, COMPOUND_STRING("COLLINA ALLENATORI") },
    [MAPSEC_MELEMELE_ISLAND]   = { 26, 13, 1, 1, COMPOUND_STRING("ISOLA MELEMELE") },
    [MAPSEC_AKALA_ISLAND]     = { 27, 12, 1, 1, COMPOUND_STRING("ISOLA AKALA") },
    [MAPSEC_ULAULA_ISLAND]    = { 27, 13, 1, 1, COMPOUND_STRING("ISOLA ULA'ULA") },
    [MAPSEC_PONI_ISLAND]      = { 25, 13, 1, 1, COMPOUND_STRING("ISOLA PONI") },
    [MAPSEC_ALOLA_OCEAN]      = { 25, 12, 1, 1, COMPOUND_STRING("MAR DI ALOLA") },
    [MAPSEC_AKALA_CAVE]       = { 27, 14, 1, 1, COMPOUND_STRING("GROTTA AKALA") },
    [MAPSEC_AKALA_FOREST]     = { 27, 11, 1, 1, COMPOUND_STRING("FORESTA DI AKALA") },
    [MAPSEC_PONI_CAVE]        = { 25, 14, 1, 1, COMPOUND_STRING("GROTTA PONI") },
    [MAPSEC_ULAULA_CAVE]     = { 26, 14, 1, 1, COMPOUND_STRING("GROTTA ULA'ULA") },
    [MAPSEC_ULAULA_CAVE_2]   = { 26, 12, 1, 1, COMPOUND_STRING("GROTTA ULA'ULA") },
};
#endif
