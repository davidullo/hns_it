...
static const struct RegionMapLocation sRegionMapEntries_Johto[] = {
    [MAPSEC_VIOLET_CITY]       = { 7,  5,  1, 1, COMPOUND_STRING("VIOLAPOLI") },
    [MAPSEC_AZALEA_TOWN]       = { 6,  12, 1, 1, COMPOUND_STRING("AZALINA") },
    [MAPSEC_GOLDENROD_CITY]    = { 5,  7,  1, 2, COMPOUND_STRING("FIORDOROPOLI") },
    [MAPSEC_ECRUTEAK_CITY]     = { 6,  3,  1, 1, COMPOUND_STRING("AMARANTOPOLI") },
    [MAPSEC_OLIVINE_CITY]      = { 3,  6,  1, 1, COMPOUND_STRING("OLIVINOPOLI") },
    [MAPSEC_CIANWOOD_CITY]     = { 1,  9,  1, 1, COMPOUND_STRING("FIORLISOPOLI") },
    [MAPSEC_SAFARI_ZONE_GATE]  = { 0,  7,  1, 1, COMPOUND_STRING("INGRESSO SAFARI") },
    [MAPSEC_MAHOGANY_TOWN]     = { 9,  3,  1, 1, COMPOUND_STRING("MOGANIA") },
    [MAPSEC_BLACKTHORN_CITY]   = { 12, 3,  1, 1, COMPOUND_STRING("EBANOPOLI") },
    [MAPSEC_CHERRYGROVE_CITY]  = { 9,  11, 1, 1, COMPOUND_STRING("FIORPESCOPOLI") },
    [MAPSEC_NEW_BARK_TOWN]     = { 13, 11, 1, 1, COMPOUND_STRING("BORGO FOGLIANOVA") },
    [MAPSEC_INDIGO_PLATEAU]    = { 16, 2,  1, 2, COMPOUND_STRING("ALTOPIANO BLU") },
    ...
    [MAPSEC_SAFARI_ZONE]       = { 0,  6,  1, 1, COMPOUND_STRING("ZONE SAFARI") },
    ...
    [MAPSEC_VERMILION_CITY]    = { 24, 7,  1, 1, COMPOUND_STRING("ARANCIOPOLI") },
    [MAPSEC_CELADON_CITY]      = { 22, 5,  1, 1, COMPOUND_STRING("AZZURROPOLI") },
    [MAPSEC_FUCHSIA_CITY]      = { 24, 11, 1, 1, COMPOUND_STRING("FUCSIAPOLI") },
    [MAPSEC_SOUTHERN_ISLAND]   = { 9,  14, 1, 1, COMPOUND_STRING("ISOLA REMOTA") },
    [MAPSEC_FARAWAY_ISLAND]    = { 9,  14, 1, 1, COMPOUND_STRING("ISOLA SUPREMA") },
    [MAPSEC_BIRTH_ISLAND]      = { 9,  14, 1, 1, COMPOUND_STRING("ISOLA MATERNA") },
    [MAPSEC_CINNABAR_ISLAND]   = { 19, 13, 1, 1, COMPOUND_STRING("ISOLA CANNELLA") },
    [MAPSEC_SAFFRON_CITY]      = { 24, 5,  1, 1, COMPOUND_STRING("ZAFFERANOPOLI") },
    ...
    [MAPSEC_VIRIDIAN_FOREST]   = { 19, 4,  1, 2, COMPOUND_STRING("BOSCO SMERALDO") },
    [MAPSEC_MT_MOON]           = { 22, 2,  1, 1, COMPOUND_STRING("MONTE LUNA") },
    [MAPSEC_DIGLETTS_CAVE]     = { 20, 3,  6, 4, COMPOUND_STRING("GROTTA DIGLETT") },
    [MAPSEC_ROCKET_HIDEOUT_HNS] = { 9,  3,  1, 1, COMPOUND_STRING("RIFUGIO ROCKET") },
    [MAPSEC_ROCK_TUNNEL]       = { 27, 3,  1, 1, COMPOUND_STRING("TUNNEL ROCCIOSO") },
    [MAPSEC_SEAFOAM_ISLANDS]   = { 22, 13, 1, 1, COMPOUND_STRING("ISOLE SPUMARINE") },
    ...
    [MAPSEC_DARK_CAVE]         = { 10, 5,  1, 1, COMPOUND_STRING("GROTTA SCURA") },
    [MAPSEC_UNION_CAVE]        = { 7,  11, 1, 2, COMPOUND_STRING("GROTTA DI MEZZO") },
    [MAPSEC_ILEX_FOREST]       = { 5,  11, 1, 2, COMPOUND_STRING("BOSCO DI LECCI") },
    [MAPSEC_NATIONAL_PARK]     = { 5,  5,  1, 1, COMPOUND_STRING("PARCO NAZIONALE") },
    [MAPSEC_WHIRL_ISLANDS]     = { 2,  9,  1, 1, COMPOUND_STRING("ISOLE VORTICOSE") },
    [MAPSEC_CLIFF_CAVE]        = { 0,  9,  1, 1, COMPOUND_STRING("GROTTA FALESIA") },
    [MAPSEC_MT_MORTAR]         = { 10, 3,  1, 1, COMPOUND_STRING("MONTE SCODELLA") },
    [MAPSEC_LAKE_OF_RAGE]      = { 9,  1,  1, 1, COMPOUND_STRING("LAGO D'IRA") },
    [MAPSEC_ICE_PATH]          = { 11, 2,  2, 1, COMPOUND_STRING("VIA GELATA") },
    [MAPSEC_MT_SILVER]         = { 14, 7,  1, 1, COMPOUND_STRING("MONTE ARGENTO") },
    [MAPSEC_SNOWSWEPT_CAVERN]  = { 14, 6,  1, 1, COMPOUND_STRING("SNOWSWEPT CAVERN") },
    [MAPSEC_ROUTE_49]          = { 14, 6,  1, 1, COMPOUND_STRING("MT049") },
    [MAPSEC_NEW_SINJOH]        = { 14, 5,  1, 1, COMPOUND_STRING("REGIONE") },
    [MAPSEC_ROUTE_50]          = { 14, 4,  1, 1, COMPOUND_STRING("COMPARSE MASSICCE") },
    ...
    [MAPSEC_TIN_TOWER]         = { 6,  2,  1, 1, COMPOUND_STRING("TORRE CAMPANA") },
    [MAPSEC_DRAGONS_DEN]       = { 12, 2,  1, 1, COMPOUND_STRING("DRAGON'S DEN") },
    [MAPSEC_RUINS_OF_ALPH]     = { 6,  6,  1, 1, COMPOUND_STRING("ROVINE D'ALFA") },
    [MAPSEC_SS_AQUA]           = { 9,  14, 10, 1, COMPOUND_STRING("S.S. AQUA") },
    [MAPSEC_EMBEDDED_TOWER]    = { 1,  10, 1, 1, COMPOUND_STRING("TORRE OCCULTA") },
    [MAPSEC_OLIVINE_LIGHTHOUSE] = { 3, 6,  1, 1, COMPOUND_STRING("FARO DI OLIVINOPOLI") },
    [MAPSEC_TRAINER_HILL]      = { 2,  5,  1, 1, COMPOUND_STRING("MONTE ALLENATORI") },
    [MAPSEC_MELEMELE_ISLAND]   = { 26, 13, 1, 1, COMPOUND_STRING("PASSIMIAN") },
    [MAPSEC_AKALA_ISLAND]     = { 27, 12, 1, 1, COMPOUND_STRING("LANTURN") },
    [MAPSEC_ULAULA_ISLAND]    = { 27, 13, 1, 1, COMPOUND_STRING("TORKOAL") },
    [MAPSEC_PONI_ISLAND]      = { 25, 13, 1, 1, COMPOUND_STRING("ELENCO DI ZONE PER") },
    [MAPSEC_ALOLA_OCEAN]      = { 25, 12, 1, 1, COMPOUND_STRING("MELEMELE SEA") },
    [MAPSEC_AKALA_CAVE]       = { 27, 14, 1, 1, COMPOUND_STRING("ALOLA") },
    [MAPSEC_AKALA_FOREST]     = { 27, 11, 1, 1, COMPOUND_STRING("ALOLA") },
    [MAPSEC_PONI_CAVE]        = { 25, 14, 1, 1, COMPOUND_STRING("ALOLA") },
    [MAPSEC_ULAULA_CAVE]     = { 26, 14, 1, 1, COMPOUND_STRING("MT. LANIKALA") },
    [MAPSEC_ULAULA_CAVE_2]   = { 26, 12, 1, 1, COMPOUND_STRING("ALOLA") },
};
#endif
