...
static const u8 sText_BigGuy[] = _("Grande");
static const u8 sText_BigGirl[] = _("Grande");
static const u8 sText_Son[] = _("figlio");
static const u8 sText_Daughter[] = _("figlia");
static const u8 sText_99TimesPlus[] = _("99 volte +");
static const u8 sText_1MinutePlus[] = _("1 minuto +");
...
static const u8 *const sScrollableMultichoiceOptions[][MAX_SCROLL_MULTI_LENGTH] =
{
    ...
    [SCROLL_MULTI_GLASS_WORKSHOP_VENDOR] =
    {
        ...
        COMPOUND_STRING("SEDIA GRAZIOSA"),
        COMPOUND_STRING("SCRIVANIA CARINA"),
        gText_Exit
    },
    [SCROLL_MULTI_POKEMON_FAN_CLUB_RATER] =
    {
        COMPOUND_STRING("0 pt"),
        COMPOUND_STRING("10 pt"),
        COMPOUND_STRING("20 pt"),
        COMPOUND_STRING("30 pt"),
        COMPOUND_STRING("40 pt"),
        COMPOUND_STRING("50 pt"),
        COMPOUND_STRING("60 pt"),
        COMPOUND_STRING("70 pt"),
        COMPOUND_STRING("80 pt"),
        COMPOUND_STRING("90 pt"),
        COMPOUND_STRING("100 pt"),
        COMPOUND_STRING("?")
    },
    [SCROLL_MULTI_BF_EXCHANGE_CORNER_DECOR_VENDOR_1] =
    {
        COMPOUND_STRING("POSTER KISS{CLEAR_TO 0x5E}16BP"),
        COMPOUND_STRING("CUSCINO KISS{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("PELUCHE SMOOCHUM{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("PELUCHE TOGEPI{CLEAR_TO 0x5E}48BP"),
        COMPOUND_STRING("PELUCHE MEOWTH{CLEAR_TO 0x5E}48BP"),
        COMPOUND_STRING("PELUCHE CLEFAIRY{CLEAR_TO 0x5E}48BP"),
        COMPOUND_STRING("PELUCHE DITTO{CLEAR_TO 0x5E}48BP"),
        COMPOUND_STRING("PELUCHE CYNDAQUIL{CLEAR_TO 0x5E}80BP"),
        COMPOUND_STRING("PELUCHE CHIKORITA{CLEAR_TO 0x5E}80BP"),
        COMPOUND_STRING("PELUCHE TOTODILE{CLEAR_TO 0x5E}80BP"),
        gText_Exit
    },
    [SCROLL_MULTI_BF_EXCHANGE_CORNER_DECOR_VENDOR_2] =
    {
        COMPOUND_STRING("PELUCHE LAPRAS{CLEAR_TO 0x58}128BP"),
        COMPOUND_STRING("PELUCHE SNORLAX{CLEAR_TO 0x58}128BP"),
        COMPOUND_STRING("PELUCHE VENUSAUR{CLEAR_TO 0x58}256BP"),
        COMPOUND_STRING("PELUCHE CHARIZARD{CLEAR_TO 0x58}256BP"),
        COMPOUND_STRING("PELUCHE BLASTOISE{CLEAR_TO 0x58}256BP"),
        gText_Exit
    },
    [SCROLL_MULTI_BF_EXCHANGE_CORNER_VITAMIN_VENDOR] =
    {
        COMPOUND_STRING("PROTEINA{CLEAR_TO 0x64}1BP"),
        COMPOUND_STRING("CALCIO{CLEAR_TO 0x64}1BP"),
        COMPOUND_STRING("FERRO{CLEAR_TO 0x64}1BP"),
        COMPOUND_STRING("ZINCO{CLEAR_TO 0x64}1BP"),
        COMPOUND_STRING("CARBURANTE{CLEAR_TO 0x64}1BP"),
        COMPOUND_STRING("PS SU{CLEAR_TO 0x64}1BP"),
        gText_Exit
    },
    [SCROLL_MULTI_BF_EXCHANGE_CORNER_HOLD_ITEM_VENDOR] =
    {
        ...
        COMPOUND_STRING("FASCIA SCELTA{CLEAR_TO 0x5E}64BP"),
        COMPOUND_STRING("ROCCIA DEL RE{CLEAR_TO 0x5E}64BP"),
        COMPOUND_STRING("FOCUSBAND{CLEAR_TO 0x5E}64BP"),
        COMPOUND_STRING("SCOPOLENS{CLEAR_TO 0x5E}64BP"),
        gText_Exit
    },
    [SCROLL_MULTI_BERRY_POWDER_VENDOR] =
    {
        ...
        COMPOUND_STRING("ENERGYPOWDER{CLEAR_TO 114}{FONT_SMALL}50"),
        COMPOUND_STRING("RADICENERGIA{CLEAR_TO 114}{FONT_SMALL}80"),
        COMPOUND_STRING("ERBA VITALE{CLEAR_TO 108}{FONT_SMALL}300"),
        COMPOUND_STRING("PROTEINA{CLEAR_TO 99}{FONT_SMALL}1.000"),
        COMPOUND_STRING("FERRO{CLEAR_TO 99}{FONT_SMALL}1.000"),
        COMPOUND_STRING("CARBURANTE{CLEAR_TO 99}{FONT_SMALL}1.000"),
        COMPOUND_STRING("CALCIO{CLEAR_TO 99}{FONT_SMALL}1.000"),
        COMPOUND_STRING("ZINCO{CLEAR_TO 99}{FONT_SMALL}1.000"),
    ...
    [SCROLL_MULTI_BF_MOVE_TUTOR_1] =
    {
        ...
        COMPOUND_STRING("CONTRATTACCO{CLEAR_TO 0x4E}48BP"),
    ...
    [SCROLL_MULTI_BF_MOVE_TUTOR_2] =
    {
        ...
        COMPOUND_STRING("RUSSARE{CLEAR_TO 0x4E}24BP"),
        COMPOUND_STRING("FANGOSBERLA{CLEAR_TO 0x4E}24BP"),
        COMPOUND_STRING("COMETE{CLEAR_TO 0x4E}24BP"),
        COMPOUND_STRING("VENTOGELIDO{CLEAR_TO 0x4E}24BP"),
        COMPOUND_STRING("RESISTENZA{CLEAR_TO 0x4E}48BP"),
        COMPOUND_STRING("PSYCH UP{CLEAR_TO 0x4E}48BP"),
        COMPOUND_STRING("ICE PUNCH{CLEAR_TO 0x4E}48BP"),
        COMPOUND_STRING("TUONOPUGNO{CLEAR_TO 0x4E}48BP"),
        COMPOUND_STRING("FUOCPUGNO{CLEAR_TO 0x4E}48BP"),
        gText_Exit
    },
#if IS_HNS
        [SCROLL_MULTI_BF_MOVE_TUTOR_3] =
    {
        ...
        COMPOUND_STRING("BLAST BURN{CLEAR_TO 0x4E}64PS"),
        COMPOUND_STRING("IDROCANNONE{CLEAR_TO 0x4E}64BP"),
        gText_Exit
    },
#endif
...
static const u8 sText_NowOn[] = _("Ora su:");
