...
static const u8 sText_RivalsName[] = _("NOME RIVALE?");
...
static const u8 sText_MoveOkBack[] = _("{DPAD_NONE}MUOVI  {A_BUTTON}OK  {B_BUTTON}INDIETRO");
...
static const struct NamingScreenTemplate sPCBoxNamingTemplate =
{
    ...
    .initialPage = KBPAGE_LETTERS_UPPER,
    .unused = 19,
    .title = COMPOUND_STRING("NOME BOX?"),
};
...
static const struct NamingScreenTemplate sWaldaWordsScreenTemplate =
{
    ...
    .initialPage = KBPAGE_LETTERS_UPPER,
    .unused = 11,
    .title = COMPOUND_STRING("Digli le parole."),
};
