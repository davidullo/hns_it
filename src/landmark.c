...
static const u8 LandmarkName_MagmaHideout[] = _("NASCONDIGLIO MAGMA"); //Unused

static const struct Landmark Landmark_FlowerShop = {COMPOUND_STRING("FIORAIO"), FLAG_LANDMARK_FLOWER_SHOP};
static const struct Landmark Landmark_PetalburgWoods = {COMPOUND_STRING("BOSCO PETALBURG"), -1};
static const struct Landmark Landmark_MrBrineysCottage = {COMPOUND_STRING("CASA DEL SIGNOR BRINEY"), FLAG_LANDMARK_MR_BRINEY_HOUSE};
static const struct Landmark Landmark_AbandonedShip = {COMPOUND_STRING("NAVE ABBANDONATA"), FLAG_LANDMARK_ABANDONED_SHIP};
static const struct Landmark Landmark_SeashoreHouse = {COMPOUND_STRING("CASA SUL MARE"), FLAG_LANDMARK_SEASHORE_HOUSE};
static const struct Landmark Landmark_SlateportBeach = {COMPOUND_STRING("SPIAGGIA PORTO SELCE"), -1};
static const struct Landmark Landmark_CyclingRoad = {COMPOUND_STRING("PISTA CICLABILE"), -1};
static const struct Landmark Landmark_NewMauville = {COMPOUND_STRING("NUOVA MAUVILLE"), FLAG_LANDMARK_NEW_MAUVILLE};
static const struct Landmark Landmark_TrickHouse = {COMPOUND_STRING("CASA RAGGIRO"), FLAG_LANDMARK_TRICK_HOUSE};
static const struct Landmark Landmark_OldLadysRestShop = {COMPOUND_STRING("PUNTO RIPOSO SIGNORA"), FLAG_LANDMARK_OLD_LADY_REST_SHOP};
static const struct Landmark Landmark_Desert = {COMPOUND_STRING("DESERTO"), -1};
static const struct Landmark Landmark_WinstrateFamily = {COMPOUND_STRING("FAMIGLIA WINSTRATE"), FLAG_LANDMARK_WINSTRATE_FAMILY};
static const struct Landmark Landmark_CableCar = {COMPOUND_STRING("FUNIVIA"), -1};
static const struct Landmark Landmark_GlassWorkshop = {COMPOUND_STRING("VETRERIA"), FLAG_LANDMARK_GLASS_WORKSHOP};
static const struct Landmark Landmark_WeatherInstitute = {COMPOUND_STRING("ISTITUTO METEO"), -1};
static const struct Landmark Landmark_MeteorFalls = {COMPOUND_STRING("CASCATE METEORA"), -1};
static const struct Landmark Landmark_TunnelersRestHouse = {COMPOUND_STRING("RIFUGIO SCAVATORE"), FLAG_LANDMARK_TUNNELERS_REST_HOUSE};
static const struct Landmark Landmark_RusturfTunnel = {COMPOUND_STRING("TUNNEL RUSTURF"), -1};
static const struct Landmark Landmark_PokemonDayCare = {COMPOUND_STRING("PENSIÓN POKéMON"), FLAG_LANDMARK_POKEMON_DAYCARE};
static const struct Landmark Landmark_SafariZoneEntrance = {COMPOUND_STRING("INGRESSO ZONA SAFARI"), -1};
static const struct Landmark Landmark_MtPyre = {COMPOUND_STRING("MONTE PIRO"), -1};
static const struct Landmark Landmark_ShoalCave = {COMPOUND_STRING("GROTTA BANCO"), -1};
static const struct Landmark Landmark_SeafloorCavern = {COMPOUND_STRING("CAVERNA ABISSALE"), FLAG_LANDMARK_SEAFLOOR_CAVERN};
static const struct Landmark Landmark_GraniteCave = {COMPOUND_STRING("GROTTA GRANITO"), -1};
static const struct Landmark Landmark_OceanCurrent = {COMPOUND_STRING("CORRENTE OCEANICA"), -1};
static const struct Landmark Landmark_LanettesHouse = {COMPOUND_STRING("CASA DI LANETTE"), FLAG_LANDMARK_LANETTES_HOUSE};
static const struct Landmark Landmark_FieryPath = {COMPOUND_STRING("STRADA INFUOCATA"), FLAG_LANDMARK_FIERY_PATH};
static const struct Landmark Landmark_JaggedPass = {COMPOUND_STRING("SUPERPASS"), -1};
static const struct Landmark Landmark_BerryMastersHouse = {COMPOUND_STRING("CASA MAESTRO BACCHE"), FLAG_LANDMARK_BERRY_MASTERS_HOUSE};
static const struct Landmark Landmark_IslandCave = {COMPOUND_STRING("GROTTA ISOLA"), FLAG_LANDMARK_ISLAND_CAVE};
static const struct Landmark Landmark_DesertRuins = {COMPOUND_STRING("ROVINE DESERTO"), FLAG_LANDMARK_DESERT_RUINS};
static const struct Landmark Landmark_ScorchedSlab = {COMPOUND_STRING("LASTRA ARSA"), FLAG_LANDMARK_SCORCHED_SLAB};
static const struct Landmark Landmark_AncientTomb = {COMPOUND_STRING("TOMBA ANTICA"), FLAG_LANDMARK_ANCIENT_TOMB};
static const struct Landmark Landmark_SealedChamber = {COMPOUND_STRING("CAMERA SIGILLATA"), FLAG_LANDMARK_SEALED_CHAMBER};
static const struct Landmark Landmark_FossilManiacsHouse = {COMPOUND_STRING("CASA MANIACO FOSSILI"), FLAG_LANDMARK_FOSSIL_MANIACS_HOUSE};
static const struct Landmark Landmark_HuntersHouse = {COMPOUND_STRING("CASA DEL CACCIATORE"), FLAG_LANDMARK_HUNTERS_HOUSE};
static const struct Landmark Landmark_SkyPillar = {COMPOUND_STRING("PILASTRO CIELO"), FLAG_LANDMARK_SKY_PILLAR};
static const struct Landmark Landmark_MirageTower = {COMPOUND_STRING("TORRE MIRAGGIO"), FLAG_LANDMARK_MIRAGE_TOWER};
static const struct Landmark Landmark_AlteringCave = {COMPOUND_STRING("GROTTA MUTANTE"), FLAG_LANDMARK_ALTERING_CAVE};
static const struct Landmark Landmark_DesertUnderpass = {COMPOUND_STRING("PASSAGGIO DESERTO"), FLAG_LANDMARK_DESERT_UNDERPASS};
static const struct Landmark Landmark_TrainerHill = {COMPOUND_STRING("COLLINA ALLENATORI"), FLAG_LANDMARK_TRAINER_HILL};
