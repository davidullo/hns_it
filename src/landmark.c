...
static const struct Landmark Landmark_PetalburgWoods = {COMPOUND_STRING("BOSCO PETALO"), -1};
...
static const struct Landmark Landmark_NewMauville = {COMPOUND_STRING("CICLANOVA"), FLAG_LANDMARK_NEW_MAUVILLE};
...
static const struct Landmark Landmark_RusturfTunnel = {COMPOUND_STRING("TUNNEL MENFERRO"), -1};
...
static const struct Landmark Landmark_MtPyre = {COMPOUND_STRING("MONTE PIRA"), -1};
static const struct Landmark Landmark_ShoalCave = {COMPOUND_STRING("GROTTA ONDOSA"), -1};
static const struct Landmark Landmark_SeafloorCavern = {COMPOUND_STRING("ANTRO ABISSALE"), FLAG_LANDMARK_SEAFLOOR_CAVERN};
static const struct Landmark Landmark_GraniteCave = {COMPOUND_STRING("GROTTA PIETROSA"), -1};
...
static const struct Landmark Landmark_FieryPath = {COMPOUND_STRING("CAMMINO ARDENTE"), FLAG_LANDMARK_FIERY_PATH};
static const struct Landmark Landmark_JaggedPass = {COMPOUND_STRING("PASSO SELVAGGIO"), -1};
...
static const struct Landmark Landmark_IslandCave = {COMPOUND_STRING("GROTTA INSULARE"), FLAG_LANDMARK_ISLAND_CAVE};
static const struct Landmark Landmark_DesertRuins = {COMPOUND_STRING("ROVINE SABBIOSE"), FLAG_LANDMARK_DESERT_RUINS};
static const struct Landmark Landmark_ScorchedSlab = {COMPOUND_STRING("GROTTINO SOLARE"), FLAG_LANDMARK_SCORCHED_SLAB};
static const struct Landmark Landmark_AncientTomb = {COMPOUND_STRING("TOMBA ANTICA"), FLAG_LANDMARK_ANCIENT_TOMB};
static const struct Landmark Landmark_SealedChamber = {COMPOUND_STRING("SALA INCISA"), FLAG_LANDMARK_SEALED_CHAMBER};
...
static const struct Landmark Landmark_SkyPillar = {COMPOUND_STRING("TORRE DEI CIELI"), FLAG_LANDMARK_SKY_PILLAR};
