...
static const u8 sText_Var1AteTheVar2[] = _("{STR_VAR_1} ha mangiato\n{STR_VAR_2}.{PAUSE_UNTIL_PRESS}");
static const u8 sText_Var1HappilyAteVar2[] = _("{STR_VAR_1} ha mangiato\n{STR_VAR_2} felice.{PAUSE_UNTIL_PRESS}");
static const u8 sText_Var1DisdainfullyAteVar2[] = _("{STR_VAR_1} ha mangiato\n{STR_VAR_2} a malincuore.{PAUSE_UNTIL_PRESS}");
