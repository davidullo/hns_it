...
static const u8 gText_NumberRegistered[] = _("N. registrati");
static const u8 gText_NumberOfBattles[] = _("N. di lotte");
static const u8 gText_TrainerCloseBy[] = _("Quel TRAINER è qui vicino.\nParlagli di persona!");
static const u8 gText_Unknown[] = _("SCONOSCIUTO");
...
{
    [MATCH_CALL_OPTION_CALL]   = COMPOUND_STRING("CHIAMA"),
    [MATCH_CALL_OPTION_CHECK]  = COMPOUND_STRING("CONTROLLA"),
    [MATCH_CALL_OPTION_CANCEL] = COMPOUND_STRING("ANNULLA")
};
