...
static const u8 sText_PlayerScurriedToCenter[] = _("{PLAYER} corse al CENTRO POKéMON,\nproteggendo i POKéMON esausti e\nsvenuti da altri danni…\p");
static const u8 sText_PlayerScurriedBackHome[] = _("{PLAYER} corse a casa, proteggendo\ni POKéMON esausti e svenuti da\naltri danni…\p");
static const u8 sText_PlayerRegroupCenter[] = _("{PLAYER} corse al CENTRO POKéMON,\nper riorganizzare la strategia\ndi lotta…\p");
static const u8 sText_PlayerRegroupHome[] = _("{PLAYER} corse a casa, per ripensare\nalla strategia di lotta…\p");
