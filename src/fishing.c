...
static const u8 sText_OhABite[] = _("Oh! Abbocca!");
static const u8 sText_PokemonOnHook[] = _("Un POKéMON ha abboccato!{PAUSE_UNTIL_PRESS}");
static const u8 sText_NotEvenANibble[] = _("Nemmeno un morso…{PAUSE_UNTIL_PRESS}");
static const u8 sText_ItGotAway[] = _("È scappato…{PAUSE_UNTIL_PRESS}");
