...
static const u8 sText_DexNav_CaptureToSee[] = _("Prima cattura!");
static const u8 sText_DexNav_PressRToRegister[] = _("R PER REGISTRARE!");
static const u8 sText_DexNav_SearchForRegisteredSpecies[] = _("Cerca {STR_VAR_1}");
static const u8 sText_DexNav_NotFoundHere[] = _("Questo POKéMON non vive qui!");
static const u8 sText_ThreeQmarks[] = _("???");
static const u8 sText_SearchLevel[] = _("CERCA {LV}. {STR_VAR_1}");
static const u8 sText_MonLevel[] = _("{LV}. {STR_VAR_1}");
static const u8 sText_EggMove[] = _("MOSSA: {STR_VAR_1}");
static const u8 sText_HeldItem[] = _("{STR_VAR_1}");
static const u8 sText_StartExit[] = _("{START_BUTTON} ESCI");
