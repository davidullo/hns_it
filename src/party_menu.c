...
static const u8 sText_askText[] = _("Vuoi cambiare l'abilità di {STR_VAR_1}\nin {STR_VAR_2}?");
static const u8 sText_doneText[] = _("L'abilità di {STR_VAR_1} è\ndiventata {STR_VAR_2}!{PAUSE_UNTIL_PRESS}");
static const u8 sText_BasePointsResetToZero[] = _("I punti base di {STR_VAR_1}\nsono stati azzerati!{PAUSE_UNTIL_PRESS}");
static const u8 sText_CannotSendMonToBoxHM[] = _("Non puoi depositare quel POKéMON,\nconosce una mossa HM.{PAUSE_UNTIL_PRESS}");
static const u8 sText_CannotSendMonToBoxPartner[] = _("Non puoi depositare un POKéMON\nche non è tuo.{PAUSE_UNTIL_PRESS}");
...
{
    static const u8 sText_askText[] = _("Potrebbe alterare le statistiche di {STR_VAR_1}.\nVuoi davvero usarla?");
    static const u8 sText_doneText[] = _("Le statistiche di {STR_VAR_1} potrebbero\nessere cambiate per via di {STR_VAR_2}!{PAUSE_UNTIL_PRESS}");
    s16 *data = gTasks[taskId].data;
...
{
    static const u8 sText_doneText[] = _("Il livello Dynamax di {STR_VAR_1}\nè salito di 1!{PAUSE_UNTIL_PRESS}");
    s16 *data = gTasks[taskId].data;
...
void ItemUseCB_PokeBall(u8 taskId, TaskFunc task)
{
    ...
    static const u8 sText_MonBallWasChanged[] = _("{STR_VAR_1} è stato messo in {STR_VAR_2}.{PAUSE_UNTIL_PRESS}");
