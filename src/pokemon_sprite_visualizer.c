...
const u8 gBackAnimNames[][23 + 1] =
{
    ...
    [BACK_ANIM_SHRINK_GROW_VIBRATE]     = _("RIMPICCIOLISCI CRESCI VIBRA"),
...
const u8 gFrontAnimNames[][34] =
{
    ...
    [ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL_SLOW] = _("RIMBALZA RUOTA AI LATI PICCOLO LENTO"),
    ...
    [ANIM_SHRINK_GROW_VIBRATE]               = _("RIMPICCIOLISCI CRESCI VIBRA"),
