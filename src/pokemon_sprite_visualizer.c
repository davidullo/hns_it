...
const u8 gMoveBackgroundNames[BG_COUNT][MOVE_BACKGROUND_NAME_LENGTH] =
{
    ...
    [BG_DARK_VOID]                 = _("Vuototetro"),
    [BG_WATER]                     = _("Acqua"),
    [BG_NIGHTMARE]                 = _("Incubo"),
    [BG_LEAF_STORM]                = _("Verdebufera"),
    [BG_FIRE]                      = _("Fuoco"),
    [BG_FIRE_2]                    = _("Fire 2"),
    [BG_WATER_2]                   = _("Water 2"),
    [BG_POISON]                    = _("Veleno"),
    [BG_AEROBLAST]                 = _("Aerocolpo"),
    [BG_HURRICANE]                 = _("Tifone"),
    [BG_ELECTRIC_TERRAIN]          = _("Campo Elettrico"),
    [BG_GRASSY_TERRAIN]            = _("Campo Erboso"),
    [BG_MISTY_TERRAIN]             = _("Campo Nebbioso"),
    [BG_PSYCHIC_TERRAIN]           = _("Campo Psichico"),
    [BG_FOCUS_BLAST]               = _("Focalcolpo"),
    [BG_GUNK_SHOT]                 = _("Sporcolancio"),
    [BG_HYDRO_CANNON]              = _("Idrocannone"),
    [BG_WONDER_ROOM]               = _("Mirabilzona"),
    [BG_MAGIC_ROOM]                = _("Magicozona"),
    [BG_HYPERSPACE_FURY]           = _("Urtodimensionale"),
    [BG_BOLT_STRIKE]               = _("Lucesiluro"),
    [BG_ZMOVE_ACTIVATE]            = _("Z-Move Activate"),
    [BG_TECTONIC_RAGE]             = _("Furore della Terra"),
    ...
    [BG_NEVERENDING_NIGHTMARE]     = _("Abbraccio Spettrale"),
    [BG_WATER_PULSE]               = _("Idropulsar"),
    [BG_INFERNO_OVERDRIVE]         = _("Fiammobomba Detonante"),
    [BG_BLOOM_DOOM]                = _("Floriscoppio Sfolgorante"),
    [BG_SHATTERED_PSYCHE]          = _("Impatto Psicocinetico"),
    [BG_TWINKLE_TACKLE]            = _("Astroimpatto Fatato"),
    [BG_BLACK_HOLE_ECLIPSE]        = _("Buco Nero del Non Ritorno"),
    [BG_SOULSTEALING_7STAR_STRIKE] = _("Colpo Eptastellare Rubanima"),
    [BG_MALICIOUS_MOONSAULT]       = _("Iperschianto delle Tenebre"),
