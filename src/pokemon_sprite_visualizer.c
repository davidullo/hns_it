...
{
    [BACK_ANIM_NONE]                    = _("NESSUNO"),
    [BACK_ANIM_H_VIBRATE]               = _("VIBRA O"),
    [BACK_ANIM_H_SLIDE]                 = _("SLITT OR"),
    [BACK_ANIM_H_SPRING]                = _("H MOLLA"),
    [BACK_ANIM_H_SPRING_REPEATED]       = _("MOLLA O RIPETUTA"),
    [BACK_ANIM_SHRINK_GROW]             = _("RIMPICCIOLISCI CRESCI"),
    [BACK_ANIM_GROW]                    = _("CRESCI"),
    [BACK_ANIM_CIRCLE_COUNTERCLOCKWISE] = _("CERCHIO ANTIORARIO"),
    [BACK_ANIM_H_SHAKE]                 = _("SCUOTI O"),
    [BACK_ANIM_V_SHAKE]                 = _("SCUOTI V"),
    [BACK_ANIM_V_SHAKE_H_SLIDE]         = _("TREMA V SCORRI O"),
    [BACK_ANIM_V_STRETCH]               = _("STIRA V"),
    [BACK_ANIM_H_STRETCH]               = _("STIRA O"),
    [BACK_ANIM_GROW_STUTTER]            = _("CRESCI SCATTI"),
    [BACK_ANIM_V_SHAKE_LOW]             = _("SCUOTI GIU"),
    [BACK_ANIM_TRIANGLE_DOWN]           = _("TRIANGOLO GIU"),
    [BACK_ANIM_CONCAVE_ARC_LARGE]       = _("ARCO CONCAVO GRANDE"),
    [BACK_ANIM_CONVEX_DOUBLE_ARC]       = _("DOPPIO ARCO CONVESSO"),
    [BACK_ANIM_CONCAVE_ARC_SMALL]       = _("ARCO CONCAVO PICCOLO"),
    [BACK_ANIM_DIP_RIGHT_SIDE]          = _("CALATA DX"),
    [BACK_ANIM_SHRINK_GROW_VIBRATE]     = _("RIDUCI CRESCI VIBRA"),
    [BACK_ANIM_JOLT_RIGHT]              = _("SCATTO DX"),
    [BACK_ANIM_SHAKE_FLASH_YELLOW]      = _("TREMA LAMP GIALLO"),
    [BACK_ANIM_SHAKE_GLOW_RED]          = _("TREMA BAGLIORE ROSSO"),
    [BACK_ANIM_SHAKE_GLOW_GREEN]        = _("TREMA BAGLIORE VERDE"),
    [BACK_ANIM_SHAKE_GLOW_BLUE]         = _("TREMA BAGLIORE BLU"),
};
const u8 gFrontAnimNames[][34] =
{
    [ANIM_V_SQUISH_AND_BOUNCE]               = _("V SCHIACCIA E SALTA"),
    [ANIM_CIRCULAR_STRETCH_TWICE]            = _("STRETCH CIRCOLARE X2"),
    [ANIM_H_VIBRATE]                         = _("VIBRA O"),
    [ANIM_H_SLIDE]                           = _("SLITT OR"),
    [ANIM_V_SLIDE]                           = _("V SCIVOLA"),
    [ANIM_BOUNCE_ROTATE_TO_SIDES]            = _("SALTA RUOTA AI LATI"),
    [ANIM_V_JUMPS_H_JUMPS]                   = _("SALTA V SALTA O"),
    [ANIM_ROTATE_TO_SIDES]                   = _("RUOTA AI LATI"),
    [ANIM_ROTATE_TO_SIDES_TWICE]             = _("RUOTA AI LATI DUE VOLTE"),
    [ANIM_GROW_VIBRATE]                      = _("CRESCI VIBRA"),
    [ANIM_ZIGZAG_FAST]                       = _("ZIGZAG VELOCE"),
    [ANIM_SWING_CONCAVE]                     = _("OSCILLA CONCAVO"),
    [ANIM_SWING_CONCAVE_FAST]                = _("OSCILLA CONCAVO VELOCE"),
    [ANIM_SWING_CONVEX]                      = _("OSCILLA CONVESSO"),
    [ANIM_SWING_CONVEX_FAST]                 = _("OSCILLA CONVESSO VELOCE"),
    [ANIM_H_SHAKE]                           = _("SCUOTI O"),
    [ANIM_V_SHAKE]                           = _("SCUOTI V"),
    [ANIM_CIRCULAR_VIBRATE]                  = _("VIBRA IN CERCHIO"),
    [ANIM_TWIST]                             = _("TORCI"),
    [ANIM_SHRINK_GROW]                       = _("RIMPICCIOLISCI CRESCI"),
    [ANIM_CIRCLE_C_CLOCKWISE]                = _("CERCHIO C ORARIO"),
    [ANIM_GLOW_BLACK]                        = _("BAGLIORE NERO"),
    [ANIM_H_STRETCH]                         = _("STIRA O"),
    [ANIM_V_STRETCH]                         = _("STIRA V"),
    [ANIM_RISING_WOBBLE]                     = _("OSCILLA SALENDO"),
    [ANIM_V_SHAKE_TWICE]                     = _("SCUOTI V DUE VOLTE"),
    [ANIM_TIP_MOVE_FORWARD]                  = _("INCLINA AVANTI"),
    [ANIM_H_PIVOT]                           = _("PIVOT O"),
    [ANIM_V_SLIDE_WOBBLE]                    = _("SCIVOLO V OSC"),
    [ANIM_H_SLIDE_WOBBLE]                    = _("SCIVOLO O OSC"),
    [ANIM_V_JUMPS_BIG]                       = _("SALTO V GRANDE"),
    [ANIM_SPIN_LONG]                         = _("GIRA LUNGO"),
    [ANIM_GLOW_ORANGE]                       = _("BAGLIORE ARANC"),
    [ANIM_GLOW_RED]                          = _("BAGLIORE ROSSO"),
    [ANIM_GLOW_BLUE]                         = _("BAGLIORE BLU"),
    [ANIM_GLOW_YELLOW]                       = _("BAGLIORE GIALLO"),
    [ANIM_GLOW_PURPLE]                       = _("BAGLIORE VIOLA"),
    [ANIM_BACK_AND_LUNGE]                    = _("ASSALTO INDIETRO"),
    [ANIM_BACK_FLIP]                         = _("CAPRIOLA"),
    [ANIM_FLICKER]                           = _("SFARFALLIO"),
    [ANIM_BACK_FLIP_BIG]                     = _("CAPRIOLA AMPIA"),
    [ANIM_FRONT_FLIP]                        = _("CAPRIOLA AVANTI"),
    [ANIM_TUMBLING_FRONT_FLIP]               = _("CAPRIOLA AVANTI MULT"),
    [ANIM_FIGURE_8]                          = _("OTTO"),
    [ANIM_FLASH_YELLOW]                      = _("BALENO GIALLO"),
    [ANIM_SWING_CONCAVE_FAST_SHORT]          = _("OSCILLA CONCAVO VEL"),
    [ANIM_SWING_CONVEX_FAST_SHORT]           = _("OSCILLA CONVESSO VEL"),
    [ANIM_ROTATE_UP_SLAM_DOWN]               = _("RUOTA SU E SCHIANTO"),
    [ANIM_DEEP_V_SQUISH_AND_BOUNCE]          = _("COMPRIMI V E MOLLA"),
    [ANIM_H_JUMPS]                           = _("SALTI O"),
    [ANIM_H_JUMPS_V_STRETCH]                 = _("SALTI O ALLUNGA V"),
    [ANIM_ROTATE_TO_SIDES_FAST]              = _("RUOTA AI LATI VEL"),
    [ANIM_ROTATE_UP_TO_SIDES]                = _("RUOTA SU AI LATI"),
    [ANIM_FLICKER_INCREASING]                = _("SFARFALLIO CRESC"),
    [ANIM_TIP_HOP_FORWARD]                   = _("SALTELLO AVANTI"),
    [ANIM_PIVOT_SHAKE]                       = _("PIVOT SCUOTI"),
    [ANIM_TIP_AND_SHAKE]                     = _("PUNTA E SCUOTI"),
    [ANIM_VIBRATE_TO_CORNERS]                = _("VIBRA AGLI ANGOLI"),
    [ANIM_GROW_IN_STAGES]                    = _("CRESCI A STADI"),
    [ANIM_V_SPRING]                          = _("MOLLA V"),
    [ANIM_V_REPEATED_SPRING]                 = _("MOLLA V RIPETUTA"),
    [ANIM_SPRING_RISING]                     = _("MOLLA SALENTE"),
    [ANIM_H_SPRING]                          = _("H MOLLA"),
    [ANIM_H_REPEATED_SPRING_SLOW]            = _("MOLLA O RIP LENTA"),
    [ANIM_H_SLIDE_SHRINK]                    = _("SCIVOLO O RIDUCI"),
    [ANIM_LUNGE_GROW]                        = _("ASSALTO CRESCI"),
    [ANIM_CIRCLE_INTO_BG]                    = _("CERCHIO SU SFONDO"),
    [ANIM_RAPID_H_HOPS]                      = _("SALTI RAPIDI O"),
    [ANIM_FOUR_PETAL]                        = _("QUATTRO PETALI"),
    [ANIM_V_SQUISH_AND_BOUNCE_SLOW]          = _("SCHIACCIA E SALTA LENTO"),
    [ANIM_H_SLIDE_SLOW]                      = _("SCIVOLO O LENTO"),
    [ANIM_V_SLIDE_SLOW]                      = _("SCIVOLO V LENTO"),
    [ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL]      = _("SALTA RUOTA LATO PICCOLO"),
    [ANIM_BOUNCE_ROTATE_TO_SIDES_SLOW]       = _("SALTA RUOTA LATO LENTO"),
    [ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL_SLOW] = _("RIMBALZA RUOTA LENTO PICCOLO"),
    [ANIM_ZIGZAG_SLOW]                       = _("ZIGZAG LENTO"),
    [ANIM_H_SHAKE_SLOW]                      = _("TREMA O LENTO"),
    [ANIM_V_SHAKE_SLOW]                      = _("TREMA V LENTO"),
    [ANIM_TWIST_TWICE]                       = _("TORCI DUE VOLTE"),
    [ANIM_CIRCLE_C_CLOCKWISE_SLOW]           = _("CERCHIO ORARIO LENTO"),
    [ANIM_V_SHAKE_TWICE_SLOW]                = _("TREMA V DUE VOLTE LENTO"),
    [ANIM_V_SLIDE_WOBBLE_SMALL]              = _("SCORRI V OSCILLA PICCOLO"),
    [ANIM_V_JUMPS_SMALL]                     = _("SALTI V PICCOLO"),
    [ANIM_SPIN]                              = _("GIRA"),
    [ANIM_TUMBLING_FRONT_FLIP_TWICE]         = _("CAPRIOLA AVANTI DUE VOLTE"),
    [ANIM_DEEP_V_SQUISH_AND_BOUNCE_TWICE]    = _("SCHIACCIA V E RIMBALZA DUE VOLTE"),
    [ANIM_H_JUMPS_V_STRETCH_TWICE]           = _("SALTI O STIRA V DUE VOLTE"),
    [ANIM_V_SHAKE_BACK]                      = _("TREMA V INDIETRO"),
    [ANIM_V_SHAKE_BACK_SLOW]                 = _("TREMA V INDIETRO LENTO"),
    [ANIM_V_SHAKE_H_SLIDE_SLOW]              = _("TREMA V SCORRI O LENTO"),
    [ANIM_V_STRETCH_BOTH_ENDS_SLOW]          = _("STIRA V DUE ESTREMI LENTO"),
    [ANIM_H_STRETCH_FAR_SLOW]                = _("STIRA O LONTANO LENTO"),
    [ANIM_V_SHAKE_LOW_TWICE]                 = _("TREMA V IN BASSO DUE VOLTE"),
    [ANIM_H_SHAKE_FAST]                      = _("TREMA O VELOCE"),
    [ANIM_H_SLIDE_FAST]                      = _("SCORRI O VELOCE"),
    [ANIM_H_VIBRATE_FAST]                    = _("VIBRA O VELOCE"),
    [ANIM_H_VIBRATE_FASTEST]                 = _("VIBRAZ OR OR"),
    [ANIM_V_SHAKE_BACK_FAST]                 = _("SCUOTI INDIETRO"),
    [ANIM_V_SHAKE_LOW_TWICE_SLOW]            = _("SCUOTI GIU DUE LENTO"),
    [ANIM_V_SHAKE_LOW_TWICE_FAST]            = _("SCUOTI GIU DUE VELOCE"),
    [ANIM_CIRCLE_C_CLOCKWISE_LONG]           = _("CERCHIO C ORARIO LUNGO"),
    [ANIM_GROW_STUTTER_SLOW]                 = _("CRESCI SCATTI LENTO"),
    [ANIM_V_SHAKE_H_SLIDE]                   = _("TREMA V SCORRI O"),
    [ANIM_V_SHAKE_H_SLIDE_FAST]              = _("SCUOTI V SCORRI O VEL"),
    [ANIM_TRIANGLE_DOWN_SLOW]                = _("TRIANGOLO GIU LENTO"),
    [ANIM_TRIANGLE_DOWN]                     = _("TRIANGOLO GIU"),
    [ANIM_TRIANGLE_DOWN_TWICE]               = _("TRIANGOLO GIU DUE"),
    [ANIM_GROW]                              = _("CRESCI"),
    [ANIM_GROW_TWICE]                        = _("CRESCI DUE"),
    [ANIM_H_SPRING_FAST]                     = _("MOLLA O VELOCE"),
    [ANIM_H_SPRING_SLOW]                     = _("MOLLA O LENTO"),
    [ANIM_H_REPEATED_SPRING_FAST]            = _("MOLLA RIP O VEL"),
    [ANIM_H_REPEATED_SPRING]                 = _("MOLLA RIPETUTA"),
    [ANIM_SHRINK_GROW_FAST]                  = _("RIMPICCIOLISCI CRESCI VEL"),
    [ANIM_SHRINK_GROW_SLOW]                  = _("RIMPICCIOLISCI CRESCI LENT"),
    [ANIM_V_STRETCH_BOTH_ENDS]               = _("STIRA DUE ESTREMI"),
    [ANIM_V_STRETCH_BOTH_ENDS_TWICE]         = _("STIRA DUE ESTREMI DUE"),
    [ANIM_H_STRETCH_FAR_TWICE]               = _("STIRA O LONTANO DUE"),
    [ANIM_H_STRETCH_FAR]                     = _("STIRA O LONTANO"),
    [ANIM_GROW_STUTTER_TWICE]                = _("CRESCI SCATTI DUE"),
    [ANIM_GROW_STUTTER]                      = _("CRESCI SCATTI"),
    [ANIM_CONCAVE_ARC_LARGE_SLOW]            = _("ARCO CONCAVO GRANDE LENTO"),
    [ANIM_CONCAVE_ARC_LARGE]                 = _("ARCO CONCAVO GRANDE"),
    [ANIM_CONCAVE_ARC_LARGE_TWICE]           = _("ARCO CONCAVO GRANDE DUE"),
    [ANIM_CONVEX_DOUBLE_ARC_SLOW]            = _("DOPPIO ARCO CONVESSO LENTO"),
    [ANIM_CONVEX_DOUBLE_ARC]                 = _("DOPPIO ARCO CONVESSO"),
    [ANIM_CONVEX_DOUBLE_ARC_TWICE]           = _("DOPPIO ARCO CONVESSO DUE"),
    [ANIM_CONCAVE_ARC_SMALL_SLOW]            = _("ARCO CONCAVO PICCOLO LENTO"),
    [ANIM_CONCAVE_ARC_SMALL]                 = _("ARCO CONCAVO PICCOLO"),
    [ANIM_CONCAVE_ARC_SMALL_TWICE]           = _("ARCO CONCAVO PICCOLO DUE"),
    [ANIM_H_DIP]                             = _("IMMERGIO"),
    [ANIM_H_DIP_FAST]                        = _("IMMERGIO VELOCE"),
    [ANIM_H_DIP_TWICE]                       = _("IMMERGIO DUE"),
    [ANIM_SHRINK_GROW_VIBRATE_FAST]          = _("RIMPICCIOLISCI CRESCI VIBRA VEL"),
    [ANIM_SHRINK_GROW_VIBRATE]               = _("RIMPICCIOLISCI CRESCI"),
    [ANIM_SHRINK_GROW_VIBRATE_SLOW]          = _("RIMPICCIOLISCI CRESCI VIBRA LENT"),
    [ANIM_JOLT_RIGHT_FAST]                   = _("SCATTO DX VELOCE"),
    [ANIM_JOLT_RIGHT]                        = _("SCATTO DX"),
    [ANIM_JOLT_RIGHT_SLOW]                   = _("SCATTO DX LENTO"),
    [ANIM_SHAKE_FLASH_YELLOW_FAST]           = _("TREMA LAMP GIALLO VEL"),
    [ANIM_SHAKE_FLASH_YELLOW]                = _("TREMA LAMP GIALLO"),
    [ANIM_SHAKE_FLASH_YELLOW_SLOW]           = _("TREMA LAMP GIALLO LENTO"),
    [ANIM_SHAKE_GLOW_RED_FAST]               = _("TREMA BAGLIORE ROSSO VEL"),
    [ANIM_SHAKE_GLOW_RED]                    = _("TREMA BAGLIORE ROSSO"),
    [ANIM_SHAKE_GLOW_RED_SLOW]               = _("TREMA BAGLIORE ROSSO LENTO"),
    [ANIM_SHAKE_GLOW_GREEN_FAST]             = _("TREMA BAGLIORE VERDE VEL"),
    [ANIM_SHAKE_GLOW_GREEN]                  = _("TREMA BAGLIORE VERDE"),
    [ANIM_SHAKE_GLOW_GREEN_SLOW]             = _("TREMA BAGLIORE VERDE LENTO"),
    [ANIM_SHAKE_GLOW_BLUE_FAST]              = _("TREMA BAGLIORE BLU VEL"),
    [ANIM_SHAKE_GLOW_BLUE]                   = _("TREMA BAGLIORE BLU"),
    [ANIM_SHAKE_GLOW_BLUE_SLOW]              = _("TREMA BAGLIORE BLU LENTO"),
    [ANIM_SHAKE_GLOW_BLACK_SLOW]             = _("TREMA BAGLIORE NERO LENTO"),
    [ANIM_SHAKE_GLOW_WHITE_SLOW]             = _("TREMA BAGLIORE BIANCO LENTO"),
    [ANIM_SHAKE_GLOW_PURPLE_SLOW]            = _("TREMA BAGLIORE VIOLA LENTO"),
};
...
const u8 gMoveBackgroundNames[BG_COUNT][MOVE_BACKGROUND_NAME_LENGTH] =
{
    ...
    [BG_GHOST]                     = _("Spettro"),
    [BG_PSYCHIC]                   = _("Psico"),
    [BG_IMPACT_OPPONENT]           = _("Impatto - Avversario"),
    [BG_IMPACT_PLAYER]             = _("Impatto - Giocatore"),
    [BG_IMPACT_CONTESTS]           = _("Impatto - Gare"),
    [BG_DRILL]                     = _("Trapano"),
    [BG_DRILL_CONTESTS]            = _("Trapano - Gare"),
    [BG_HIGHSPEED_OPPONENT]        = _("Alta Vel - Avversario"),
    [BG_HIGHSPEED_PLAYER]          = _("Alta Vel - Giocatore"),
    [BG_THUNDER]                   = _("Tuono"),
    [BG_GUILLOTINE_OPPONENT]       = _("Ghigliottina - Avversario"),
    [BG_GUILLOTINE_PLAYER]         = _("Ghigliottina - Giocatore"),
    [BG_GUILLOTINE_CONTESTS]       = _("Ghigliottina - Gare"),
    [BG_ICE]                       = _("Ghiaccio"),
    [BG_COSMIC]                    = _("Cosmico"),
    [BG_IN_AIR]                    = _("In Aria"),
    [BG_SKY]                       = _("Cielo"),
    [BG_SKY_CONTESTS]              = _("Cielo - Gare"),
    [BG_AURORA]                    = _("Aurora"),
    [BG_FISSURE]                   = _("Abisso"),
    [BG_BUG_OPPONENT]              = _("Bug - Avversario"),
    [BG_BUG_PLAYER]                = _("Bug - Giocatore"),
    [BG_SOLAR_BEAM_OPPONENT]       = _("Solarraggio - Avversario"),
    [BG_SOLAR_BEAM_PLAYER]         = _("Solarraggio - Giocatore"),
    [BG_SOLAR_BEAM_CONTESTS]       = _("Solar Beam - Gare"),
    [BG_MAGMA_STORM]               = _("Magmaclisma"),
    [BG_GIGA_IMPACT_OPPONENT]      = _("Giga Impact - Avv."),
    [BG_GIGA_IMPACT_PLAYER]        = _("Giga Impact - Gioc."),
    [BG_GIGA_IMPACT_CONTESTS]      = _("Giga Impact - Gare"),
    [BG_TRICK_ROOM]                = _("Distorsione"),
    [BG_ROCK_WRECKER]              = _("Devastomasso"),
    [BG_SPACIAL_REND_OPPONENT]     = _("Spacial Rend - Avv."),
    [BG_SPACIAL_REND_PLAYER]       = _("Spacial Rend - Gioc."),
    [BG_DARK_VOID]                 = _("Vuotobuio"),
    [BG_WATER]                     = _("Acqua"),
    [BG_NIGHTMARE]                 = _("Incubo"),
    [BG_LEAF_STORM]                = _("Fogliamarcia"),
    [BG_FIRE]                      = _("Fire"),
    [BG_FIRE_2]                    = _("Fire 2"),
    ...
    [BG_ELECTRIC_TERRAIN]          = _("Elettroterreno"),
    [BG_GRASSY_TERRAIN]            = _("Erbaterreno"),
    [BG_MISTY_TERRAIN]             = _("Nebbioterreno"),
    [BG_PSYCHIC_TERRAIN]           = _("Psicoterreno"),
    [BG_FOCUS_BLAST]               = _("Focalcolpo"),
    [BG_GUNK_SHOT]                 = _("Sporcolancio"),
    [BG_HYDRO_CANNON]              = _("Idrocannone"),
    [BG_WONDER_ROOM]               = _("Mirabilzona"),
    [BG_MAGIC_ROOM]                = _("Magiczona"),
    [BG_HYPERSPACE_FURY]           = _("Ultraondasconvolte"),
    [BG_BOLT_STRIKE]               = _("Folgorcolpo"),
    [BG_ZMOVE_ACTIVATE]            = _("Attiva Mossa Z"),
    [BG_TECTONIC_RAGE]             = _("Geoforza"),
    [BG_ROCK_FIELD_DAY]            = _("Campo Roccia - Giorno"),
    [BG_ROCK_FIELD_AFTERNOON]      = _("Campo Roccia - Pomeriggio"),
    [BG_ROCK_FIELD_NIGHT]          = _("Campo Roccia - Notte"),
    [BG_ZMOVE_MOUNTAIN]            = _("Mossa Z - Montagna"),
    [BG_NEVERENDING_NIGHTMARE]     = _("Incubo Infinito"),
    [BG_WATER_PULSE]               = _("Idropulsar"),
    [BG_INFERNO_OVERDRIVE]         = _("Inferno Overdrive"),
    [BG_BLOOM_DOOM]                = _("Floridio"),
    [BG_SHATTERED_PSYCHE]          = _("Psiconda"),
    [BG_TWINKLE_TACKLE]            = _("Sbrilluccitackle"),
    [BG_BLACK_HOLE_ECLIPSE]        = _("Buco Nero Eclissi"),
    [BG_SOULSTEALING_7STAR_STRIKE] = _("Colpo Eptastellare"),
    [BG_MALICIOUS_MOONSAULT]       = _("Iperschianto Lunare"),
    [BG_CLANGOROUS_SOULBLAZE]      = _("Dracofonia Divampante"),
    [BG_SNUGGLE_FOREVER]           = _("Coccole eterne"),
    [BG_MAX_LIGHTNING]             = _("Dynasaetta"),
    [BG_GARBAGE_FALLS]             = _("Cascata Rifiuti"),
    [BG_HYPER_BEAM]                = _("Iper Raggio"),
    [BG_DYNAMAX_CANNON]            = _("Cannone Dynamax"),
    [BG_AURA_SPHERE]               = _("Forzasfera"),
    [BG_STEEL_BEAM_OPPONENT]       = _("Raggio Acciaio - Avversario"),
    [BG_STEEL_BEAM_PLAYER]         = _("Raggio Acciaio - Giocatore"),
    [BG_CHLOROBLAST]               = _("Clorofillaser"),
    [BG_RAINBOW_PLAYER]            = _("Arcobaleno - Giocatore"),
    [BG_RAINBOW_OPPONENT]          = _("Arcobaleno - Avversario"),
    [BG_SWAMP]                     = _("Palude"),
};
...
static const struct SubmenuText sSubmenuText[] =
{
    [SUBMENU_SPECIES] =
    {
        .instructions = COMPOUND_STRING("{START_BUTTON} Shiny\n{B_BUTTON} Esci  {A_BUTTON} Anim e BG$"),
        .instructionsGender = COMPOUND_STRING("{START_BUTTON} Shiny {SELECT_BUTTON} Genere\n{B_BUTTON} Esci  {A_BUTTON} Anim e BG$"),
    },

    [SUBMENU_ANIMS_BG] =
    {
        .instructions = COMPOUND_STRING("{START_BUTTON} Shiny\n{B_BUTTON} Indietro  {A_BUTTON} Coord Sprite$"),
        .instructionsGender = COMPOUND_STRING("{START_BUTTON} Shiny {SELECT_BUTTON} Genere\n{B_BUTTON} Indietro  {A_BUTTON} Coord Sprite$"),
    },
    ...
    [SUBMENU_SPRITE_COORDS] =
    {
        ...
        .instructions = COMPOUND_STRING("{START_BUTTON} Shiny\n{B_BUTTON} Indietro  {A_BUTTON} Coord Ombra$"),
        .instructionsGender = COMPOUND_STRING("{START_BUTTON} Shiny {SELECT_BUTTON} Genere\n{B_BUTTON} Indietro  {A_BUTTON} Coord Ombra$"),
#else
        .instructions = COMPOUND_STRING("{START_BUTTON} Shiny\n{B_BUTTON} Indietro  {A_BUTTON} Muovi BG$"),
        .instructionsGender = COMPOUND_STRING("{START_BUTTON} Shiny {SELECT_BUTTON} Genere\n{B_BUTTON} Indietro  {A_BUTTON} Muovi BG$"),
#endif
        .bottomLeft = COMPOUND_STRING("Coord B:\nCoord F:\nElev F:"),
    },
...
#endif
        .bottomLeft = COMPOUND_STRING("Coord X:\nCoord Y:\nDim:"),
    },
    ...
    [SUBMENU_MOVE_BACKGROUNDS] =
    {
        .instructions = COMPOUND_STRING("{START_BUTTON} Shiny\n{B_BUTTON} Indietro$"),
        .instructionsGender = COMPOUND_STRING("{START_BUTTON} Shiny {SELECT_BUTTON} Genere\n{B_BUTTON} Indietro$"),
        .bottomLeft = COMPOUND_STRING("Muovi BG:"),
    },
};
...
static void PrintInstructionsOnWindow(struct PokemonSpriteVisualizer *data)
{
    ...
    u8 textBottom[] = _("RETRO:\nFRONTE:\nBG:$");
    u8 textBottomForms[] = _("RETRO:\nFRONTE:\nBG:\nFORME:$");
...
static void UpdateYPosOffsetText(struct PokemonSpriteVisualizer *data)
{
    u8 text[34];
    u8 fontId = FONT_SMALL;
    u8 textConst[] = _("val const:");
    u8 textNew[] = _("nuovo val:");
    u8 x_const_val = 50;
    u8 x_new_text = 70;
    u8 x_new_val = 110;
    u8 y = 0;
