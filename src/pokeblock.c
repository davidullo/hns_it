...
static const u8 sText_StowCase[] = _("Riponi CASELLA.");
static const u8 sText_LvVar1[] = _("{LV}{STR_VAR_1}");
static const u8 sText_ThrowAwayVar1[] = _("Buttare via\n{STR_VAR_1}?");
...
const u8 *const gPokeblockNames[] =
{
    ...
    [PBLOCK_CLR_RED]       = COMPOUND_STRING("ROSSO {POKEBLOCK}"),
    [PBLOCK_CLR_BLUE]      = COMPOUND_STRING("BLU {POKEBLOCK}"),
    [PBLOCK_CLR_PINK]      = COMPOUND_STRING("ROSA {POKEBLOCK}"),
    [PBLOCK_CLR_GREEN]     = COMPOUND_STRING("VERDE {POKEBLOCK}"),
    [PBLOCK_CLR_YELLOW]    = COMPOUND_STRING("GIALLO {POKEBLOCK}"),
    [PBLOCK_CLR_PURPLE]    = COMPOUND_STRING("VIOLA {POKEBLOCK}"),
    [PBLOCK_CLR_INDIGO]    = COMPOUND_STRING("INDACO {POKEBLOCK}"),
    [PBLOCK_CLR_BROWN]     = COMPOUND_STRING("MARRONE {POKEBLOCK}"),
    [PBLOCK_CLR_LITE_BLUE] = COMPOUND_STRING("AZZURRO {POKEBLOCK}"),
    [PBLOCK_CLR_OLIVE]     = COMPOUND_STRING("OLIVA {POKEBLOCK}"),
    [PBLOCK_CLR_GRAY]      = COMPOUND_STRING("GRIGIO {POKEBLOCK}"),
    [PBLOCK_CLR_BLACK]     = COMPOUND_STRING("NERO {POKEBLOCK}"),
    [PBLOCK_CLR_WHITE]     = COMPOUND_STRING("BIANCO {POKEBLOCK}"),
    [PBLOCK_CLR_GOLD]      = COMPOUND_STRING("ORO {POKEBLOCK}")
};
...
static void DrawPokeblockMenuTitleText(void)
{
    ...
    PrintOnPokeblockWindow(WIN_SPICY,  COMPOUND_STRING("PICC"),  0);
    PrintOnPokeblockWindow(WIN_DRY,    COMPOUND_STRING("SEC"),    0);
    PrintOnPokeblockWindow(WIN_SWEET,  COMPOUND_STRING("DOL"),  0);
    PrintOnPokeblockWindow(WIN_BITTER, COMPOUND_STRING("AMA"), 0);
    PrintOnPokeblockWindow(WIN_SOUR,   COMPOUND_STRING("ASP"),   0);
