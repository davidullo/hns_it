...
static const u8 sText_Stats_Buttons[] = _("{A_BUTTON}CAMBIA  {DPAD_UPDOWN}MOSSE");
static const u8 sText_Stats_Buttons_Decapped[] = _("{A_BUTTON}Cambia   {DPAD_UPDOWN}Mosse");
static const u8 sText_Stats_HP[] = _("PS");
static const u8 sText_Stats_Attack[] = _("ATT");
static const u8 sText_Stats_Defense[] = _("DIF");
static const u8 sText_Stats_Speed[] = _("VEL");
static const u8 sText_Stats_SpAttack[] = _("ATT.S");
static const u8 sText_Stats_SpDefense[] = _("DIF.S");
...
static const u8 sText_Stats_CatchRate[] = _("CATTURA{0x5B}: ");
static const u8 sText_Stats_CatchRate_Legend[] = _("LEGGENDA");
static const u8 sText_Stats_CatchRate_VeryHard[] = _("DIFFICILE");
static const u8 sText_Stats_CatchRate_Difficult[] = _("IMPEgnATIVA");
static const u8 sText_Stats_CatchRate_Medium[] = _("MEDIA");
static const u8 sText_Stats_CatchRate_Relaxed[] = _("PLACIDA");
static const u8 sText_Stats_CatchRate_Easy[] = _("FACILE");
static const u8 sText_Stats_ExpYield[] = _("ESP. DATI: ");
static const u8 sText_Stats_EggCycles[] = _("PASSI UOVO:");
...
static const u8 sText_Stats_Growthrate[] = _("CRESC: ");
static const u8 sText_Stats_Friendship[] = _("AMICIZIA:");
...
static const u8 sText_Stats_MEDIUM_FAST[] = _("MED. VEL");
static const u8 sText_Stats_ERRATIC[] = _("ERRATICA");
static const u8 sText_Stats_FLUCTUATING[] = _("FLUTTUANTE");
static const u8 sText_Stats_MEDIUM_SLOW[] = _("MED. LENT");
static const u8 sText_Stats_FAST[] = _("VELOCE");
static const u8 sText_Stats_SLOW[] = _("LENTO");
static const u8 sText_Stats_ContestHeart[] = _("H");
static const u8 sText_Stats_Minus[] = _("-");
static const u8 sText_Stats_eggGroup[] = _("UOVO G1:");
static const u8 sText_Stats_eggGroup_Groups[] = _("{STR_VAR_1}/{STR_VAR_2}");
static const u8 sText_Stats_eggGroup_MONSTER[] = _("MOSTRO");
static const u8 sText_Stats_eggGroup_WATER_1[] = _("ACQUA {CIRCLE_1}");
static const u8 sText_Stats_eggGroup_BUG[] = _("COLEOTTERO");
static const u8 sText_Stats_eggGroup_FLYING[] = _("VOLANTE");
static const u8 sText_Stats_eggGroup_FIELD[] = _("CAMPO");
static const u8 sText_Stats_eggGroup_FAIRY[] = _("MAGICO");
static const u8 sText_Stats_eggGroup_GRASS[] = _("ERBA");
static const u8 sText_Stats_eggGroup_HUMAN_LIKE[] = _("UMANO");
static const u8 sText_Stats_eggGroup_WATER_3[] = _("ACQUA {CIRCLE_3}");
static const u8 sText_Stats_eggGroup_MINERAL[] = _("MINERAL");
static const u8 sText_Stats_eggGroup_AMORPHOUS[] = _("AMORFO");
static const u8 sText_Stats_eggGroup_WATER_2[] = _("ACQUA {CIRCLE_2}");
static const u8 sText_Stats_eggGroup_DITTO[] = _("DITTO");
static const u8 sText_Stats_eggGroup_DRAGON[] = _("DRAGO");
...
static const u8 sText_EVO_Buttons_PE[] = _("{DPAD_UPDOWN}EVO  {A_BUTTON}VEDI  {START_BUTTON}FORME");
static const u8 sText_EVO_Buttons_Decapped_PE[] = _("{DPAD_UPDOWN}Evo  {A_BUTTON}Vedi  {START_BUTTON}Forme");
static const u8 sText_EVO_Name[] = _("{STR_VAR_3}:");
static const u8 sText_EVO_PreEvo[] = _("{STR_VAR_1} si evolve da {STR_VAR_2}");
static const u8 sText_EVO_PreEvo_PE_Mega[] = _("MegaEvoluzione di {STR_VAR_1} con {STR_VAR_2}");
static const u8 sText_EVO_LEVEL_SILCOON[] = _("{LV}{UP_ARROW} a {STR_VAR_2}, come Silcoon");
static const u8 sText_EVO_LEVEL_CASCOON[] = _("{LV}{UP_ARROW} a {STR_VAR_2}, come Cascoon");
static const u8 sText_EVO_MOVE[] = _("{LV}{UP_ARROW}, conosce {STR_VAR_2}");
static const u8 sText_EVO_LEVEL_RAIN[] = _("{LV}{UP_ARROW} a {STR_VAR_2} sotto la pioggia");
static const u8 sText_EVO_TRADE_SPECIFIC_MON[] = _("Scambiato con {STR_VAR_2}");
static const u8 sText_EVO_CRITICAL_HITS[] = _("Metti a segno {STR_VAR_2} brutti colpi\nin un singolo");
static const u8 sText_EVO_SCRIPT_TRIGGER_DMG[] = _("Subisce almeno {STR_VAR_2} PS di danno");
static const u8 sText_EVO_DARK_SCROLL[] = _("Usa ScrllOfDrknss");
static const u8 sText_EVO_WATER_SCROLL[] = _("Usa ScrollOfWatrs");
static const u8 sText_EVO_USE_MOVE_TWENTY_TIMES[] = _("{LV}{UP_ARROW} dopo 20 volte {STR_VAR_2}");
static const u8 sText_EVO_RECOIL_DAMAGE_MALE[] = _("{LV}{UP_ARROW} con contraccolpo {STR_VAR_2}, maschio");
static const u8 sText_EVO_RECOIL_DAMAGE_FEMALE[] = _("{LV}{UP_ARROW} con contraccolpo di {STR_VAR_2}, femmina");
static const u8 sText_EVO_DEFEAT_THREE_WITH_ITEM[] = _("{LV}{UP_ARROW} battendo 3 {STR_VAR_3} con {STR_VAR_2}");
static const u8 sText_EVO_NONE[] = _("{STR_VAR_1} non si evolve.");

static const u8 sText_FORMS_Buttons_PE[] = _("{A_BUTTON}MODALITà FORME  {START_BUTTON}EVO");
static const u8 sText_FORMS_Buttons_Decapped_PE[] = _("{START_BUTTON}Evo");
static const u8 sText_FORMS_Buttons_Submenu_PE[] = _("{DPAD_NONE}FORME {A_BUTTON}VEDI {START_BUTTON}EVO");
static const u8 sText_FORMS_Buttons_Submenu_Decapped_PE[] = _("{START_BUTTON}Evo");
static const u8 sText_FORMS_NONE[] = _("{STR_VAR_1} non ha altre forme.");
...
static void PrintEvolutionTargetSpeciesAndMethod(u8 taskId, u16 species, u8 depth, u32 *depth_i, u32 alreadyPrintedIcons[], u32 *icon_depth_i, u32 numLines, u32 *totalLines, u16 baseSpecies)
{
    ...
    for (i = 0; i < times; i++)
    {
        ...
        {
            StringExpandPlaceholders(gStringVar4, COMPOUND_STRING("Ignoto"));
        }
        else
        {
            ...
            case EVO_LEVEL_BATTLE_ONLY:
                ...
                if ((enum EvolutionMethods)evolutions[i].method == EVO_LEVEL_BATTLE_ONLY)
                    StringAppend(gStringVar4, COMPOUND_STRING(", in lotta"));
                break;
            case EVO_TRADE:
                StringExpandPlaceholders(gStringVar4, COMPOUND_STRING("Scambio"));
                break;
            case EVO_ITEM:
                CopyItemName(evolutions[i].param, gStringVar2);
                StringExpandPlaceholders(gStringVar4, COMPOUND_STRING("{STR_VAR_2} è usato"));
                break;
            case EVO_SPLIT_FROM_EVO:
                StringCopy(gStringVar4, COMPOUND_STRING("Si divide da "));
                StringAppend(gStringVar4, GetSpeciesName(evolutions[i].param)); //mon name
                break;
            case EVO_BATTLE_END:
                StringExpandPlaceholders(gStringVar4, COMPOUND_STRING("Fine lotta"));
                break;
            case EVO_SPIN:
                StringCopy(gStringVar4, COMPOUND_STRING("Gira "));
                if (evolutions[i].param == SPIN_CW_SHORT)
                    StringAppend(gStringVar4, COMPOUND_STRING("OR <5s"));
                else if (evolutions[i].param == SPIN_CW_LONG)
                    StringAppend(gStringVar4, COMPOUND_STRING("OR >5s"));
                else if (evolutions[i].param == SPIN_CCW_SHORT)
                    StringAppend(gStringVar4, COMPOUND_STRING("AN <5s"));
                else if (evolutions[i].param == SPIN_CCW_LONG)
                    StringAppend(gStringVar4, COMPOUND_STRING("AN >5s"));
                else
                    StringAppend(gStringVar4, COMPOUND_STRING("OR/AN >10s"));
                break;
            }//Switch end
            ...
            for (u32 j = 0; evolutions[i].params != NULL && evolutions[i].params[j].condition != CONDITIONS_END; j++)
            {
                ...
                case IF_GENDER:
                    ...
                    {
                    case MON_MALE:   StringAppend(gStringVar4, COMPOUND_STRING("Maschio"));   break;
                    case MON_FEMALE: StringAppend(gStringVar4, COMPOUND_STRING("Femmina")); break;
                    }
                    break;
                case IF_MIN_FRIENDSHIP:
                    StringAppend(gStringVar4, COMPOUND_STRING("{UP_ARROW_2}amicizia"));
                    break;
                case IF_ATK_GT_DEF:
                    StringAppend(gStringVar4, COMPOUND_STRING("Att > Dif"));
                    break;
                case IF_ATK_EQ_DEF:
                    StringAppend(gStringVar4, COMPOUND_STRING("Att = Dif"));
                    break;
                ...
                case IF_TIME:
                    switch (evolutions[i].params[j].arg1)
                    {
                    case TIME_MORNING: StringAppend(gStringVar4, COMPOUND_STRING("Mattina")); break;
                    case TIME_DAY:     StringAppend(gStringVar4, COMPOUND_STRING("Giorno"));     break;
                    case TIME_EVENING: StringAppend(gStringVar4, COMPOUND_STRING("Sera")); break;
                    case TIME_NIGHT:   StringAppend(gStringVar4, COMPOUND_STRING("Notte"));   break;
                    }
                    break;
                case IF_NOT_TIME:
                    switch (evolutions[i].params[j].arg1)
                    {
                    case TIME_MORNING: StringAppend(gStringVar4, COMPOUND_STRING("NON Mattina")); break;
                    case TIME_DAY:     StringAppend(gStringVar4, COMPOUND_STRING("NON Giorno"));     break;
                    case TIME_EVENING: StringAppend(gStringVar4, COMPOUND_STRING("NON Sera")); break;
                    case TIME_NIGHT:   StringAppend(gStringVar4, COMPOUND_STRING("Giorno"));         break; // More intuitive than "NOT Night"
                    }
                    break;
                case IF_HOLD_ITEM:
                    StringAppend(gStringVar4, COMPOUND_STRING("tiene "));
                    if (isAlcremie && IsItemSweet(evolutions[i].params[j].arg1))
                    {
                        StringAppend(gStringVar4, COMPOUND_STRING("Dolce")); //item
                    }
                    else
                    {
                ...
                case IF_PID_UPPER_MODULO_10_LT:
                    ...
                    StringAppend(gStringVar4, COMPOUND_STRING("caso %"));
                    StringAppend(gStringVar4, gStringVar2);
                    break;
                case IF_MIN_BEAUTY:
                    StringAppend(gStringVar4, COMPOUND_STRING("{UP_ARROW_2}bellezza"));
                    break;
                case IF_MIN_COOLNESS:
                    StringAppend(gStringVar4, COMPOUND_STRING("{UP_ARROW_2}classe"));
                    break;
                case IF_MIN_SMARTNESS:
                    StringAppend(gStringVar4, COMPOUND_STRING("{UP_ARROW_2}acume"));
                    break;
                case IF_MIN_TOUGHNESS:
                    StringAppend(gStringVar4, COMPOUND_STRING("{UP_ARROW_2}grinta"));
                    break;
                case IF_MIN_CUTENESS:
                    StringAppend(gStringVar4, COMPOUND_STRING("{UP_ARROW_2}grazia"));
                    break;
                // Gen 4
                case IF_SPECIES_IN_PARTY:
                    StringAppend(gStringVar4, GetSpeciesName(evolutions[i].params[j].arg1)); //mon name
                    StringAppend(gStringVar4, COMPOUND_STRING(" in squadra"));
                    break;
                case IF_IN_MAPSEC:
                ...
                case IF_IN_MAP:
                    ...
                    break;
                case IF_KNOWS_MOVE:
                    StringAppend(gStringVar4, COMPOUND_STRING("sa "));
                    StringAppend(gStringVar4, GetMoveName(evolutions[i].params[j].arg1));
                    break;
                // Gen 5
                case IF_TRADE_PARTNER_SPECIES:
                    StringAppend(gStringVar4, COMPOUND_STRING("scambiato con "));
                ...
                case IF_TYPE_IN_PARTY:
                    ...
                    StringAppend(gStringVar4, COMPOUND_STRING("-tipo in squadra"));
                    break;
                case IF_WEATHER:
                    StringAppend(gStringVar4, COMPOUND_STRING("meteo "));
                ...
                case IF_KNOWS_MOVE_TYPE:
                    ...
                    StringAppend(gStringVar4, COMPOUND_STRING(" mossa"));
                    break;
                case IF_REGION:
                case IF_NOT_REGION:
                {
                    if (condition == IF_REGION)
                        ...
                        StringAppend(gStringVar4, COMPOUND_STRING("fuori da "));
                    ...
                    case REGION_UNOVA: StringAppend(gStringVar4, COMPOUND_STRING("Unima")); break;
                    case REGION_KALOS: StringAppend(gStringVar4, COMPOUND_STRING("Kalos")); break;
                    case REGION_ALOLA: StringAppend(gStringVar4, COMPOUND_STRING("Isole Alola")); break;
                ...
                case IF_NATURE:
                    ...
                    StringAppend(gStringVar4, gStringVar2);
                    StringAppend(gStringVar4, COMPOUND_STRING(" natura"));
                    break;
                case IF_AMPED_NATURE:
                    StringAppend(gStringVar4, COMPOUND_STRING("natura amped"));
                    break;
                case IF_LOW_KEY_NATURE:
                    StringAppend(gStringVar4, COMPOUND_STRING("natura low-Key"));
                    break;
                case IF_RECOIL_DAMAGE_GE:
                    StringAppend(gStringVar4, COMPOUND_STRING("serve >= "));
                    ConvertIntToDecimalStringN(gStringVar2, evolutions[i].params[j].arg1, STR_CONV_MODE_LEFT_ALIGN, 3);
                    StringAppend(gStringVar4, gStringVar2);
                    StringAppend(gStringVar4, COMPOUND_STRING(" danno rec"));
                    break;
                case IF_CURRENT_DAMAGE_GE:
                    ConvertIntToDecimalStringN(gStringVar2, evolutions[i].params[j].arg1, STR_CONV_MODE_LEFT_ALIGN, 3);
                    StringAppend(gStringVar4, gStringVar2);
                    StringAppend(gStringVar4, COMPOUND_STRING(" danno att"));
                    break;
                case IF_CRITICAL_HITS_GE:
                    ConvertIntToDecimalStringN(gStringVar2, evolutions[i].params[j].arg1, STR_CONV_MODE_LEFT_ALIGN, 2);
                    StringAppend(gStringVar4, gStringVar2);
                    StringAppend(gStringVar4, COMPOUND_STRING(" colpi critici"));
                    break;
                case IF_USED_MOVE_X_TIMES:
                    StringAppend(gStringVar4, COMPOUND_STRING("usa mossa "));
                    StringAppend(gStringVar4, GetMoveName(evolutions[i].params[j].arg1));
                    StringAppend(gStringVar4, COMPOUND_STRING(" "));
                    ConvertIntToDecimalStringN(gStringVar2, evolutions[i].params[j].arg2, STR_CONV_MODE_LEFT_ALIGN, 3);
                    StringAppend(gStringVar4, gStringVar2);
                    StringAppend(gStringVar4, COMPOUND_STRING(" volte"));
                    break;
                // Gen 9
                case IF_DEFEAT_X_WITH_ITEMS:
                    StringAppend(gStringVar4, COMPOUND_STRING("batti "));
                    ConvertIntToDecimalStringN(gStringVar2, evolutions[i].params[j].arg3, STR_CONV_MODE_LEFT_ALIGN, 3);
                    StringAppend(gStringVar4, gStringVar2);
                    StringAppend(gStringVar4, COMPOUND_STRING(" "));
                    StringAppend(gStringVar4, GetSpeciesName(evolutions[i].params[j].arg1));
                    StringAppend(gStringVar4, COMPOUND_STRING(" che tiene "));
                ...
                case IF_BAG_ITEM_COUNT:
                    ...
                    StringAppend(gStringVar4, gStringVar2);
                    StringAppend(gStringVar4, COMPOUND_STRING(" in borsa"));
                    break;
                case CONDITIONS_END:
                    break;
                }
