...
{
    [TRAINER_CLASS_PKMN_TRAINER_1] = { _("{PKMN} ALLEN.") },
    [TRAINER_CLASS_PKMN_TRAINER_2] = { _("{PKMN} ALLEN.") },
    ...
    [TRAINER_CLASS_BIRD_KEEPER] = { _("UCCELLATORE"), 8 },
    ...
    [TRAINER_CLASS_EXPERT] = { _("ESPERTO"), 10 },
    [TRAINER_CLASS_AQUA_ADMIN] = { _("CAPO AQUA"), 10 },
    [TRAINER_CLASS_BLACK_BELT] = { _("CINTURA NERA"), 8, BALL_ULTRA },
    [TRAINER_CLASS_AQUA_LEADER] = { _("CAPO AQUA"), 20, BALL_MASTER },
    [TRAINER_CLASS_HEX_MANIAC] = { _("SCIAGURATO"), 6 },
    [TRAINER_CLASS_AROMA_LADY] = { _("DAMA AROMA"), 10 },
    [TRAINER_CLASS_RUIN_MANIAC] = { _("DROGATO"), 15 },
    [TRAINER_CLASS_INTERVIEWER] = { _("INTERVISTA"), 12 },
    [TRAINER_CLASS_TUBER_F] = { _("SOMMOZZATORE"), 1 },
    [TRAINER_CLASS_TUBER_M] = { _("SOMMOZZATORE"), 1 },
    [TRAINER_CLASS_LADY] = { _("DAMA"), 50 },
    [TRAINER_CLASS_BEAUTY] = { _("BELLEZZA"), 20, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_GREAT : BALL_POKE },
    [TRAINER_CLASS_RICH_BOY] = { _("RICCO"), 50 },
    [TRAINER_CLASS_POKEMANIAC] = { _("POKéMANIACO"), 15 },
    [TRAINER_CLASS_GUITARIST] = { _("CHITARRISTA"), 8 },
    [TRAINER_CLASS_KINDLER] = { _("FUOCHISTA"), 8 },
    [TRAINER_CLASS_CAMPER] = { _("CAMPER"), 4 },
    [TRAINER_CLASS_PICNICKER] = { _("PICNIC"), 4 },
    [TRAINER_CLASS_BUG_MANIAC] = { _("FANATICO"), 15 },
    [TRAINER_CLASS_PSYCHIC] = { _("PSICO"), 6 },
    [TRAINER_CLASS_GENTLEMAN] = { _("GENTILUOMO"), 20, BALL_LUXURY },
    [TRAINER_CLASS_ELITE_FOUR] = { _("SUPERQUATTRO"), 25, BALL_ULTRA },
    [TRAINER_CLASS_LEADER] = { _("CAPO"), 25, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_ULTRA : BALL_POKE },
    [TRAINER_CLASS_SCHOOL_KID] = { _("SCOLASTICO") },
    [TRAINER_CLASS_SR_AND_JR] = { _("SR. E JR."), 4 },
    [TRAINER_CLASS_WINSTRATE] = { _("WINSTRATE"), 10 },
    [TRAINER_CLASS_POKEFAN] = { _("APPASSIONATO"), 20 },
    [TRAINER_CLASS_YOUNGSTER] = { _("PICCOLO"), 4 },
    ...
    [TRAINER_CLASS_DRAGON_TAMER] = { _("DOMATORE"), 12 },
    [TRAINER_CLASS_NINJA_BOY] = { _("NINJA BOY"), 3 },
    [TRAINER_CLASS_BATTLE_GIRL] = { _("LOTTATRICE"), 6 },
    [TRAINER_CLASS_PARASOL_LADY] = { _("DAMA SOLE"), 10 },
    [TRAINER_CLASS_SWIMMER_F] = { _("NUOTATRICE♀"), 2, BALL_DIVE },
    [TRAINER_CLASS_TWINS] = { _("GEMELLI"), 3 },
    [TRAINER_CLASS_SAILOR] = { _("MARINAIO"), 8 },
    [TRAINER_CLASS_COOLTRAINER_2] = { _("COOLTRAINER"), 5, BALL_ULTRA },
    [TRAINER_CLASS_MAGMA_ADMIN] = { _("CAPO MAGMA"), 10 },
    [TRAINER_CLASS_RIVAL] = { _("{PKMN} ALLEN."), 15 },
    ...
    [TRAINER_CLASS_LASS] = { _("RAGAZZA"), 4 },
    [TRAINER_CLASS_YOUNG_COUPLE] = { _("COPPIA"), 8 },
    [TRAINER_CLASS_OLD_COUPLE] = { _("COPPIA"), 10 },
    [TRAINER_CLASS_SIS_AND_BRO] = { _("FRATELLI"), 3 },
    [TRAINER_CLASS_SALON_MAIDEN] = { _("DAMIGELLA"), 5, BALL_ULTRA },
    [TRAINER_CLASS_DOME_ACE] = { _("ASSO CUPOLA") },
    [TRAINER_CLASS_PALACE_MAVEN] = { _("ASSO PALAZZO") },
    [TRAINER_CLASS_ARENA_TYCOON] = { _("ASSO ARENA") },
    [TRAINER_CLASS_FACTORY_HEAD] = { _("CAPO AZIENDA") },
    [TRAINER_CLASS_PIKE_QUEEN] = { _("REGINA PIKE") },
    [TRAINER_CLASS_PYRAMID_KING] = { _("RE PIRAMIDE") },
    [TRAINER_CLASS_RS_PROTAG] = { _("{PKMN} ALLEN.") },

    [TRAINER_CLASS_YOUNGSTER_FRLG] =       { _("PICCOLO"), 4 },
    [TRAINER_CLASS_BUG_CATCHER_FRLG] =     { _("PIGLIAMOSCHE"), 3 },
    [TRAINER_CLASS_LASS_FRLG] =            { _("RAGAZZA"), 4 },
    [TRAINER_CLASS_SAILOR_FRLG] =          { _("MARINAIO"), 8 },
    [TRAINER_CLASS_CAMPER_FRLG] =          { _("CAMPER"), 5 },
    [TRAINER_CLASS_PICNICKER_FRLG] =       { _("PICNIC"), 5 },
    [TRAINER_CLASS_POKEMANIAC_FRLG] =      { _("POKéMANIACO"), 12 },
    [TRAINER_CLASS_SUPER_NERD_FRLG] =      { _("SUPER NERD"), 6 },
    [TRAINER_CLASS_HIKER_FRLG] =           { _("HIKER"), 9 },
    [TRAINER_CLASS_BIKER_FRLG] =           { _("CENTAURO"), 5 },
    [TRAINER_CLASS_BURGLAR_FRLG] =         { _("LADRO"), 22 },
    ...
    [TRAINER_CLASS_CUE_BALL_FRLG] =        { _("PALLA 8"), 6 },
    [TRAINER_CLASS_GAMER_FRLG] =           { _("VIDEOMANIACO"), 18 },
    [TRAINER_CLASS_BEAUTY_FRLG] =          { _("BELLEZZA"), 18 },
    [TRAINER_CLASS_SWIMMER_F_FRLG] =       { _("NUOTATRICE♀"), 1, BALL_DIVE },
    [TRAINER_CLASS_PSYCHIC_FRLG] =         { _("PSICO"), 5 },
    [TRAINER_CLASS_ROCKER_FRLG] =          { _("ROCKER"), 6 },
    [TRAINER_CLASS_JUGGLER_FRLG] =         { _("GIALLISTA"), 10 },
    [TRAINER_CLASS_TAMER_FRLG] =           { _("DOMATORE"), 10 },
    [TRAINER_CLASS_BIRD_KEEPER_FRLG] =     { _("UCCELLATORE"), 6 },
    [TRAINER_CLASS_BLACK_BELT_FRLG] =      { _("CINTURA NERA"), 6, BALL_ULTRA },
    [TRAINER_CLASS_RIVAL_EARLY_FRLG] =     { _("RIVALE"), 4 },
    [TRAINER_CLASS_SCIENTIST_FRLG] =       { _("SCIENZIATO"), 12 },
    [TRAINER_CLASS_BOSS_FRLG] =            { _("CAPO"), 25 },
    [TRAINER_CLASS_LEADER_FRLG] =          { _("CAPO"), 25 },
    ...
    [TRAINER_CLASS_TWINS_FRLG] =           { _("GEMELLI"), 3 },
    [TRAINER_CLASS_COOL_COUPLE_FRLG] =     { _("COPPIA COOL"), 6 },
    [TRAINER_CLASS_YOUNG_COUPLE_FRLG] =    { _("COPPIA"), 7 },
    [TRAINER_CLASS_CRUSH_KIN_FRLG] =       { _("SQUILIBRATI"), 6 },
    [TRAINER_CLASS_SIS_AND_BRO_FRLG] =     { _("FRATELLI"), 1 },
    [TRAINER_CLASS_PKMN_PROF_FRLG] =       { _("{PKMN} PROF."), 25 },
    [TRAINER_CLASS_PLAYER_FRLG] =          { _("{PKMN} ALLEN."), 1 },
    [TRAINER_CLASS_CRUSH_GIRL_FRLG] =      { _("SQUILIBRATA"), 6 },
    [TRAINER_CLASS_TUBER_FRLG] =           { _("SOMMOZZATORE"), 1 },
    ...
    [TRAINER_CLASS_AROMA_LADY_FRLG] =      { _("DAMA AROMA"), 7 },
    [TRAINER_CLASS_RUIN_MANIAC_FRLG] =     { _("DROGATO"), 12 },
    [TRAINER_CLASS_LADY_FRLG] =            { _("DAMA"), 50 },
    [TRAINER_CLASS_PAINTER_FRLG] =         { _("PITTORE"), 4 },

    // HnS Trainer Classes
    [TRAINER_CLASS_ARENA_TYCOON_HNS] =     { _("ASSO ARENA") },
    [TRAINER_CLASS_BATTLE_GIRL_HNS] =      { _("LOTTATRICE"), 6 },
    [TRAINER_CLASS_BEAUTY_HNS] =           { _("BELLEZZA"), 20 },
    [TRAINER_CLASS_BIKER_HNS] =            { _("CENTAURO") },
    [TRAINER_CLASS_BIRD_KEEPER_HNS] =      { _("UCCELLATORE"), 8 },
    [TRAINER_CLASS_BLACK_BELT_HNS] =       { _("CINTURA NERA"), 8, BALL_ULTRA },
    [TRAINER_CLASS_BUG_CATCHER_HNS] =      { _("PIGLIAMOSCHE"), 4 },
    [TRAINER_CLASS_BURGLAR_HNS] =          { _("LADRO") },
    ...
    [TRAINER_CLASS_DOME_ACE_HNS] =         { _("ASSO CUPOLA") },
    [TRAINER_CLASS_DRAGON_TAMER_HNS] =     { _("DOMATORE"), 12 },
    [TRAINER_CLASS_ELITE_FOUR_HNS] =       { _("SUPERQUATTRO"), 25, BALL_ULTRA },
    [TRAINER_CLASS_EXPERT_HNS] =           { _("ESPERTO"), 10 },
    [TRAINER_CLASS_FACTORY_HEAD_HNS] =     { _("CAPO AZIENDA") },
    [TRAINER_CLASS_FIREBREATHER_HNS] =     { _("SOFFIATORE") },
    ...
    [TRAINER_CLASS_HEX_MANIAC_HNS] =       { _("SCIAGURATO"), 6 },
    [TRAINER_CLASS_HIKER_HNS] =            { _("HIKER"), 10 },
    [TRAINER_CLASS_JUGGLER_HNS] =          { _("GIALLISTA") },
    [TRAINER_CLASS_KIMONO_GIRL_HNS] =      { _("KIMONO") },
    [TRAINER_CLASS_LASS_HNS] =             { _("RAGAZZA"), 4 },
    [TRAINER_CLASS_LEADER_HNS] =           { _("CAPO"), 25 },
    [TRAINER_CLASS_LEADER_KANTO_HNS] =     { _("CAPO"), 25 },
    [TRAINER_CLASS_MYSTERY_MAN_HNS] =      { _("UOMO MISTERO") },
    [TRAINER_CLASS_OFFICER_HNS] =          { _("POLIZIOTTO") },
    [TRAINER_CLASS_PALACE_MAVEN_HNS] =     { _("ASSO PALAZZO") },
    [TRAINER_CLASS_PARASOL_LADY_HNS] =     { _("DAMA SOLE"), 10 },
    [TRAINER_CLASS_PICNICKER_HNS] =        { _("PICNIC"), 4 },
    [TRAINER_CLASS_PIKE_QUEEN_HNS] =       { _("REGINA PIKE") },
    [TRAINER_CLASS_PKMN_TRAINER_1_HNS] =   { _("{PKMN} ALLEN.") },
    [TRAINER_CLASS_POKEFAN_HNS] =          { _("APPASSIONATO"), 20 },
    [TRAINER_CLASS_POKEMANIAC_HNS] =       { _("POKéMANIACO"), 15 },
    [TRAINER_CLASS_PSYCHIC_HNS] =          { _("PSICO"), 6 },
    [TRAINER_CLASS_PSYCHIC_M_HNS] =        { _("PSICO"), 6 },
    [TRAINER_CLASS_RIVAL_HNS] =            { _("{PKMN} ALLEN."), 15 },
    [TRAINER_CLASS_ROCKET_ADMIN_HNS] =     { _("CAPO ROCKET") },
    [TRAINER_CLASS_SAGE_HNS] =             { _("SAGGIO") },
    [TRAINER_CLASS_SAILOR_HNS] =           { _("MARINAIO"), 8 },
    [TRAINER_CLASS_SALON_MAIDEN_HNS] =     { _("DAMIGELLA"), 5, BALL_ULTRA },
    [TRAINER_CLASS_SCHOOL_KID_HNS] =       { _("SCOLASTICO") },
    [TRAINER_CLASS_SKIER_HNS] =            { _("SCIATORE"), 10 },
    ...
    [TRAINER_CLASS_TWINS_HNS] =            { _("GEMELLI"), 3 },
    [TRAINER_CLASS_YOUNG_COUPLE_HNS] =     { _("COPPIA"), 8 },
    [TRAINER_CLASS_YOUNGSTER_HNS] =        { _("PICCOLO"), 4 },
    [TRAINER_CLASS_PROFESSOR_HNS] =        { _("{PKMN} PROF."), 25, BALL_FRIEND},
    [TRAINER_CLASS_DEVELOPER_HNS] =        { _("SVILUPPATORE"), 50, BALL_MASTER},
