...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_HIKER] = { _("AVVENTURIERO"), 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_ULTRA : BALL_POKE },
    [TRAINER_CLASS_TEAM_AQUA] = { _("TEAM IDRO") },
    [TRAINER_CLASS_PKMN_BREEDER] = { _("ALLEVA{PKMN}"), 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_HEAL : BALL_FRIEND },
    [TRAINER_CLASS_COOLTRAINER] = { _("FANTALLEN."), 12, BALL_ULTRA },
    [TRAINER_CLASS_BIRD_KEEPER] = { _("AVICOLTORE"), 8 },
    [TRAINER_CLASS_COLLECTOR] = { _("CERCA{PKMN}"), 15, BALL_PREMIER },
    [TRAINER_CLASS_SWIMMER_M] = { _("NUOTATORE"), 2, BALL_DIVE },
    [TRAINER_CLASS_TEAM_MAGMA] = { _("TEAM MAGMA") },
    [TRAINER_CLASS_EXPERT] = { _("SPECIALISTA"), 10 },
    [TRAINER_CLASS_AQUA_ADMIN] = { _("IDROTENENTE"), 10 },
    [TRAINER_CLASS_BLACK_BELT] = { _("CINTURANERA"), 8, BALL_ULTRA },
    [TRAINER_CLASS_AQUA_LEADER] = { _("CAPO IDRO"), 20, BALL_MASTER },
    [TRAINER_CLASS_HEX_MANIAC] = { _("STREGHETTA"), 6 },
    [TRAINER_CLASS_AROMA_LADY] = { _("PROFUMINA"), 10 },
    [TRAINER_CLASS_RUIN_MANIAC] = { _("SCOPRIROVINE"), 15 },
    [TRAINER_CLASS_INTERVIEWER] = { _("REPORTER"), 12 },
    [TRAINER_CLASS_TUBER_F] = { _("CIAMBELLINA"), 1 },
    [TRAINER_CLASS_TUBER_M] = { _("CIAMBELLINO"), 1 },
    [TRAINER_CLASS_LADY] = { _("LADY"), 50 },
    [TRAINER_CLASS_BEAUTY] = { _("BELLEZZA"), 20, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_GREAT : BALL_POKE },
    [TRAINER_CLASS_RICH_BOY] = { _("ELEGANTONE"), 50 },
    [TRAINER_CLASS_POKEMANIAC] = { _("POKéFANATICO"), 15 },
    [TRAINER_CLASS_GUITARIST] = { _("CHITARRISTA"), 8 },
    [TRAINER_CLASS_KINDLER] = { _("BRANDIFUOCO"), 8 },
    [TRAINER_CLASS_CAMPER] = { _("CAMPEGGISTA"), 4 },
    [TRAINER_CLASS_PICNICKER] = { _("PICNIC GIRL"), 4 },
    [TRAINER_CLASS_BUG_MANIAC] = { _("INSETTOLOGO"), 15 },
    [TRAINER_CLASS_PSYCHIC] = { _("PSICHE"), 6 },
    [TRAINER_CLASS_GENTLEMAN] = { _("GENTILUOMO"), 20, BALL_LUXURY },
    [TRAINER_CLASS_ELITE_FOUR] = { _("SUPERQUATTRO"), 25, BALL_ULTRA },
    [TRAINER_CLASS_LEADER] = { _("CAPOPALESTRA"), 25, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_ULTRA : BALL_POKE },
    [TRAINER_CLASS_SCHOOL_KID] = { _("SCOLARO") },
    [TRAINER_CLASS_SR_AND_JR] = { _("SENIOR & JR"), 4 },
    [TRAINER_CLASS_WINSTRATE] = { _("FAM. VINCI"), 10 },
    [TRAINER_CLASS_POKEFAN] = { _("POKéFAN"), 20 },
    [TRAINER_CLASS_YOUNGSTER] = { _("BULLO"), 4 },
    [TRAINER_CLASS_CHAMPION] = { _("CAMPIONE"), 50, BALL_ULTRA },
    [TRAINER_CLASS_FISHERMAN] = { _("PESCATORE"), 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_DIVE : BALL_LURE },
    [TRAINER_CLASS_TRIATHLETE] = { _("TRIATLETA"), 10 },
    [TRAINER_CLASS_DRAGON_TAMER] = { _("DOMADRAGHI"), 12 },
    [TRAINER_CLASS_NINJA_BOY] = { _("NINJA BOY"), 3 },
    [TRAINER_CLASS_BATTLE_GIRL] = { _("COMBAT GIRL"), 6 },
    [TRAINER_CLASS_PARASOL_LADY] = { _("OMBRELLINA"), 10 },
    [TRAINER_CLASS_SWIMMER_F] = { _("NUOTATRICE"), 2, BALL_DIVE },
    [TRAINER_CLASS_TWINS] = { _("GEMELLE"), 3 },
    [TRAINER_CLASS_SAILOR] = { _("MARINAIO"), 8 },
    [TRAINER_CLASS_COOLTRAINER_2] = { _("FANTALLEN."), 5, BALL_ULTRA },
    [TRAINER_CLASS_MAGMA_ADMIN] = { _("MAGMATENENTE"), 10 },
    [TRAINER_CLASS_RIVAL] = { _("ALLENATORE"), 15 },
    [TRAINER_CLASS_BUG_CATCHER] = { _("PIGLIAMOSCHE"), 4 },
    [TRAINER_CLASS_PKMN_RANGER] = { _("{PKMN} SCOUT"), 12 },
    [TRAINER_CLASS_MAGMA_LEADER] = { _("CAPO MAGMA"), 20, BALL_MASTER },
    [TRAINER_CLASS_LASS] = { _("PUPA"), 4 },
    [TRAINER_CLASS_YOUNG_COUPLE] = { _("COPPIETTA"), 8 },
    [TRAINER_CLASS_OLD_COUPLE] = { _("COPPIARZILLA"), 10 },
    [TRAINER_CLASS_SIS_AND_BRO] = { _("FRATELLINI"), 3 },
    ...
    [TRAINER_CLASS_YOUNGSTER_FRLG] =       { _("BULLO"), 4 },
    [TRAINER_CLASS_BUG_CATCHER_FRLG] =     { _("PIGLIAMOSCHE"), 3 },
    [TRAINER_CLASS_LASS_FRLG] =            { _("PUPA"), 4 },
    [TRAINER_CLASS_SAILOR_FRLG] =          { _("MARINAIO"), 8 },
    [TRAINER_CLASS_CAMPER_FRLG] =          { _("CAMPEGGISTA"), 5 },
    [TRAINER_CLASS_PICNICKER_FRLG] =       { _("PICNIC GIRL"), 5 },
    [TRAINER_CLASS_POKEMANIAC_FRLG] =      { _("POKéFANATICO"), 12 },
    [TRAINER_CLASS_SUPER_NERD_FRLG] =      { _("CERVELLONE"), 6 },
    [TRAINER_CLASS_HIKER_FRLG] =           { _("AVVENTURIERO"), 9 },
    [TRAINER_CLASS_BIKER_FRLG] =           { _("CENTAURO"), 5 },
    [TRAINER_CLASS_BURGLAR_FRLG] =         { _("SCASSINATORE"), 22 },
    [TRAINER_CLASS_ENGINEER_FRLG] =        { _("MECCANICO"), 12 },
    [TRAINER_CLASS_FISHERMAN_FRLG] =       { _("PESCATORE"), 9, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_DIVE : BALL_LURE },
    [TRAINER_CLASS_SWIMMER_M_FRLG] =       { _("NUOTATORE"), 1 },
    [TRAINER_CLASS_CUE_BALL_FRLG] =        { _("ZUCCAPELATA"), 6 },
    [TRAINER_CLASS_GAMER_FRLG] =           { _("RISCHIATUTTO"), 18 },
    [TRAINER_CLASS_BEAUTY_FRLG] =          { _("BELLEZZA"), 18 },
    [TRAINER_CLASS_SWIMMER_F_FRLG] =       { _("NUOTATRICE"), 1, BALL_DIVE },
    [TRAINER_CLASS_PSYCHIC_FRLG] =         { _("PSICHE"), 5 },
    [TRAINER_CLASS_ROCKER_FRLG] =          { _("ROCKETTARO"), 6 },
    [TRAINER_CLASS_JUGGLER_FRLG] =         { _("GIOCOLIERE"), 10 },
    [TRAINER_CLASS_TAMER_FRLG] =           { _("DOMATORE"), 10 },
    [TRAINER_CLASS_BIRD_KEEPER_FRLG] =     { _("AVICOLTORE"), 6 },
    [TRAINER_CLASS_BLACK_BELT_FRLG] =      { _("CINTURANERA"), 6, BALL_ULTRA },
    [TRAINER_CLASS_RIVAL_EARLY_FRLG] =     { _("RIVALE"), 4 },
    [TRAINER_CLASS_SCIENTIST_FRLG] =       { _("SCIENZIATO"), 12 },
    [TRAINER_CLASS_BOSS_FRLG] =            { _("CAPO"), 25 },
    [TRAINER_CLASS_LEADER_FRLG] =          { _("CAPOPALESTRA"), 25 },
    [TRAINER_CLASS_TEAM_ROCKET_FRLG] =     { _("TEAM ROCKET"), 8 },
    [TRAINER_CLASS_COOLTRAINER_FRLG] =     { _("FANTALLEN."), 9, BALL_ULTRA },
    [TRAINER_CLASS_ELITE_FOUR_FRLG] =      { _("SUPERQUATTRO"), 25, BALL_ULTRA },
    [TRAINER_CLASS_GENTLEMAN_FRLG] =       { _("GENTILUOMO"), 18, BALL_LUXURY },
    [TRAINER_CLASS_RIVAL_LATE_FRLG] =      { _("RIVALE"), 9 },
    [TRAINER_CLASS_CHAMPION_FRLG] =        { _("CAMPIONE"), 25 },
    [TRAINER_CLASS_CHANNELER_FRLG] =       { _("MEDIUM"), 8 },
    [TRAINER_CLASS_TWINS_FRLG] =           { _("GEMELLE"), 3 },
    [TRAINER_CLASS_COOL_COUPLE_FRLG] =     { _("COPPIAGIUSTA"), 6 },
    [TRAINER_CLASS_YOUNG_COUPLE_FRLG] =    { _("COPPIETTA"), 7 },
    [TRAINER_CLASS_CRUSH_KIN_FRLG] =       { _("DUO LOTTA"), 6 },
    [TRAINER_CLASS_SIS_AND_BRO_FRLG] =     { _("FRATELLINI"), 1 },
    [TRAINER_CLASS_PKMN_PROF_FRLG] =       { _("PROF. {PKMN}"), 25 },
    [TRAINER_CLASS_PLAYER_FRLG] =          { _("GIOCATORE"), 1 },
    [TRAINER_CLASS_CRUSH_GIRL_FRLG] =      { _("FIGHT GIRL"), 6 },
    [TRAINER_CLASS_TUBER_FRLG] =           { _("CIAMBELLINA"), 1 },
    [TRAINER_CLASS_PKMN_BREEDER_FRLG] =    { _("ALLEVA{PKMN}"), 7, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_HEAL : BALL_FRIEND },
    [TRAINER_CLASS_PKMN_RANGER_FRLG] =     { _("{PKMN} SCOUT"), 9 },
    [TRAINER_CLASS_AROMA_LADY_FRLG] =      { _("PROFUMINA"), 7 },
    [TRAINER_CLASS_RUIN_MANIAC_FRLG] =     { _("SCOPRIROVINE"), 12 },
    [TRAINER_CLASS_LADY_FRLG] =            { _("LADY"), 50 },
    [TRAINER_CLASS_PAINTER_FRLG] =         { _("PITTRICE"), 4 },

    // HnS Trainer Classes
    [TRAINER_CLASS_ARENA_TYCOON_HNS] =     { _("MAESTRA DOJO") },
    [TRAINER_CLASS_BATTLE_GIRL_HNS] =      { _("COMBAT GIRL"), 6 },
    [TRAINER_CLASS_BEAUTY_HNS] =           { _("BELLEZZA"), 20 },
    [TRAINER_CLASS_BIKER_HNS] =            { _("CENTAURO") },
    [TRAINER_CLASS_BIRD_KEEPER_HNS] =      { _("AVICOLTORE"), 8 },
    [TRAINER_CLASS_BLACK_BELT_HNS] =       { _("CINTURANERA"), 8, BALL_ULTRA },
    [TRAINER_CLASS_BUG_CATCHER_HNS] =      { _("PIGLIAMOSCHE"), 4 },
    [TRAINER_CLASS_BURGLAR_HNS] =          { _("SCASSINATORE") },
    [TRAINER_CLASS_CAMPER_HNS] =           { _("CAMPEGGISTA"), 4 },
    [TRAINER_CLASS_CHAMPION_HNS] =         { _("CAMPIONE"), 50, BALL_ULTRA },
    [TRAINER_CLASS_COLLECTOR_HNS] =        { _("CERCA{PKMN}"), 15, BALL_PREMIER },
    [TRAINER_CLASS_COOLTRAINER_HNS] =      { _("FANTALLEN."), 12, BALL_ULTRA },
    [TRAINER_CLASS_DOME_ACE_HNS] =         { _("ASTRO CUPOLA") },
    [TRAINER_CLASS_DRAGON_TAMER_HNS] =     { _("DOMADRAGHI"), 12 },
    [TRAINER_CLASS_ELITE_FOUR_HNS] =       { _("SUPERQUATTRO"), 25, BALL_ULTRA },
    [TRAINER_CLASS_EXPERT_HNS] =           { _("SPECIALISTA"), 10 },
    [TRAINER_CLASS_FACTORY_HEAD_HNS] =     { _("BOSS AZIENDA") },
    [TRAINER_CLASS_FIREBREATHER_HNS] =     { _("MANGIAFUOCO") },
    [TRAINER_CLASS_FISHERMAN_HNS] =        { _("PESCATORE"), 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_DIVE : BALL_LURE },
    [TRAINER_CLASS_GENTLEMAN_HNS] =        { _("GENTILUOMO"), 20, BALL_LUXURY },
    [TRAINER_CLASS_GUITARIST_HNS] =        { _("CHITARRISTA"), 8 },
    [TRAINER_CLASS_HEX_MANIAC_HNS] =       { _("STREGHETTA"), 6 },
    [TRAINER_CLASS_HIKER_HNS] =            { _("AVVENTURIERO"), 10 },
    [TRAINER_CLASS_JUGGLER_HNS] =          { _("GIOCOLIERE") },
    [TRAINER_CLASS_KIMONO_GIRL_HNS] =      { _("KIMONO GIRL") },
    [TRAINER_CLASS_LASS_HNS] =             { _("PUPA"), 4 },
    [TRAINER_CLASS_LEADER_HNS] =           { _("CAPOPALESTRA"), 25 },
    [TRAINER_CLASS_LEADER_KANTO_HNS] =     { _("CAPO"), 25 },
    [TRAINER_CLASS_MYSTERY_MAN_HNS] =      { _("FANTALLEN.") },
    [TRAINER_CLASS_OFFICER_HNS] =          { _("GUARDIA") },
    [TRAINER_CLASS_PALACE_MAVEN_HNS] =     { _("SIRE PALAZZO") },
    [TRAINER_CLASS_PARASOL_LADY_HNS] =     { _("OMBRELLINA"), 10 },
    [TRAINER_CLASS_PICNICKER_HNS] =        { _("PICNIC GIRL"), 4 },
    [TRAINER_CLASS_PIKE_QUEEN_HNS] =       { _("REGINA SERPE") },
    [TRAINER_CLASS_PKMN_TRAINER_1_HNS] =   { _("ALLENATORE") },
    [TRAINER_CLASS_POKEFAN_HNS] =          { _("POKéFAN"), 20 },
    [TRAINER_CLASS_POKEMANIAC_HNS] =       { _("POKéFANATICO"), 15 },
    [TRAINER_CLASS_PSYCHIC_HNS] =          { _("PSICHE"), 6 },
    [TRAINER_CLASS_PSYCHIC_M_HNS] =        { _("PSICO"), 6 },
    [TRAINER_CLASS_RIVAL_HNS] =            { _("ALLENATORE"), 15 },
    [TRAINER_CLASS_ROCKET_ADMIN_HNS] =     { _("GENERALE ROCKET") },
    [TRAINER_CLASS_SAGE_HNS] =             { _("SAGGIO") },
    [TRAINER_CLASS_SAILOR_HNS] =           { _("MARINAIO"), 8 },
    [TRAINER_CLASS_SALON_MAIDEN_HNS] =     { _("DAMA TORRE"), 5, BALL_ULTRA },
    [TRAINER_CLASS_SCHOOL_KID_HNS] =       { _("SCOLARO") },
    [TRAINER_CLASS_SKIER_HNS] =            { _("SCIATRICE"), 10 },
    [TRAINER_CLASS_SUPER_NERD_HNS] =       { _("CERVELLONE"), 8 },
    [TRAINER_CLASS_SWIMMER_F_HNS] =        { _("NUOTATRICE"), 2, BALL_DIVE },
    [TRAINER_CLASS_SWIMMER_M_HNS] =        { _("NUOTATORE"), 2, BALL_DIVE },
    [TRAINER_CLASS_TEAM_ROCKET_HNS] =      { _("TEAM ROCKET") },
    [TRAINER_CLASS_TWINS_HNS] =            { _("GEMELLE"), 3 },
    [TRAINER_CLASS_YOUNG_COUPLE_HNS] =     { _("COPPIETTA"), 8 },
    [TRAINER_CLASS_YOUNGSTER_HNS] =        { _("BULLO"), 4 },
    [TRAINER_CLASS_PROFESSOR_HNS] =        { _("{PKMN} PROF."), 25, BALL_FRIEND},
    [TRAINER_CLASS_DEVELOPER_HNS] =        { _("GAME FREAK"), 50, BALL_MASTER},
    [TRAINER_CLASS_PYRAMID_KING_HNS] =     { _("RE PIRAMIDE") },
};
