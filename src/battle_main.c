...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_INTERVIEWER] = { _("INTERVISTATORE"), 12 },
    ...
    [TRAINER_CLASS_RICH_BOY] = { _("RAGAZZO RICCO"), 50 },
    ...
    [TRAINER_CLASS_BUG_MANIAC] = { _("MANIACO COLEOTTERO"), 15 },
    ...
    [TRAINER_CLASS_OLD_COUPLE] = { _("COPPIA ANZIANA"), 10 },
    [TRAINER_CLASS_SIS_AND_BRO] = { _("FRATELLI"), 3 },
    [TRAINER_CLASS_SALON_MAIDEN] = { _("MASSAGGIATRICE"), 5, BALL_ULTRA },
    ...
    [TRAINER_CLASS_SALON_MAIDEN_HNS] =     { _("MASSAGGIATRICE"), 5, BALL_ULTRA },
