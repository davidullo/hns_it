...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_PSYCHIC] = { _("PSICHICO"), 6 },
    ...
    [TRAINER_CLASS_PSYCHIC_FRLG] =         { _("PSICHICO"), 5 },
    ...
    [TRAINER_CLASS_PSYCHIC_HNS] =          { _("PSICHICO"), 6 },
    [TRAINER_CLASS_PSYCHIC_M_HNS] =        { _("PSICHICO"), 6 },
