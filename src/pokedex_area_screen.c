...
{
    static const u8 gText_Morning[] = _("{DPAD_UPDOWN} MATTINA");
    static const u8 gText_Day[] = _("{DPAD_UPDOWN} GIORNO");
    static const u8 gText_Evening[] = _("{DPAD_UPDOWN} SERA");
    static const u8 gText_Night[] = _("{DPAD_UPDOWN} NOTTE");
...
static void ShowAreaUnknownLabel(void)
{
    static const u8 gText_AreaUnknown[] = _("ZONA IGNOTA");
