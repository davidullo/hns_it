...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_TREECKO] =
    {
        ...
        .description = COMPOUND_STRING(
            "Riesce a scalare rapidamente\n"
            "anche pareti verticali. Rileva\n"
            "l'umidità attraverso la coda\n"
            "per prevedere il tempo dell'indomani."),
        .pokemonScale = 541,
        .pokemonOffset = 19,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GROVYLE] =
    {
        ...
        .weight = 216,
        .description = COMPOUND_STRING(
            "I muscoli delle zampe estremamente\n"
            "sviluppati gli permettono\n"
            "di saltare fino a grandi altezze."),
        .pokemonScale = 360,
        .pokemonOffset = 5,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SCEPTILE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "braccia tagliano anche grandi\n"
            "alberi. Nel suo habitat, è imbattibile."),
        .pokemonScale = 256,
        .pokemonOffset = -1,
        .trainerScale = 275,
        .trainerOffset = 2,
    ...
    [SPECIES_TORCHIC] =
    {
        ...
        .weight = 25,
        .description = COMPOUND_STRING(
            "Nel ventre ha una sacca di fuoco\n"
            "che brucia in continuazione.\n"
            "Se lo si abbraccia, emana calore."),
        .pokemonScale = 566,
        .pokemonOffset = 19,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_COMBUSKEN] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "dieci calci al secondo. Emette\n"
            "urla strazianti per intimorire i nemici."),
        .pokemonScale = 343,
        .pokemonOffset = 5,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BLAZIKEN] =
    {
        ...
        .weight = 520,
        .description = COMPOUND_STRING(
            "Riesce a superare un edificio\n"
            "di 30 piani con un salto. I suoi\n"
            "pugni di fuoco inceneriscono il nemico."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 301,
        .trainerOffset = 4,
    ...
    [SPECIES_MUDKIP] =
    {
        ...
        .weight = 76,
        .description = COMPOUND_STRING(
            "La grande pinna sulla coda gli conferisce\n"
            "una straordinaria accelerazione\n"
            "in acqua. È minuto, ma forte."),
        .pokemonScale = 535,
        .pokemonOffset = 20,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MARSHTOMP] =
    {
        ...
        .weight = 280,
        .description = COMPOUND_STRING(
            "Grazie alle zampe vigorose, si\n"
            "muove con disinvoltura anche\n"
            "nel fango. Dorme immerso nella melma."),
        .pokemonScale = 340,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SWAMPERT] =
    {
        ...
        .weight = 819,
        .description = COMPOUND_STRING(
            "Ha braccia dure come roccia,\n"
            "capaci di frantumare in\n"
            "mille pezzi un masso con un colpo solo."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MIGHTYENA] =
    {
        ...
        .weight = 370,
        .description = COMPOUND_STRING(
            "La sua eccezionale obbedienza verso\n"
            "gli Allenatori esperti deriva dall'antica\n"
            "abitudine di vivere in branchi."),
        .pokemonScale = 362,
        .pokemonOffset = 9,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LINOONE] =
    {
        ...
        .weight = 325,
        .description = COMPOUND_STRING(
            "Quando corre in rettilineo\n"
            "può raggiungere i 100 km/h,\n"
            "ma le curve non sono il suo forte."),
        .pokemonScale = 321,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_OBSTAGOON] =
    {
        ...
        .categoryName = _("Bloccaggio"),
        .height = 16,
        .weight = 460,
        .description = COMPOUND_STRING(
            "Ha una potenza vocale impressionante.\n"
            "Quando assume la tipica posa\n"
            "intimidatoria e si mette a urlare,\n"
            "si dice che sta facendo “sbarramento”."),
        .pokemonScale = 259,
        .pokemonOffset = 1,
        .trainerScale = 296,
        .trainerOffset = 1,
    ...
    [SPECIES_WURMPLE] =
    {
        ...
        .weight = 36,
        .description = COMPOUND_STRING(
            "Ama mangiare le foglie. Se Starly\n"
            "lo attacca, si difende con gli\n"
            "aculei che ha sulla parte posteriore."),
        .pokemonScale = 711,
        .pokemonOffset = 24,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SILCOON] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Aspetta l'evoluzione bevendo\n"
            "l'acqua piovana che si posa sulla seta."),
        .pokemonScale = 431,
        .pokemonOffset = 19,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BEAUTIFLY] =
    {
        ...
        .weight = 284,
        .description = COMPOUND_STRING(
            "Sulle ali ha splendidi, vividi\n"
            "colori. Succhia il dolce polline\n"
            "dai fiori allungando la bocca sottile."),
        .pokemonScale = 298,
        .pokemonOffset = -1,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CASCOON] =
    {
        ...
        .weight = 115,
        .description = COMPOUND_STRING(
            "Il corpo di soffice seta si indurisce\n"
            "nel corso del tempo. Quando\n"
            "appaiono crepe, l'evoluzione è vicina."),
        .pokemonScale = 391,
        .pokemonOffset = 20,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DUSTOX] =
    {
        ...
        .weight = 316,
        .description = COMPOUND_STRING(
            "Pokémon notturno. Attirato\n"
            "dalla luce dei lampioni, divora\n"
            "le foglie degli alberi lungo i viali."),
        .pokemonScale = 269,
        .pokemonOffset = 1,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LOTAD] =
    {
        ...
        .weight = 26,
        .description = COMPOUND_STRING(
            "Sembra una pianta acquatica\n"
            "e viene usato come traghetto\n"
            "dai Pokémon che non sanno nuotare."),
        .pokemonScale = 406,
        .pokemonOffset = 19,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LOMBRE] =
    {
        ...
        .weight = 325,
        .description = COMPOUND_STRING(
            "Vive in riva a specchi d'acqua, in aree\n"
            "soleggiate. Di giorno dorme su di un\n"
            "letto di alghe, mentre la notte è attivo."),
        .pokemonScale = 277,
        .pokemonOffset = 9,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LUDICOLO] =
    {
        ...
        .weight = 550,
        .description = COMPOUND_STRING(
            "Se ascolta musica allegra,\n"
            "tutto il suo corpo si rivitalizza\n"
            "e non riesce a evitare di ballare."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 268,
        .trainerOffset = -1,
    ...
    [SPECIES_SEEDOT] =
    {
        ...
        .weight = 40,
        .description = COMPOUND_STRING(
            "Si attacca ai rami degli alberi\n"
            "usando il picciolo che ha sul\n"
            "capo. Talvolta il vento lo fa cadere."),
        .pokemonScale = 472,
        .pokemonOffset = 20,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_NUZLEAF] =
    {
        ...
        .weight = 280,
        .description = COMPOUND_STRING(
            "Il fischio del suo flauto di\n"
            "foglia mette a disagio chi lo\n"
            "sente. Vive nelle foreste più fitte."),
        .pokemonScale = 299,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SHIFTRY] =
    {
        ...
        .weight = 596,
        .description = COMPOUND_STRING(
            "Un tempo era un temuto guardiano\n"
            "della foresta. Sa leggere\n"
            "nella mente del nemico, anticipandolo."),
        .pokemonScale = 290,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TAILLOW] =
    {
        ...
        .weight = 23,
        .description = COMPOUND_STRING(
            "È molto coraggioso e\n"
            "affronta spavaldo i nemici\n"
    ...
    [SPECIES_SWELLOW] =
    {
        ...
        .weight = 198,
        .description = COMPOUND_STRING(
            "Se le due penne sulla coda sono\n"
            "ritte, significa che è in buona\n"
            "salute. Si libra elegantemente nel cielo."),
        .pokemonScale = 428,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_WINGULL] =
    {
        ...
        .weight = 95,
        .description = COMPOUND_STRING(
            "Segue i venti marini con le sue\n"
            "lunghe ali e si libra in volo come\n"
            "un aliante. Si riposa piegando le ali."),
        .pokemonScale = 295,
        .pokemonOffset = -2,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PELIPPER] =
    {
        ...
        .weight = 280,
        .description = COMPOUND_STRING(
            "Immerge il suo enorme becco nel mare,\n"
            "raccogliendo acqua e numerose prede."),
        .pokemonScale = 288,
        .pokemonOffset = 1,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_RALTS] =
    {
        ...
        .weight = 66,
        .description = COMPOUND_STRING(
            "Se con le corna avverte emozioni\n"
    ...
    [SPECIES_KIRLIA] =
    {
        ...
        .weight = 202,
        .description = COMPOUND_STRING(
            "Lo spirito gioioso è alla base dei\n"
            "suoi poteri psicocinetici. Quando\n"
            "è felice si lancia in danze e piroette."),
        .pokemonScale = 354,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GARDEVOIR] =
    {
        ...
        .weight = 484,
        .description = COMPOUND_STRING(
            "Quando il suo Allenatore è in\n"
            "pericolo usa tutto il suo potere\n"
            "psichico per creare un piccolo buco nero."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GALLADE] =
    {
        ...
        .weight = 520,
        .description = COMPOUND_STRING(
            "Il suo intuito gli consente\n"
            "di capire cosa pensa il\n"
    ...
    [SPECIES_SURSKIT] =
    {
        ...
        .weight = 17,
        .description = COMPOUND_STRING(
            "Normalmente vivono negli stagni, ma\n"
            "dopo un acquazzone è possibile trovarli\n"
            "anche in città, nelle pozzanghere."),
        .pokemonScale = 375,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MASQUERAIN] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "motivo a occhi. Con le quattro\n"
            "ali riesce a volare in ogni direzione."),
        .pokemonScale = 378,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SHROOMISH] =
    {
        ...
        .weight = 45,
        .description = COMPOUND_STRING(
            "Predilige le aree umide. Di giorno resta\n"
            "immobile nell'ombra della foresta.\n"
            "Dal capo rilascia polvere tossica."),
        .pokemonScale = 513,
        .pokemonOffset = 22,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BRELOOM] =
    {
        ...
        .weight = 392,
        .description = COMPOUND_STRING(
            "Tirando pugni, i suoi cortissimi\n"
            "arti si allungano. Usa una tecnica\n"
            "simile a quella dei pugili professionisti."),
        .pokemonScale = 324,
        .pokemonOffset = 6,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_VIGOROTH] =
    {
        ...
        .weight = 465,
        .description = COMPOUND_STRING(
            "I battiti del suo cuore sono rapidissimi\n"
            "e il suo sangue scorre con tale impeto\n"
            "che non riesce a stare fermo un istante."),
        .pokemonScale = 301,
        .pokemonOffset = 2,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SLAKING] =
    {
        ...
        .weight = 1305,
        .description = COMPOUND_STRING(
            "Il più pigro Pokémon del\n"
            "mondo. Si sposta solo quando\n"
            "non ha più cibo a portata di mano."),
        .pokemonScale = 256,
        .pokemonOffset = 2,
        .trainerScale = 300,
        .trainerOffset = 1,
    ...
    [SPECIES_NINCADA] =
    {
        ...
        .weight = 55,
        .description = COMPOUND_STRING(
            "Poiché passa quasi tutta\n"
            "l'esistenza sottoterra, è quasi\n"
            "cieco. Usa le antenne per orientarsi."),
        .pokemonScale = 405,
        .pokemonOffset = 21,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_NINJASK] =
    {
        ...
        .weight = 120,
        .description = COMPOUND_STRING(
            "I suoi continui lamenti provocano\n"
            "atroci emicranie. Si sposta\n"
            "così velocemente che... non si vede!"),
        .pokemonScale = 383,
        .pokemonOffset = -9,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SHEDINJA] =
    {
        ...
        .weight = 12,
        .description = COMPOUND_STRING(
            "È nato dal guscio vuoto di un\n"
            "insetto. Pare che chi spia nella\n"
            "fessura sul suo dorso perda l'anima."),
        .pokemonScale = 372,
        .pokemonOffset = -8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_WHISMUR] =
    {
        ...
        .weight = 163,
        .description = COMPOUND_STRING(
            "Di solito sussurra, ma se avverte\n"
            "un pericolo lancia grida acute, che\n"
            "interrompe quando ha le orecchie chiuse."),
        .pokemonScale = 373,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LOUDRED] =
    {
        ...
        .weight = 405,
        .description = COMPOUND_STRING(
            "Leva potenti grida inspirando\n"
            "tanta aria e poi sparandola fuori\n"
            "con tutta la forza degli addominali."),
        .pokemonScale = 356,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_EXPLOUD] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "distanza. Emette diversi suoni\n"
            "dalle numerose aperture del suo corpo."),
        .pokemonScale = 284,
        .pokemonOffset = 1,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MAKUHITA] =
    {
        ...
        .weight = 864,
        .description = COMPOUND_STRING(
            "Sbattendo a ripetizione contro\n"
            "enormi alberi, si costruisce\n"
            "un corpo e uno spirito indistruttibili."),
        .pokemonScale = 256,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_HARIYAMA] =
    {
        ...
        .weight = 2538,
        .description = COMPOUND_STRING(
            "Pesta i piedi sul terreno per accumulare\n"
            "energia. Con uno dei suoi schiaffi può\n"
    ...
    [SPECIES_NOSEPASS] =
    {
        ...
        .weight = 970,
        .description = COMPOUND_STRING(
            "Rafforza le sue difese attirando\n"
            "su di sé gli oggetti di ferro\n"
            "circostanti con il suo naso\n"
            "magnetico che indica sempre il nord."),
        .pokemonScale = 256,
        .pokemonOffset = 9,
        .trainerScale = 289,
        .trainerOffset = 3,
    ...
    [SPECIES_PROBOPASS] =
    {
        ...
        .weight = 3400,
        .description = COMPOUND_STRING(
            "Emana un forte magnetismo\n"
            "da tutto il corpo. Controlla\n"
    ...
    [SPECIES_SKITTY] =
    {
        ...
        .weight = 110,
        .description = COMPOUND_STRING(
            "Non riesce a evitare di inseguire\n"
            "tutto ciò che si muove e corre\n"
            "in tondo a caccia della propria coda."),
        .pokemonScale = 492,
        .pokemonOffset = 19,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DELCATTY] =
    {
        ...
        .weight = 326,
        .description = COMPOUND_STRING(
            "Detesta gli ambienti sporchi.\n"
            "Se ne sta sempre ad allisciarsi\n"
            "la pelliccia in luoghi accoglienti."),
        .pokemonScale = 322,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SABLEYE] =
    {
        ...
        .weight = 110,
        .description = COMPOUND_STRING(
            "Si cela nell'oscurità delle\n"
            "caverne. Si nutre di gemme e per\n"
            "questo i suoi occhi sono pietre preziose."),
        .pokemonScale = 451,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MAWILE] =
    {
        ...
        .weight = 115,
        .description = COMPOUND_STRING(
            "Intenerisce i nemici con la sua\n"
            "faccia innocente, per poi morderli\n"
            "con le forti e instancabili mascelle."),
        .pokemonScale = 466,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ARON] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "cibarsi di binari ferroviari e automobili."),
        .pokemonScale = 419,
        .pokemonOffset = 23,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LAIRON] =
    {
        ...
        .weight = 1200,
        .description = COMPOUND_STRING(
            "Adora i minerali di ferro. Scaglia\n"
            "il suo corpo d'acciaio contro\n"
            "gli altri nella lotta per il territorio."),
        .pokemonScale = 275,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_AGGRON] =
    {
        ...
        .weight = 3600,
        .description = COMPOUND_STRING(
            "Sceglie come territorio intere\n"
            "montagne. Se ha tante cicatrici sul\n"
            "suo corpo, è meglio non scherzare con lui."),
        .pokemonScale = 256,
        .pokemonOffset = -1,
        .trainerScale = 350,
        .trainerOffset = 6,
    ...
    [SPECIES_MEDITITE] =
    {
        ...
        .weight = 112,
        .description = COMPOUND_STRING(
            "Si allena in montagna per\n"
            "elevare il suo potere spirituale.\n"
            "Con la meditazione riesce a levitare."),
        .pokemonScale = 465,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MEDICHAM] =
    {
        ...
        .weight = 315,
        .description = COMPOUND_STRING(
            "Evita elegantemente gli\n"
            "attacchi a passo di danza,\n"
            "per poi lanciare devastanti\n"
            "attacchi con la stessa grazia."),
        .pokemonScale = 298,
        .pokemonOffset = 5,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ELECTRIKE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "pelliccia gli stimola i muscoli\n"
            "e aumenta la sua velocità di reazione."),
        .pokemonScale = 290,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MANECTRIC] =
    {
        ...
        .weight = 402,
        .description = COMPOUND_STRING(
            "Raramente si mostra agli\n"
            "umani. Si dice che nidifichi\n"
    ...
    [SPECIES_PLUSLE] =
    {
        ...
        .weight = 42,
        .description = COMPOUND_STRING(
            "Incoraggia gli amici con un\n"
            "vivace scoppiettio di scintille.\n"
            "Assorbe elettricità dai pali telefonici."),
        .pokemonScale = 515,
        .pokemonOffset = -9,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MINUN] =
    {
        ...
        .weight = 42,
        .description = COMPOUND_STRING(
            "L'elettricità tra un Plusle e un\n"
    ...
    [SPECIES_VOLBEAT] =
    {
        ...
        .weight = 177,
        .description = COMPOUND_STRING(
            "Di notte comunica con gli\n"
            "altri illuminando la sua\n"
    ...
    [SPECIES_ILLUMISE] =
    {
        ...
        .weight = 177,
        .description = COMPOUND_STRING(
            "Con un dolce aroma dirige il volo\n"
            "dei Volbeat, che disegnano più di\n"
            "200 figure luminose nel cielo stellato."),
        .pokemonScale = 572,
        .pokemonOffset = 19,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BUDEW] =
    {
        ...
        .weight = 12,
        .description = COMPOUND_STRING(
            "I raggi del sole gli fanno schiudere\n"
            "la gemma e rilasciare polline.\n"
            "Fa la tana vicino a bei corsi d'acqua."),
        .pokemonScale = 682,
        .pokemonOffset = 24,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ROSELIA] =
    {
        ...
        .weight = 20,
        .description = COMPOUND_STRING(
            "Attacca usando abilmente i due tipi di\n"
            "veleno delle estremità dei suoi arti. Più\n"
            "è forte la sua fragranza, più è in salute."),
        .pokemonScale = 677,
        .pokemonOffset = 20,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ROSERADE] =
    {
        ...
        .weight = 145,
        .description = COMPOUND_STRING(
            "Attira la preda con il suo\n"
            "profumo soave per poi afferrarla\n"
    ...
    [SPECIES_GULPIN] =
    {
        ...
        .weight = 103,
        .description = COMPOUND_STRING(
            "Ha cuore e cervello mini: lo stomaco\n"
            "prende troppo spazio! Con i\n"
            "succhi gastrici scioglie qualunque cosa."),
        .pokemonScale = 593,
        .pokemonOffset = 23,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SWALOT] =
    {
        ...
        .weight = 800,
        .description = COMPOUND_STRING(
            "Inghiotte intera qualsiasi\n"
            "cosa. Dai pori traspira un\n"
            "liquido tossico con cui bagna i nemici."),
        .pokemonScale = 256,
        .pokemonOffset = 6,
        .trainerScale = 345,
        .trainerOffset = 3,
    ...
    [SPECIES_CARVANHA] =
    {
        ...
        .weight = 208,
        .description = COMPOUND_STRING(
            "I Carvanha attaccano le navi in\n"
            "branco e ne strappano gli scafi\n"
            "a morsi. Abitano i fiumi della giungla."),
        .pokemonScale = 362,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SHARPEDO] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "il ferro. Nuota a 120 km/h.\n"
            "È noto come il “Tiranno del mare”."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 317,
        .trainerOffset = 3,
    ...
    [SPECIES_WAILMER] =
    {
        ...
        .weight = 1300,
        .description = COMPOUND_STRING(
            "Si diverte a rimbalzare come\n"
            "una palla. Più acqua di mare\n"
            "ingolla, più in alto riesce a rimbalzare."),
        .pokemonScale = 256,
        .pokemonOffset = 2,
        .trainerScale = 493,
        .trainerOffset = 0,
    ...
    [SPECIES_WAILORD] =
    {
        ...
        .weight = 3980,
        .description = COMPOUND_STRING(
            "L'impatto creato dai suoi salti\n"
            "fuori e dentro l'acqua può\n"
            "arrivare a mandare KO un avversario."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 1352,
        .trainerOffset = 18,
    ...
    [SPECIES_NUMEL] =
    {
        ...
        .weight = 240,
        .description = COMPOUND_STRING(
            "Nella gobba accumula magma.\n"
            "Quando piove, il magma si\n"
            "indurisce e il Pokémon diventa più lento."),
        .pokemonScale = 342,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CAMERUPT] =
    {
        ...
        .weight = 2200,
        .description = COMPOUND_STRING(
            "I vulcani sul suo dorso\n"
            "eruttano ogni dieci anni\n"
            "o quando è veramente arrabbiato."),
        .pokemonScale = 256,
        .pokemonOffset = 7,
        .trainerScale = 345,
        .trainerOffset = 6,
    ...
    [SPECIES_TORKOAL] =
    {
        ...
        .weight = 804,
        .description = COMPOUND_STRING(
            "I Torkoal eleggono a propria dimora\n"
            "miniere di carbone abbandonate\n"
            "e vi scavano carbone con ardore."),
        .pokemonScale = 390,
        .pokemonOffset = 9,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GRUMPIG] =
    {
        ...
        .weight = 715,
        .description = COMPOUND_STRING(
            "Amplifica i suoi poteri\n"
            "psichici con le sue perle nere.\n"
            "Si esibisce anche in danze\n"
    ...
    [SPECIES_SPINDA] =
    {
        ...
        .weight = 50,
        .description = COMPOUND_STRING(
            "Non ci sono due Spinda con lo\n"
            "stesso motivo maculato. Il suo\n"
            "passo barcollante confonde i nemici."),
        .pokemonScale = 321,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TRAPINCH] =
    {
        ...
        .weight = 150,
        .description = COMPOUND_STRING(
            "Vive nei deserti. Scava buche nel\n"
            "terreno e vi si apposta, attendendo\n"
            "che le prede vi caschino dentro."),
        .pokemonScale = 298,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_VIBRAVA] =
    {
        ...
        .weight = 153,
        .description = COMPOUND_STRING(
            "Fa vibrare velocemente le ali\n"
            "generando onde ultrasoniche\n"
            "che provocano dei forti mal di testa."),
        .pokemonScale = 370,
        .pokemonOffset = 11,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_FLYGON] =
    {
        ...
        .weight = 820,
        .description = COMPOUND_STRING(
            "Solleva sabbia con le ali per\n"
            "nascondersi. Un rivestimento rosso\n"
            "protegge gli occhi dalla sabbia stessa."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 268,
        .trainerOffset = 1,
    ...
    [SPECIES_CACNEA] =
    {
        ...
        .weight = 513,
        .description = COMPOUND_STRING(
            "Cacnea vive in zone aride, dove\n"
            "non piove quasi mai. Il suo\n"
            "fiore giallo sboccia una volta all'anno."),
        .pokemonScale = 455,
        .pokemonOffset = 20,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CACTURNE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "quando va a caccia di prede\n"
            "stremate dalla calura del deserto."),
        .pokemonScale = 327,
        .pokemonOffset = 5,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SWABLU] =
    {
        ...
        .weight = 12,
        .description = COMPOUND_STRING(
            "Per qualche motivo adora salire\n"
            "sulla testa delle persone\n"
            "e far finta di essere un cappello."),
        .pokemonScale = 422,
        .pokemonOffset = -8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ALTARIA] =
    {
        ...
        .weight = 206,
        .description = COMPOUND_STRING(
            "Volteggia elegante nel cielo.\n"
            "Canticchia soavemente, mandando\n"
            "in onirica estasi chi lo ascolta."),
        .pokemonScale = 327,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ZANGOOSE] =
    {
        ...
        .weight = 403,
        .description = COMPOUND_STRING(
            "Da generazioni, è acerrimo\n"
            "nemico di Seviper. Gli artigli\n"
            "aguzzi sono le sue armi più potenti."),
        .pokemonScale = 256,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SEVIPER] =
    {
        ...
        .weight = 525,
        .description = COMPOUND_STRING(
            "Respinge gli attacchi dell'agile\n"
            "Zangoose con la coda affilatissima,\n"
            "che secerne un micidiale veleno."),
        .pokemonScale = 275,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LUNATONE] =
    {
        ...
        .weight = 1680,
        .description = COMPOUND_STRING(
            "Diventa attivo nelle notti di\n"
            "luna piena, pertanto si dice che\n"
            "abbia qualche legame con le fasi lunari."),
        .pokemonScale = 300,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SOLROCK] =
    {
        ...
        .weight = 1540,
        .description = COMPOUND_STRING(
            "L'energia solare è la fonte della sua\n"
            "potenza, per cui è più forte di giorno.\n"
    ...
    [SPECIES_BARBOACH] =
    {
        ...
        .weight = 19,
        .description = COMPOUND_STRING(
            "Il suo corpo è ricoperto da\n"
            "una pellicola viscida, che gli\n"
            "permette di sgusciare via, se afferrato."),
        .pokemonScale = 581,
        .pokemonOffset = -3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_WHISCASH] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "nelle grandi paludi. Se il nemico\n"
            "gli si accosta, provoca un terremoto."),
        .pokemonScale = 317,
        .pokemonOffset = 1,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CORPHISH] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "di adattarsi e proliferare anche\n"
            "nelle acque dei fiumi più inquinati."),
        .pokemonScale = 484,
        .pokemonOffset = 19,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CRAWDAUNT] =
    {
        ...
        .weight = 328,
        .description = COMPOUND_STRING(
            "Pokémon violento che afferra\n"
            "il nemico con le chele e\n"
            "lo scaraventa fuori dal suo stagno."),
        .pokemonScale = 365,
        .pokemonOffset = 9,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BALTOY] =
    {
        ...
        .weight = 215,
        .description = COMPOUND_STRING(
            "Si sposta piroettando sull'unica\n"
            "estremità inferiore del\n"
            "proprio corpo. Molti fanno la verticale."),
        .pokemonScale = 457,
        .pokemonOffset = 21,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CLAYDOL] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "statuetta d'argilla portata\n"
            "in vita da misteriose radiazioni."),
        .pokemonScale = 256,
        .pokemonOffset = 3,
        .trainerScale = 280,
        .trainerOffset = 1,
    ...
    [SPECIES_LILEEP] =
    {
        ...
        .weight = 238,
        .description = COMPOUND_STRING(
            "Cattura le prede che si avvicinano\n"
            "con i tentacoli a forma di corolla.\n"
            "Si è estinto 100 milioni di anni fa."),
        .pokemonScale = 305,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ANORITH] =
    {
        ...
        .weight = 125,
        .description = COMPOUND_STRING(
            "Pokémon di tipo primitivo, usa i\n"
            "lunghi artigli per catturare prede\n"
            "nascoste tra le rocce in fondo al mare."),
        .pokemonScale = 296,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ARMALDO] =
    {
        ...
        .weight = 682,
        .description = COMPOUND_STRING(
            "Cattura il nemico infilzandolo\n"
            "con gli enormi artigli retrattili.\n"
            "È rivestito di una robusta corazza."),
        .pokemonScale = 312,
        .pokemonOffset = 3,
        .trainerScale = 271,
        .trainerOffset = 0,
    ...
    [SPECIES_FEEBAS] =
    {
        ...
        .weight = 74,
        .description = COMPOUND_STRING(
            "Si nutre di qualsiasi cosa, pertanto\n"
    ...
    [SPECIES_MILOTIC] =
    {
        ...
        .weight = 1620,
        .description = COMPOUND_STRING(
            "Pokémon di una bellezza vertiginosa. Chi\n"
            "lo vede perde ogni voglia di combattere."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 360,
        .trainerOffset = 7,
    ...
    [SPECIES_CASTFORM_NORMAL] =
    {
        ...
        .weight = 8,
        .description = COMPOUND_STRING(
            "Il suo aspetto varia con\n"
            "l'umidità e la temperatura, che\n"
            "influenzano la sua struttura molecolare."),
        .pokemonScale = 435,
        .pokemonOffset = -5,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_KECLEON] =
    {
        ...
        .weight = 220,
        .description = COMPOUND_STRING(
            "Può mutare il colore del corpo\n"
            "a piacimento. Tuttavia, il\n"
            "motivo a zigzag sul ventre non cambia."),
        .pokemonScale = 316,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SHUPPET] =
    {
        ...
        .weight = 23,
        .description = COMPOUND_STRING(
            "Si dice che si nutra di rancore\n"
            "e invidia con il corno che ha\n"
            "sulla testa. A mezzanotte si scatena."),
        .pokemonScale = 440,
        .pokemonOffset = 20,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BANETTE] =
    {
        ...
        .weight = 125,
        .description = COMPOUND_STRING(
            "Un peluche divenuto Pokémon per\n"
            "la rabbia di essere stato buttato\n"
            "via da un bimbo, di cui è alla ricerca."),
        .pokemonScale = 262,
        .pokemonOffset = 9,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DUSKULL] =
    {
        ...
        .weight = 150,
        .description = COMPOUND_STRING(
            "Segue ostinatamente la\n"
            "preda ovunque essa vada.\n"
    ...
    [SPECIES_DUSCLOPS] =
    {
        ...
        .weight = 306,
        .description = COMPOUND_STRING(
            "Se si osserva troppo da vicino la\n"
            "palla di fuoco dentro Dusclops,\n"
            "la propria anima viene risucchiata."),
        .pokemonScale = 256,
        .pokemonOffset = 3,
        .trainerScale = 299,
        .trainerOffset = 1,
    ...
    [SPECIES_DUSKNOIR] =
    {
        ...
        .categoryName = _("Pinza"),
        .height = 22,
        .weight = 1066,
        .description = COMPOUND_STRING(
            "Si dice che accolga gli\n"
            "spiriti smarriti nel suo\n"
            "corpo flessibile per riportarli a casa."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 348,
        .trainerOffset = 6,
    ...
    [SPECIES_TROPIUS] =
    {
        ...
        .weight = 1000,
        .description = COMPOUND_STRING(
            "Vola sbattendo delle grandi\n"
            "ali a forma di foglia e\n"
            "distribuisce ai bambini i deliziosi\n"
            "frutti che gli crescono sul collo."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 344,
        .trainerOffset = 7,
    ...
    [SPECIES_CHINGLING] =
    {
        ...
        .categoryName = _("Sonaglio"),
        .height = 2,
        .weight = 6,
        .description = COMPOUND_STRING(
            "A ogni salto produce un suono che\n"
            "sembra uno squillo. I suoi versi\n"
            "ad alta frequenza assordano i nemici."),
        .pokemonScale = 682,
        .pokemonOffset = 24,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CHIMECHO] =
    {
        ...
        .weight = 10,
        .description = COMPOUND_STRING(
            "Emette sette tipi di versi penzolando\n"
            "da rami o cornicioni, a cui si\n"
            "attacca con la ventosa che ha sul capo."),
        .pokemonScale = 505,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ABSOL] =
    {
        ...
        .weight = 470,
        .description = COMPOUND_STRING(
            "Percepisce i disastri naturali\n"
            "imminenti e si mostra solo\n"
            "per avvertire la gente del pericolo."),
        .pokemonScale = 301,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GLALIE] =
    {
        ...
        .weight = 2565,
        .description = COMPOUND_STRING(
            "Per difendersi, riveste il suo\n"
            "corpo con un'armatura di ghiaccio,\n"
            "fatta congelando l'umidità dell'aria."),
        .pokemonScale = 256,
        .pokemonOffset = 3,
        .trainerScale = 344,
        .trainerOffset = 0,
    ...
    [SPECIES_FROSLASS] =
    {
        ...
        .categoryName = _("Suolnevoso"),
        .height = 13,
        .weight = 266,
        .description = COMPOUND_STRING(
            "Congela i nemici con un alito glaciale\n"
            "a -50 gradi. Il suo corpo è vuoto."),
        .pokemonScale = 272,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SPHEAL] =
    {
        ...
        .weight = 395,
        .description = COMPOUND_STRING(
            "Non sa ancora nuotare molto bene e\n"
            "si muove più velocemente rotolando.\n"
            "Quando è felice batte le pinne."),
        .pokemonScale = 315,
        .pokemonOffset = 16,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SEALEO] =
    {
        ...
        .weight = 876,
        .description = COMPOUND_STRING(
            "Per memorizzare un nuovo oggetto,\n"
            "ha bisogno di toccarlo con il\n"
            "naso, dove risiede la sua sensibilità."),
        .pokemonScale = 338,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_WALREIN] =
    {
        ...
        .weight = 1506,
        .description = COMPOUND_STRING(
            "Frantuma il ghiaccio con le\n"
            "zanne. Lo spesso strato adiposo\n"
            "respinge il freddo e gli attacchi nemici."),
        .pokemonScale = 316,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CLAMPERL] =
    {
        ...
        .weight = 525,
        .description = COMPOUND_STRING(
            "Crea una sola perla in tutta\n"
            "la sua vita, quando si evolve.\n"
            "Questa perla amplifica i poteri psichici."),
        .pokemonScale = 691,
        .pokemonOffset = 22,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_HUNTAIL] =
    {
        ...
        .weight = 270,
        .description = COMPOUND_STRING(
            "Vive in mare a grandi profondità, dove\n"
            "non filtra nessuna luce. Attira le prede\n"
    ...
    [SPECIES_GOREBYSS] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "il suo corpo rosato diventa\n"
            "più vivido per chissà quale motivo."),
        .pokemonScale = 278,
        .pokemonOffset = 5,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_RELICANTH] =
    {
        ...
        .weight = 234,
        .description = COMPOUND_STRING(
            "Immutato da 100 milioni di\n"
            "anni, è stato scoperto durante\n"
            "un'esplorazione nelle profondità marine."),
        .pokemonScale = 316,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BAGON] =
    {
        ...
        .weight = 421,
        .description = COMPOUND_STRING(
            "Frantuma grandi massi con\n"
            "la testa dura come il ferro\n"
            "e gli allenatissimi muscoli del collo."),
        .pokemonScale = 448,
        .pokemonOffset = 18,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SALAMENCE] =
    {
        ...
        .weight = 1026,
        .description = COMPOUND_STRING(
            "Quando è adirato diventa una furia. Con\n"
            "i suoi artigli laceranti e le fiammate che\n"
            "lancia può distruggere qualsiasi cosa."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BELDUM] =
    {
        ...
        .weight = 952,
        .description = COMPOUND_STRING(
            "Riesce a fluttuare in aria grazie\n"
            "alla repulsione tra le proprie\n"
            "onde magnetiche e quelle della terra."),
        .pokemonScale = 414,
        .pokemonOffset = -1,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_METANG] =
    {
        ...
        .weight = 2025,
        .description = COMPOUND_STRING(
            "È sorto dalla fusione di due\n"
            "Beldum. Il suo corpo d'acciaio non\n"
            "viene scalfito neanche se urta un jet."),
        .pokemonScale = 256,
        .pokemonOffset = 6,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_METAGROSS] =
    {
        ...
        .weight = 5500,
        .description = COMPOUND_STRING(
            "Con l'incredibile velocità di calcolo dei\n"
            "suoi quattro cervelli analizza il nemico\n"
            "più rapidamente di un supercomputer."),
        .pokemonScale = 256,
        .pokemonOffset = 4,
        .trainerScale = 447,
        .trainerOffset = 9,
    ...
    [SPECIES_REGIROCK] =
    {
        ...
        .weight = 2300,
        .description = COMPOUND_STRING(
            "È formato interamente da\n"
            "rocce. Se si staccano nella\n"
            "lotta, ne cerca altre per sostituirle."),
        .pokemonScale = 256,
        .pokemonOffset = 2,
        .trainerScale = 309,
        .trainerOffset = 1,
    ...
    [SPECIES_REGICE] =
    {
        ...
        .weight = 1750,
        .description = COMPOUND_STRING(
            "Si dice che sia rimasto a dormire nei\n"
            "ghiacci per alcuni millenni. Nemmeno\n"
            "il magma riuscirebbe a scioglierlo."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 301,
        .trainerOffset = 2,
    ...
    [SPECIES_REGISTEEL] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "ha reso il suo corpo resistentissimo."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 359,
        .trainerOffset = 6,
    ...
    [SPECIES_LATIAS] =
    {
        ...
        .weight = 400,
        .description = COMPOUND_STRING(
            "Sa comunicare telepaticamente.\n"
            "Le piume sul suo corpo riflettono\n"
            "la luce e lo rendono invisibile."),
        .pokemonScale = 304,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LATIOS] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Ripiegando indietro le ali,\n"
            "riesce a volare più veloce di un jet."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 294,
        .trainerOffset = 3,
    ...
    [SPECIES_KYOGRE] =
    {
        ...
        .weight = 3520,
        .description = COMPOUND_STRING(
            "Nella mitologia, Kyogre è il Pokémon\n"
            "che ha ampliato i mari con megaonde\n"
            "e megapiogge. Nemico di Groudon."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 614,
        .trainerOffset = 13,
    ...
    [SPECIES_GROUDON] =
    {
        ...
        .weight = 9500,
        .description = COMPOUND_STRING(
            "Si tramanda che fece evaporare\n"
            "l'acqua per aumentare la\n"
            "superficie terrestre. Nemico di Kyogre."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 515,
        .trainerOffset = 14,
    ...
    [SPECIES_RAYQUAZA] =
    {
        ...
        .weight = 2065,
        .description = COMPOUND_STRING(
            "Vive nello strato di\n"
            "ozono oltre le nuvole e\n"
            "non può essere avvistato da terra."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 448,
        .trainerOffset = 12,
    ...
    [SPECIES_JIRACHI] =
    {
        ...
        .weight = 11,
        .description = COMPOUND_STRING(
            "Da sempre si dice che al risveglio\n"
            "realizzi i desideri scritti\n"
            "sulle striscioline attaccate in testa."),
        .pokemonScale = 608,
        .pokemonOffset = -8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DEOXYS_NORMAL] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "mutazione genetica di un\n"
            "virus alieno giunto con un meteorite."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 290,
        .trainerOffset = 2,
