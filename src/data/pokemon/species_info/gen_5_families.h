...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_VICTINI] =
    {
        ...
        .description = COMPOUND_STRING(
            "Pokémon che porta la vittoria. Si\n"
            "dice che l'Allenatore che ha con sé\n"
            "Victini possa vincere qualsiasi lotta."),
        .pokemonScale = 491,
        .pokemonOffset = 16,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SNIVY] =
    {
        ...
        .weight = 81,
        .description = COMPOUND_STRING(
            "Quando è esposto alla luce solare\n"
            "può muoversi più velocemente. Usa\n"
            "le sue liane meglio dei suoi stessi arti."),
        .pokemonScale = 422,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SERVINE] =
    {
        ...
        .weight = 160,
        .description = COMPOUND_STRING(
            "Corre quasi scivolando sulle superfici.\n"
            "Confonde il nemico con i rapidi movimenti,\n"
            "per poi attaccarlo con una frustata."),
        .pokemonScale = 366,
        .pokemonOffset = 9,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_SERPERIOR] =
    {
        ...
        .weight = 630,
        .description = COMPOUND_STRING(
            "Dà il meglio di sé solo contro chi non\n"
    ...
    [SPECIES_TEPIG] =
    {
        ...
        .weight = 99,
        .description = COMPOUND_STRING(
            "Lancia palle di fuoco dal naso mentre\n"
            "evita abilmente gli attacchi del nemico.\n"
            "Mangia bacche che arrostisce lui stesso."),
        .pokemonScale = 432,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PIGNITE] =
    {
        ...
        .weight = 555,
        .description = COMPOUND_STRING(
            "Più mangia e più le fiamme che bruciano\n"
            "nel suo stomaco si rinvigoriscono,\n"
            "aumentando così il suo potere."),
        .pokemonScale = 305,
        .pokemonOffset = 8,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_EMBOAR] =
    {
        ...
        .weight = 1500,
        .description = COMPOUND_STRING(
            "Infiamma i pugni sulla barba ardente,\n"
            "poi sferra attacchi di fuoco sui nemici.\n"
    ...
    [SPECIES_OSHAWOTT] =
    {
        ...
        .weight = 59,
        .description = COMPOUND_STRING(
            "Non usa la conchiglia del suo\n"
            "ventre solo durante la lotta,\n"
    ...
    [SPECIES_DEWOTT] =
    {
        ...
        .weight = 245,
        .description = COMPOUND_STRING(
            "Ha appreso tramite un durissimo\n"
            "allenamento l'arte di maneggiare le\n"
            "sue due conchiglie come fossero lame."),
        .pokemonScale = 366,
        .pokemonOffset = 9,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_SAMUROTT] =
    {
        ...
        .weight = 946,
        .description = COMPOUND_STRING(
            "Riesce a estrarre le sue spade, colpire\n"
            "il nemico e riporle al loro posto nelle\n"
            "zampe anteriori in un batter d'occhio."),
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
        .trainerOffset = 0,
    ...
    [SPECIES_PATRAT] =
    {
        ...
        .weight = 116,
        .description = COMPOUND_STRING(
            "Immagazzina cibo nelle guance e monta\n"
            "la guardia per molti giorni di seguito.\n"
            "Usa la coda per fare segnali ai compagni."),
        .pokemonScale = 432,
        .pokemonOffset = 14,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_WATCHOG] =
    {
        ...
        .weight = 270,
        .description = COMPOUND_STRING(
            "Fa tentennare il nemico facendo brillare\n"
            "occhi e pelliccia grazie a una sostanza\n"
            "fluorescente contenuta nel suo corpo."),
        .pokemonScale = 320,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LILLIPUP] =
    {
        ...
        .weight = 41,
        .description = COMPOUND_STRING(
            "I lunghi peli che gli coprono il volto\n"
            "sono un radar molto sensibile alle\n"
    ...
    [SPECIES_HERDIER] =
    {
        ...
        .weight = 147,
        .description = COMPOUND_STRING(
            "È un Pokémon molto leale, che aiuta il\n"
            "suo Allenatore e al contempo si prende\n"
            "cura degli altri Pokémon della squadra."),
        .pokemonScale = 338,
        .pokemonOffset = 9,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_STOUTLAND] =
    {
        ...
        .weight = 610,
        .description = COMPOUND_STRING(
            "Soccorre chi si trova in difficoltà sulle\n"
            "montagne spazzate da bufere di neve.\n"
            "I lunghi peli lo proteggono dal freddo."),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PURRLOIN] =
    {
        ...
        .weight = 101,
        .description = COMPOUND_STRING(
            "Distrae con pose ammalianti i nemici\n"
            "incauti e ne approfitta per depredarli.\n"
            "Se si arrabbia, sguaina le unghie."),
        .pokemonScale = 491,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LIEPARD] =
    {
        ...
        .weight = 375,
        .description = COMPOUND_STRING(
            "I muscoli tonici del suo corpo gli donano\n"
            "una figura davvero affascinante. Si\n"
            "aggira silenzioso nel buio della notte."),
        .pokemonScale = 320,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PANSAGE] =
    {
        ...
        .weight = 105,
        .description = COMPOUND_STRING(
            "Distribuisce le foglie sulla sua\n"
            "testa ai Pokémon affaticati,\n"
    ...
    [SPECIES_SIMISAGE] =
    {
        ...
        .weight = 305,
        .description = COMPOUND_STRING(
            "Attacca il nemico colpendolo\n"
            "con la coda piena di aculei.\n"
    ...
    [SPECIES_PANSEAR] =
    {
        ...
        .weight = 110,
        .description = COMPOUND_STRING(
            "È molto intelligente e ha l'abitudine\n"
            "di arrostire le bacche prima di\n"
            "mangiarle. Adora aiutare gli esseri umani."),
        .pokemonScale = 422,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SIMISEAR] =
    {
        ...
        .weight = 280,
        .description = COMPOUND_STRING(
            "Alimentando la fiamma all'interno del suo\n"
            "corpo, sparge dalla testa o dalla coda\n"
            "una pioggia di fuoco che scotta i nemici."),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_PANPOUR] =
    {
        ...
        .weight = 135,
        .description = COMPOUND_STRING(
            "L'acqua contenuta nel suo ciuffo\n"
            "è ricca di nutrienti e la usa\n"
    ...
    [SPECIES_SIMIPOUR] =
    {
        ...
        .weight = 290,
        .description = COMPOUND_STRING(
            "Spruzza dalla coda un getto d'acqua ad\n"
            "alta pressione, con una potenza tale\n"
            "da distruggere anche pareti di cemento."),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_MUNNA] =
    {
        ...
        .weight = 233,
        .description = COMPOUND_STRING(
            "Compare accanto a Pokémon e\n"
            "uomini tormentati dagli incubi\n"
    ...
    [SPECIES_MUSHARNA] =
    {
        ...
        .weight = 605,
        .description = COMPOUND_STRING(
            "Nel fumo che gli esce dalla\n"
            "fronte sono racchiusi molti\n"
            "sogni di esseri umani e di Pokémon."),
        .pokemonScale = 320,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PIDOVE] =
    {
        ...
        .weight = 21,
        .description = COMPOUND_STRING(
            "È un Pokémon un po' smemorato. A volte\n"
            "dimentica l'ordine appena ricevuto\n"
            "e allora aspetta di riceverne un altro."),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TRANQUILL] =
    {
        ...
        .weight = 150,
        .description = COMPOUND_STRING(
            "Si dice che nel cuore della foresta\n"
            "in cui vive Tranquill si trovi\n"
    ...
    [SPECIES_UNFEZANT] =
    {
        ...
        .weight = 290,
        .description = COMPOUND_STRING(
            "Il maschio minaccia il nemico\n"
            "facendo ondeggiare gli ornamenti\n"
            "del capo. La femmina eccelle nel volo."),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BLITZLE] =
    {
        ...
        .weight = 298,
        .description = COMPOUND_STRING(
            "Appare quando il cielo si riempie di\n"
            "fulmini e saette. Accumula elettricità\n"
            "attirando i fulmini con la criniera."),
        .pokemonScale = 366,
        .pokemonOffset = 8,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_ZEBSTRIKA] =
    {
        ...
        .weight = 795,
        .description = COMPOUND_STRING(
            "Ha un temperamento sanguigno.\n"
            "Quando si arrabbia dalla\n"
    ...
    [SPECIES_ROGGENROLA] =
    {
        ...
        .weight = 180,
        .description = COMPOUND_STRING(
            "Ha un solo orecchio di forma esagonale.\n"
            "Essendo stato compresso sotto terra,\n"
            "il suo corpo è duro quasi come l'acciaio."),
        .pokemonScale = 491,
        .pokemonOffset = 16,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BOLDORE] =
    {
        ...
        .weight = 1020,
        .description = COMPOUND_STRING(
            "L'energia sovrabbondante cerca sfogo\n"
            "all'esterno del corpo e si solidifica\n"
            "formando cristalli di colore arancione."),
        .pokemonScale = 338,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GIGALITH] =
    {
        ...
        .weight = 2600,
        .description = COMPOUND_STRING(
            "Assorbe i raggi solari e, grazie\n"
            "al suo nucleo energetico, li\n"
            "trasforma in palle di luce che poi spara."),
        .pokemonScale = 259,
        .pokemonOffset = 0,
        .trainerScale = 290,
        .trainerOffset = 1,
    ...
    [SPECIES_WOOBAT] =
    {
        ...
        .weight = 21,
        .description = COMPOUND_STRING(
            "Vive nelle foreste buie o nelle\n"
            "caverne. Sonda l'ambiente circostante\n"
            "emettendo degli ultrasuoni dalle narici."),
        .pokemonScale = 491,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SWOOBAT] =
    {
        ...
        .weight = 105,
        .description = COMPOUND_STRING(
            "Quando emette delle onde\n"
            "ultrasoniche così forti da rompere\n"
    ...
    [SPECIES_DRILBUR] =
    {
        ...
        .weight = 85,
        .description = COMPOUND_STRING(
            "Sfreccia a gran velocità sotto terra,\n"
            "avvitandosi su se stesso, mentre si apre\n"
            "un passaggio scavando con le unghie."),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_EXCADRILL] =
    {
        ...
        .weight = 404,
        .description = COMPOUND_STRING(
            "La trivella si è evoluta diventando\n"
            "d'acciaio e può perforare una lastra di\n"
            "ferro. È molto utile per scavare tunnel."),
        .pokemonScale = 365,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_AUDINO] =
    {
        ...
        .weight = 310,
        .description = COMPOUND_STRING(
            "Le sue orecchie sono antenne capaci di\n"
            "sondare lo stato di salute degli altri\n"
            "o capire quando un uovo si schiuderà."),
        .pokemonScale = 320,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TIMBURR] =
    {
        ...
        .weight = 125,
        .description = COMPOUND_STRING(
            "Porta sempre con sé una tavola di legno.\n"
            "Appare nei cantieri dove aiuta nei lavori."),
        .pokemonScale = 422,
        .pokemonOffset = 14,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GURDURR] =
    {
        ...
        .weight = 400,
        .description = COMPOUND_STRING(
            "Ha un corpo pieno di muscoli e manovra\n"
            "con abilità la sua trave d'acciaio,\n"
            "con cui può abbattere una casa intera."),
        .pokemonScale = 282,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CONKELDURR] =
    {
        ...
        .weight = 870,
        .description = COMPOUND_STRING(
            "Si pensa che la tecnica per fare\n"
            "il cemento sia stata diffusa\n"
    ...
    [SPECIES_TYMPOLE] =
    {
        ...
        .weight = 45,
        .description = COMPOUND_STRING(
            "Fa vibrare le membrane sulle guance per\n"
            "emettere onde sonore impercettibili\n"
            "agli umani con cui segnala un pericolo."),
        .pokemonScale = 432,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PALPITOAD] =
    {
        ...
        .weight = 170,
        .description = COMPOUND_STRING(
            "Se fa vibrare il bernoccolo\n"
            "sulla testa può sollevare onde\n"
            "nell'acqua e anche provocare terremoti."),
        .pokemonScale = 366,
        .pokemonOffset = 10,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_SEISMITOAD] =
    {
        ...
        .weight = 620,
        .description = COMPOUND_STRING(
            "Facendo vibrare le protuberanze\n"
            "sui pugni, ne raddoppia la potenza.\n"
            "Frantuma enormi massi con un colpo."),
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
        .trainerOffset = 0,
    ...
    [SPECIES_THROH] =
    {
        ...
        .weight = 555,
        .description = COMPOUND_STRING(
            "La cintura da karate lo rende più forte.\n"
            "I Throh selvatici si costruiscono\n"
            "le cinture usando piante rampicanti."),
        .pokemonScale = 272,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SAWK] =
    {
        ...
        .weight = 510,
        .description = COMPOUND_STRING(
            "Si allena senza posa, giorno e\n"
            "notte, sui monti per potenziare\n"
    ...
    [SPECIES_SEWADDLE] =
    {
        ...
        .weight = 25,
        .description = COMPOUND_STRING(
            "Si prepara da sé i vestiti, tagliando\n"
            "le foglie e usando i fili viscosi\n"
            "che secerne dalla bocca per cucirli."),
        .pokemonScale = 530,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SWADLOON] =
    {
        ...
        .weight = 73,
        .description = COMPOUND_STRING(
            "Le foreste in cui vive Swadloon sono\n"
            "lussureggianti, poiché trasforma\n"
            "le foglie morte in sostanze nutritive."),
        .pokemonScale = 432,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LEAVANNY] =
    {
        ...
        .weight = 205,
        .description = COMPOUND_STRING(
            "Quando incontra un giovane Pokémon\n"
            "gli fa un vestito di foglie che cuce con\n"
            "il filo appiccicoso prodotto dalla bocca."),
        .pokemonScale = 282,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_VENIPEDE] =
    {
        ...
        .weight = 53,
        .description = COMPOUND_STRING(
            "Sonda l'ambiente circostante con\n"
            "le antenne del capo e della coda.\n"
            "Ha un carattere estremamente collerico."),
        .pokemonScale = 491,
        .pokemonOffset = 16,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_WHIRLIPEDE] =
    {
        ...
        .weight = 585,
        .description = COMPOUND_STRING(
            "È protetto da un guscio\n"
            "resistente. Si scaglia contro il\n"
            "nemico rotolando come uno pneumatico."),
        .pokemonScale = 282,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SCOLIPEDE] =
    {
        ...
        .weight = 2005,
        .description = COMPOUND_STRING(
            "Trafigge la preda con gli aculei del\n"
            "collo e dopo averla immobilizzata\n"
            "la finisce con le sue tossine."),
        .pokemonScale = 257,
        .pokemonOffset = 2,
        .trainerScale = 423,
        .trainerOffset = 8,
...
#define COTTONEE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_GRASS)
    ...
    [SPECIES_COTTONEE] =
    {
        ...
        .weight = 6,
        .description = COMPOUND_STRING(
            "Se viene attaccato crea una\n"
            "nuvola di cotone per confondere il\n"
            "nemico, poi ne approfitta per fuggire."),
        .pokemonScale = 530,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_WHIMSICOTT] =
    {
        ...
        .weight = 66,
        .description = COMPOUND_STRING(
            "Appare con un vortice d'aria, facendo\n"
            "piccoli dispetti come spostare i mobili\n"
            "nelle case o lasciare cotone ovunque."),
        .pokemonScale = 365,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PETILIL] =
    {
        ...
        .weight = 66,
        .description = COMPOUND_STRING(
            "Le foglie che ha sul capo sono\n"
            "molto amare ma, se masticate, hanno\n"
            "l'effetto di rinvigorire il corpo stanco."),
        .pokemonScale = 432,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LILLIGANT] =
    {
        ...
        .weight = 163,
        .description = COMPOUND_STRING(
            "I fiori che ha sulla testa spandono un\n"
            "profumo rilassante, ma necessitano di\n"
            "continue attenzioni per non appassire."),
        .pokemonScale = 320,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BASCULIN_RED_STRIPED] =
    {
        ...
        .weight = 180,
        .description = COMPOUND_STRING(
            "I Basculin con la linea rossa\n"
            "e quelli con la linea blu\n"
            "sono molto violenti e litigano spesso."),
        .pokemonScale = 316,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_SANDILE] =
    {
        ...
        .weight = 152,
        .description = COMPOUND_STRING(
            "Si nasconde sotto la sabbia e si sposta\n"
            "cacciando fuori gli occhi e il naso.\n"
            "Una membrana nera gli protegge gli occhi."),
        .pokemonScale = 365,
        .pokemonOffset = 14,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_KROKOROK] =
    {
        ...
        .weight = 334,
        .description = COMPOUND_STRING(
            "Forma gruppi di pochi esemplari. La\n"
            "pellicola che ricopre i suoi occhi\n"
            "lo protegge dalle tempeste di sabbia."),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_KROOKODILE] =
    {
        ...
        .weight = 963,
        .description = COMPOUND_STRING(
            "È un Pokémon molto feroce.\n"
            "Attacca tutto ciò che gli\n"
            "si para davanti, prendendolo a morsi."),
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
        .trainerOffset = 0,
    ...
    [SPECIES_DARUMAKA] =
    {
        ...
        .weight = 375,
        .description = COMPOUND_STRING(
            "Poiché i suoi escrementi sono molto\n"
            "caldi, nell'antichità gli uomini solevano\n"
            "conservarli in buste per riscaldarsi."),
        .pokemonScale = 422,
        .pokemonOffset = 14,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DARMANITAN_STANDARD] =
    {
        ...
        .weight = 929,
        .description = COMPOUND_STRING(
            "Se resta ferito durante una battaglia\n"
            "violenta, diventa duro come la\n"
            "pietra e medita per purificare la mente."),
        .pokemonScale = 272,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MARACTUS] =
    {
        ...
        .weight = 280,
        .description = COMPOUND_STRING(
            "Con danze e suoni a ritmo vivace scaccia\n"
            "i suoi predatori, i Pokémon uccello,\n"
            "che divorano i semi dei suoi fiori."),
        .pokemonScale = 305,
        .pokemonOffset = 6,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_DWEBBLE] =
    {
        ...
        .weight = 145,
        .description = COMPOUND_STRING(
            "Scava un buco in una pietra adatta per\n"
            "farne la sua dimora. Se si rompe, non\n"
            "si dà pace finché non ne trova un'altra."),
        .pokemonScale = 530,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CRUSTLE] =
    {
        ...
        .weight = 2000,
        .description = COMPOUND_STRING(
            "Ha una tale forza nelle gambe, che\n"
            "può spostarsi per giorni in zone aride\n"
            "con una pesante roccia sulle spalle."),
        .pokemonScale = 265,
        .pokemonOffset = 2,
        .trainerScale = 262,
        .trainerOffset = 0,
    ...
    [SPECIES_SCRAGGY] =
    {
        ...
        .weight = 118,
        .description = COMPOUND_STRING(
            "Assumono la posizione difensiva tirando\n"
            "su fino al collo la pelle, che è elastica\n"
    ...
    [SPECIES_SCRAFTY] =
    {
        ...
        .weight = 300,
        .description = COMPOUND_STRING(
            "Quando tira calci, si protegge\n"
            "dai danni con la pelle della muta.\n"
            "Più grande è la cresta e più arie si dà."),
        .pokemonScale = 320,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SIGILYPH] =
    {
        ...
        .weight = 140,
        .description = COMPOUND_STRING(
            "Era lo spirito custode di un'antica\n"
            "città. Attaccava con poteri psichici i\n"
            "nemici che invadevano il suo territorio."),
        .pokemonScale = 265,
        .pokemonOffset = 2,
        .trainerScale = 262,
        .trainerOffset = 0,
    ...
    [SPECIES_YAMASK] =
    {
        ...
        .weight = 15,
        .description = COMPOUND_STRING(
            "Erano un tempo spettri che riposavano\n"
            "in antiche tombe. Conservano\n"
            "la memoria della loro vita mortale."),
        .pokemonScale = 432,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_COFAGRIGUS] =
    {
        ...
        .weight = 765,
        .description = COMPOUND_STRING(
            "Si dice che inghiottisca le prede che gli\n"
            "si avvicinano e le trasformi in mummie.\n"
    ...
    [SPECIES_RUNERIGUS] =
    {
        ...
        .weight = 666,
        .description = COMPOUND_STRING(
            "Un antico disegno afflitto da\n"
            "una potente maledizione ha preso\n"
            "vita, imprigionando l'anima di Yamask."),
        .pokemonScale = 259,
        .pokemonOffset = 1,
        .trainerScale = 296,
        .trainerOffset = 1,
    ...
    [SPECIES_TIRTOUGA] =
    {
        ...
        .weight = 165,
        .description = COMPOUND_STRING(
            "Nuotava nei mari 100 milioni\n"
            "di anni fa. A volte sale\n"
    ...
    [SPECIES_CARRACOSTA] =
    {
        ...
        .weight = 810,
        .description = COMPOUND_STRING(
            "Vive nel mare e sulla terraferma. Ha\n"
            "una forza tale da sfondare con un\n"
            "solo colpo il fondo di una nave cisterna."),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ARCHEN] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "fossile. Si ritiene che sia\n"
            "l'antenato di tutti i Pokémon uccello."),
        .pokemonScale = 432,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ARCHEOPS] =
    {
        ...
        .weight = 320,
        .description = COMPOUND_STRING(
            "Spicca il volo prendendo la\n"
            "rincorsa da terra. Collabora\n"
    ...
    [SPECIES_TRUBBISH] =
    {
        ...
        .weight = 310,
        .description = COMPOUND_STRING(
            "È nato da un sacchetto della spazzatura\n"
            "che ha subito un cambiamento\n"
            "chimico a causa delle scorie industriali."),
        .pokemonScale = 422,
        .pokemonOffset = 14,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GARBODOR] =
    {
        ...
        .weight = 1073,
        .description = COMPOUND_STRING(
            "Serra l'avversario con l'arto sinistro\n"
            "e gli dà il colpo di grazia esalando\n"
            "dalla bocca un fetido gas velenoso."),
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 326,
        .trainerOffset = 4,
    ...
    [SPECIES_ZORUA] =
    {
        ...
        .weight = 125,
        .description = COMPOUND_STRING(
            "Inganna spesso il nemico\n"
            "assumendone la forma e lasciandolo\n"
    ...
    [SPECIES_ZOROARK] =
    {
        ...
        .weight = 811,
        .description = COMPOUND_STRING(
            "Ha la capacità di trarre in\n"
            "inganno una folla di persone.\n"
    ...
    [SPECIES_MINCCINO] =
    {
        ...
        .description = COMPOUND_STRING(
            "Si salutano\n"
            "pulendosi l'un l'altro con le loro code."),
        .pokemonScale = 491,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CINCCINO] =
    {
        ...
        .weight = 75,
        .description = COMPOUND_STRING(
            "La sua pelliccia bianca è\n"
            "morbidissima al tatto. Non accumula\n"
    ...
    [SPECIES_GOTHITA] =
    {
        ...
        .weight = 58,
        .description = COMPOUND_STRING(
            "Amplifica i poteri psichici con le\n"
            "antenne a forma di fiocchetti.\n"
    ...
    [SPECIES_GOTHORITA] =
    {
        ...
        .weight = 180,
        .description = COMPOUND_STRING(
            "Trae energia dalla luce delle stelle.\n"
            "Ne traccia la posizione facendo\n"
            "levitare le pietre con i poteri psichici."),
        .pokemonScale = 365,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GOTHITELLE] =
    {
        ...
        .weight = 440,
        .description = COMPOUND_STRING(
            "I suoi forti poteri psichici modificano\n"
            "lo spazio circostante rendendo visibili\n"
    ...
    [SPECIES_SOLOSIS] =
    {
        ...
        .weight = 10,
        .description = COMPOUND_STRING(
            "Il liquido speciale in cui è avvolto\n"
            "il suo corpo gli permette di\n"
    ...
    [SPECIES_DUOSION] =
    {
        ...
        .weight = 80,
        .description = COMPOUND_STRING(
            "Poiché ha due cervelli separati e\n"
            "indipendenti, può capitare che si\n"
            "comporti in modo del tutto incoerente."),
        .pokemonScale = 422,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_REUNICLUS] =
    {
        ...
        .weight = 201,
        .description = COMPOUND_STRING(
            "Le sue braccia, piene di un liquido che\n"
            "convoglia i suoi poteri psichici, sono\n"
            "anche in grado di frantumare le rocce."),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_DUCKLETT] =
    {
        ...
        .weight = 55,
        .description = COMPOUND_STRING(
            "Quando viene attaccato schizza acqua\n"
    ...
    [SPECIES_SWANNA] =
    {
        ...
        .weight = 242,
        .description = COMPOUND_STRING(
            "Non è solo elegante. Con il poderoso\n"
            "battito d'ali riesce a volare per\n"
            "migliaia di chilometri senza fermarsi."),
        .pokemonScale = 272,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_VANILLITE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Il suo fiato è a -50\n"
            "gradi. Fa nevicare tutto\n"
            "intorno, formando dei cristalli di neve."),
        .pokemonScale = 491,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_VANILLISH] =
    {
        ...
        .weight = 410,
        .description = COMPOUND_STRING(
            "Congela il corpo del nemico\n"
            "con granelli di ghiaccio che\n"
            "genera raffreddando l'aria circostante."),
        .pokemonScale = 320,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_VANILLUXE] =
    {
        ...
        .weight = 575,
        .description = COMPOUND_STRING(
            "Se le due teste si arrabbiano allo\n"
            "stesso tempo, scatena una bufera\n"
            "dalle corna, coprendo di neve i dintorni."),
        .pokemonScale = 272,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DEERLING_SPRING] =
    {
        ...
        .weight = 195,
        .description = COMPOUND_STRING(
            "Il suo corpo muta non solo a seconda\n"
            "della stagione ma in misura minore anche\n"
            "al cambiare di temperatura e umidità."),
        .pokemonScale = 422,
        .pokemonOffset = 14,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SAWSBUCK_SPRING] =
    {
        ...
        .weight = 925,
        .description = COMPOUND_STRING(
            "Cambia dimora a seconda delle stagioni.\n"
            "Gli uomini si accorgono del cambio\n"
            "di stagione osservando le sue corna."),
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 326,
        .trainerOffset = 4,
    ...
    [SPECIES_EMOLGA] =
    {
        ...
        .weight = 50,
        .description = COMPOUND_STRING(
            "Vive nelle foreste sulle cime degli\n"
            "alberi. Plana usando una membrana simile\n"
            "a un mantello, elettrificata all'interno."),
        .pokemonScale = 491,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_KARRABLAST] =
    {
        ...
        .weight = 59,
        .description = COMPOUND_STRING(
            "Pokémon misterioso che si evolve\n"
            "ricevendo uno stimolo elettrico\n"
            "se si trova in presenza di Shelmet."),
        .pokemonScale = 432,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ESCAVALIER] =
    {
        ...
        .weight = 330,
        .description = COMPOUND_STRING(
            "Protegge il corpo con la conchiglia\n"
            "che ha rubato a Shelmet mentre\n"
            "spunzona il nemico con due lance."),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_FOONGUS] =
    {
        ...
        .weight = 10,
        .description = COMPOUND_STRING(
            "Simile a una Poké Ball, adesca i nemici\n"
            "e sparge spore velenose. Da dove venga\n"
            "questa somiglianza è un vero mistero."),
        .pokemonScale = 682,
        .pokemonOffset = 24,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_AMOONGUSS] =
    {
        ...
        .weight = 105,
        .description = COMPOUND_STRING(
            "Cerca di attirare le prede esibendo un\n"
            "cappello a forma di Poké Ball, ma sono\n"
            "pochi i Pokémon che si fanno ingannare."),
        .pokemonScale = 422,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_FRILLISH] =
    {
        ...
        .weight = 330,
        .description = COMPOUND_STRING(
            "Paralizza la preda con il\n"
            "veleno e la porta nella\n"
            "sua dimora a 8000 m in fondo al mare."),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_JELLICENT] =
    {
        ...
        .weight = 1350,
        .description = COMPOUND_STRING(
            "È composto per lo più d'acqua marina.\n"
            "Dicono che si sia costruito un castello\n"
            "con i relitti delle navi che ha affondato."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 348,
        .trainerOffset = 6,
    ...
    [SPECIES_ALOMOMOLA] =
    {
        ...
        .weight = 316,
        .description = COMPOUND_STRING(
            "Vive in mare aperto trasportato\n"
            "dalle onde. Se si imbatte in un\n"
            "Pokémon ferito, lo riaccompagna a riva."),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_JOLTIK] =
    {
        ...
        .weight = 6,
        .description = COMPOUND_STRING(
            "Non può produrre elettricità da sé, per\n"
            "cui si attacca a Pokémon più grandi\n"
            "per succhiarne l'energia elettrostatica."),
        .pokemonScale = 682,
        .pokemonOffset = 24,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GALVANTULA] =
    {
        ...
        .weight = 143,
        .description = COMPOUND_STRING(
            "Tende trappole con fili elettrificati.\n"
            "Consuma poi con comodo le prede\n"
    ...
    [SPECIES_FERROSEED] =
    {
        ...
        .weight = 188,
        .description = COMPOUND_STRING(
            "Quando avverte un pericolo, reagisce\n"
            "sparando simultaneamente tutti i suoi\n"
            "aculei, per poi fuggire via rotolando."),
        .pokemonScale = 422,
        .pokemonOffset = 14,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_FERROTHORN] =
    {
        ...
        .weight = 1100,
        .description = COMPOUND_STRING(
            "Fa a pezzi il nemico colpendolo\n"
            "prima con le sue tre antenne e\n"
            "poi sparandogli addosso i suoi aculei."),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_KLINK] =
    {
        ...
        .weight = 210,
        .description = COMPOUND_STRING(
            "Produce l'energia che gli serve\n"
            "per vivere incastrando e facendo\n"
            "ruotare le due parti che lo compongono."),
        .pokemonScale = 530,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_KLANG] =
    {
        ...
        .weight = 510,
        .description = COMPOUND_STRING(
            "Comunicano il loro stato d'animo\n"
            "cambiando senso di rotazione. Più\n"
            "si arrabbiano, più girano velocemente."),
        .pokemonScale = 422,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_KLINKLANG] =
    {
        ...
        .weight = 810,
        .description = COMPOUND_STRING(
            "Facendo girare velocemente\n"
            "l'ingranaggio dotato del nucleo rosso,\n"
            "accumula una grande quantità di energia."),
        .pokemonScale = 422,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TYNAMO] =
    {
        ...
        .weight = 3,
        .description = COMPOUND_STRING(
            "La carica elettrica di un Tynamo è\n"
    ...
    [SPECIES_EELEKTRIK] =
    {
        ...
        .weight = 220,
        .description = COMPOUND_STRING(
            "Si avvinghia alla preda e la\n"
            "paralizza rilasciando elettricità\n"
    ...
    [SPECIES_EELEKTROSS] =
    {
        ...
        .weight = 805,
        .description = COMPOUND_STRING(
            "Si attacca alla preda con\n"
            "la bocca a ventosa e la\n"
    ...
    [SPECIES_ELGYEM] =
    {
        ...
        .weight = 90,
        .description = COMPOUND_STRING(
            "Con i suoi incredibili poteri psichici\n"
            "comprime il cervello dei suoi nemici\n"
    ...
    [SPECIES_BEHEEYEM] =
    {
        ...
        .weight = 345,
        .description = COMPOUND_STRING(
            "Dialoga con i suoi simili\n"
            "tramite le luci sui suoi arti, ma\n"
            "il suo linguaggio è ancora un mistero."),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_LITWICK] =
    {
        ...
        .weight = 31,
        .description = COMPOUND_STRING(
            "Mentre fa luce col pretesto\n"
            "di fare loro da guida,\n"
    ...
    [SPECIES_LAMPENT] =
    {
        ...
        .weight = 130,
        .description = COMPOUND_STRING(
            "La sua fiamma si accende\n"
            "quando risucchia gli spettri.\n"
            "Si trova spesso nei pressi\n"
            "dei cimiteri, dove questi abbondano."),
        .pokemonScale = 422,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CHANDELURE] =
    {
        ...
        .weight = 343,
        .description = COMPOUND_STRING(
            "Le fiamme di Chandelure\n"
            "risucchiano lo spirito e\n"
    ...
    [SPECIES_AXEW] =
    {
        ...
        .weight = 180,
        .description = COMPOUND_STRING(
            "Mangia le bacche sminuzzandole con i\n"
            "denti, che ricrescono costantemente,\n"
            "diventando sempre più forti e affilati."),
        .pokemonScale = 422,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_FRAXURE] =
    {
        ...
        .weight = 360,
        .description = COMPOUND_STRING(
            "Ha zanne in grado di frantumare\n"
            "rocce. Le lotte per il\n"
            "territorio tra i Fraxure sono furibonde."),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_HAXORUS] =
    {
        ...
        .weight = 1055,
        .description = COMPOUND_STRING(
            "Ha un carattere gentile, ma non\n"
            "perdona chi devasta il suo territorio.\n"
            "Le sue zanne possono tagliare l'acciaio."),
        .pokemonScale = 267,
        .pokemonOffset = 2,
        .trainerScale = 286,
        .trainerOffset = 1,
    ...
    [SPECIES_CUBCHOO] =
    {
        ...
        .weight = 85,
        .description = COMPOUND_STRING(
            "Ha sempre il naso gocciolante e\n"
            "se ne serve per lanciare le sue\n"
            "mosse. Il muco è l'origine della sua forza."),
        .pokemonScale = 432,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BEARTIC] =
    {
        ...
        .weight = 2600,
        .description = COMPOUND_STRING(
            "Predilige i freddi mari del nord. Crea\n"
            "strade di ghiaccio soffiando con il suo\n"
            "alito gelido sulla superficie del mare."),
        .pokemonScale = 266,
        .pokemonOffset = 3,
        .trainerScale = 399,
        .trainerOffset = 4,
    ...
    [SPECIES_CRYOGONAL] =
    {
        ...
        .weight = 1480,
        .description = COMPOUND_STRING(
            "È nato nelle nuvole cariche di\n"
            "neve. Cattura le prede con una\n"
            "catena fatta di cristalli di ghiaccio."),
        .pokemonScale = 320,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SHELMET] =
    {
        ...
        .weight = 77,
        .description = COMPOUND_STRING(
            "Quando incontra Karrablast si crea della\n"
            "corrente elettrica che stimola entrambi\n"
            "i Pokémon causandone l'evoluzione."),
        .pokemonScale = 491,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ACCELGOR] =
    {
        ...
        .weight = 253,
        .description = COMPOUND_STRING(
            "Liberatosi della pesante\n"
            "conchiglia, è diventato leggero.\n"
    ...
    [SPECIES_STUNFISK] =
    {
        ...
        .weight = 110,
        .description = COMPOUND_STRING(
            "Ha la pelle così dura che un lottatore di\n"
            "sumo potrebbe calpestarlo senza fargli\n"
            "male. L'elettricità gli fa il solletico."),
        .pokemonScale = 365,
        .pokemonOffset = 14,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MIENFOO] =
    {
        ...
        .weight = 200,
        .description = COMPOUND_STRING(
            "Va fiero della rapidità delle sue mosse.\n"
            "Sopperisce a un'eventuale mancanza\n"
            "di potenza con il numero dei colpi."),
        .pokemonScale = 338,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MIENSHAO] =
    {
        ...
        .weight = 355,
        .description = COMPOUND_STRING(
            "Usa i peli degli arti come fruste.\n"
            "I suoi attacchi sono talmente\n"
            "rapidi da essere invisibili a occhio nudo."),
        .pokemonScale = 265,
        .pokemonOffset = 2,
        .trainerScale = 262,
        .trainerOffset = 0,
    ...
    [SPECIES_DRUDDIGON] =
    {
        ...
        .weight = 1390,
        .description = COMPOUND_STRING(
            "Percorre le grotte anguste catturando\n"
            "le prede con gli artigli affilati. La\n"
            "pelle del muso è più dura della roccia."),
        .pokemonScale = 259,
        .pokemonOffset = 1,
        .trainerScale = 296,
        .trainerOffset = 1,
    ...
    [SPECIES_GOLETT] =
    {
        ...
        .weight = 920,
        .description = COMPOUND_STRING(
            "Si muove grazie all'energia che\n"
            "gli brucia dentro, ma nessuno\n"
    ...
    [SPECIES_GOLURK] =
    {
        ...
        .weight = 3300,
        .description = COMPOUND_STRING(
            "Si narra che gli antichi costruttori\n"
            "dei Golurk avessero ordinato loro\n"
            "di proteggere gli uomini e i Pokémon."),
        .pokemonScale = 275,
        .pokemonOffset = 3,
        .trainerScale = 300,
        .trainerOffset = 0,
    ...
    [SPECIES_PAWNIARD] =
    {
        ...
        .weight = 102,
        .description = COMPOUND_STRING(
            "Il suo intero corpo è un'arma da\n"
            "taglio. Se le lame si smussano\n"
            "lottando, le affila con pietre di fiume."),
        .pokemonScale = 432,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BISHARP] =
    {
        ...
        .weight = 700,
        .description = COMPOUND_STRING(
            "È molto crudele. Lascia che un gruppo di\n"
            "Pawniard attacchi la preda e, quando è\n"
            "ferita e non può più muoversi, la finisce."),
        .pokemonScale = 259,
        .pokemonOffset = 1,
        .trainerScale = 296,
        .trainerOffset = 1,
    ...
    [SPECIES_BOUFFALANT] =
    {
        ...
        .weight = 946,
        .description = COMPOUND_STRING(
            "Sferra testate contro tutto e\n"
            "tutti. Ha una forza distruttiva\n"
            "tale da far deragliare un treno in corsa."),
        .pokemonScale = 259,
        .pokemonOffset = 1,
        .trainerScale = 296,
        .trainerOffset = 1,
    ...
    [SPECIES_RUFFLET] =
    {
        ...
        .weight = 105,
        .description = COMPOUND_STRING(
            "Si serve degli arti come schiaccianoci\n"
            "per rompere le bacche. Affronta\n"
            "con valore anche i nemici più forti."),
        .pokemonScale = 432,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BRAVIARY] =
    {
        ...
        .weight = 410,
        .description = COMPOUND_STRING(
            "È l'intrepido guerriero del cielo.\n"
            "Per difendere i suoi simili, lotta\n"
            "fino all'ultimo senza badare alle ferite."),
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
        .trainerOffset = 0,
    ...
    [SPECIES_VULLABY] =
    {
        ...
        .weight = 90,
        .description = COMPOUND_STRING(
            "Le piccole ali non gli consentono di\n"
            "volare. Quando si avvicina il momento\n"
            "di evolversi, si libera del teschio."),
        .pokemonScale = 432,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MANDIBUZZ] =
    {
        ...
        .weight = 395,
        .description = COMPOUND_STRING(
            "Vola in cerchio nel cielo e quando\n"
            "scorge una preda le si lancia contro in\n"
            "picchiata per trasportarla al suo nido."),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_HEATMOR] =
    {
        ...
        .weight = 580,
        .description = COMPOUND_STRING(
            "Con la sua lingua infuocata\n"
            "scioglie la corazza d'acciaio\n"
            "di Durant e ne consuma l'interno."),
        .pokemonScale = 265,
        .pokemonOffset = 2,
        .trainerScale = 262,
        .trainerOffset = 0,
    ...
    [SPECIES_DURANT] =
    {
        ...
        .weight = 330,
        .description = COMPOUND_STRING(
            "Heatmor è il loro acerrimo nemico, e\n"
            "quando vogliono cacciarlo dalla tana si\n"
            "dividono i compiti e partono all'attacco!"),
        .pokemonScale = 530,
        .pokemonOffset = 19,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DEINO] =
    {
        ...
        .weight = 173,
        .description = COMPOUND_STRING(
            "Dal momento che non ci vede, esamina ciò\n"
            "che lo circonda mordendo o lanciandosi di\n"
            "peso. Ha ammaccature su tutto il corpo."),
        .pokemonScale = 366,
        .pokemonOffset = 12,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_ZWEILOUS] =
    {
        ...
        .weight = 500,
        .description = COMPOUND_STRING(
            "Le due teste non vanno d'accordo\n"
            "e si contendono la posizione di\n"
            "comando in base a quale mangia di più."),
        .pokemonScale = 265,
        .pokemonOffset = 3,
        .trainerScale = 262,
        .trainerOffset = 0,
    ...
    [SPECIES_HYDREIGON] =
    {
        ...
        .weight = 1600,
        .description = COMPOUND_STRING(
            "Le teste che ha sugli arti non hanno\n"
            "cervello. Distrugge e divora qualsiasi\n"
            "cosa usando tutte e tre le teste."),
        .pokemonScale = 267,
        .pokemonOffset = 2,
        .trainerScale = 286,
        .trainerOffset = 1,
    ...
    [SPECIES_LARVESTA] =
    {
        ...
        .weight = 288,
        .description = COMPOUND_STRING(
            "Si dice che sia nato dal sole. Prima\n"
            "di evolversi, avvolge tutto il\n"
            "suo corpo nelle fiamme emesse dai corni."),
        .pokemonScale = 320,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_VOLCARONA] =
    {
        ...
        .weight = 460,
        .description = COMPOUND_STRING(
            "Quando lotta, sparge scaglie\n"
            "infuocate dalle sue sei ali,\n"
    ...
    [SPECIES_COBALION] =
    {
        ...
        .weight = 2500,
        .description = COMPOUND_STRING(
            "Ha un corpo e uno spirito d'acciaio.\n"
            "Gli basta lo sguardo per farsi\n"
            "ubbidire anche dai Pokémon più feroci."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 365,
        .trainerOffset = 7,
    ...
    [SPECIES_TERRAKION] =
    {
        ...
        .weight = 2600,
        .description = COMPOUND_STRING(
            "Quando carica, ha una forza tale\n"
            "da sfondare un'enorme muraglia.\n"
            "Si racconta di lui nelle leggende."),
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 336,
        .trainerOffset = 4,
    ...
    [SPECIES_VIRIZION] =
    {
        ...
        .weight = 2000,
        .description = COMPOUND_STRING(
            "Le corna della testa sono lame\n"
            "affilate. Muovendosi come un turbine,\n"
            "scuote e falcia fulmineo i nemici."),
        .pokemonScale = 261,
        .pokemonOffset = 1,
        .trainerScale = 344,
        .trainerOffset = 4,
    ...
    [SPECIES_TORNADUS_INCARNATE] =
    {
        ...
        .weight = 630,
        .description = COMPOUND_STRING(
            "Ha la parte inferiore del\n"
            "corpo avvolta in una nuvola di\n"
            "energia. Sfreccia nei cieli a 300 km/h."),
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
        .trainerOffset = 0,
    ...
    [SPECIES_THUNDURUS_INCARNATE] =
    {
        ...
        .weight = 610,
        .description = COMPOUND_STRING(
            "Lancia scariche elettriche\n"
            "dagli aculei della coda. Vola\n"
            "per i cieli di Unima scagliando fulmini."),
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
        .trainerOffset = 0,
    ...
    [SPECIES_RESHIRAM] =
    {
        ...
        .weight = 3300,
        .description = COMPOUND_STRING(
            "Questo Pokémon leggendario può rendere\n"
            "il mondo un inferno di fiamme. Aiuta\n"
            "chi vuole costruire un mondo di verità."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 445,
        .trainerOffset = 8,
    ...
    [SPECIES_ZEKROM] =
    {
        ...
        .weight = 3450,
        .description = COMPOUND_STRING(
            "Questo Pokémon leggendario può riempire\n"
            "il mondo di fulmini e saette. Aiuta\n"
            "chi vuole costruire un mondo ideale."),
        .pokemonScale = 275,
        .pokemonOffset = 2,
        .trainerScale = 412,
        .trainerOffset = 10,
    ...
    [SPECIES_LANDORUS_INCARNATE] =
    {
        ...
        .weight = 680,
        .description = COMPOUND_STRING(
            "Poiché le terre che visita\n"
            "producono abbondanti raccolti, è\n"
            "considerato una benedizione per i campi."),
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
        .trainerOffset = 0,
    ...
    [SPECIES_KYUREM] =
    {
        ...
        .weight = 3250,
        .description = COMPOUND_STRING(
            "Questo leggendario Pokémon dei ghiacci\n"
            "attende l'eroe che gli restituirà le sue\n"
            "vere sembianze con gli ideali o la verità."),
        .pokemonScale = 275,
        .pokemonOffset = 7,
        .trainerScale = 356,
        .trainerOffset = 0,
    ...
    [SPECIES_KELDEO_ORDINARY] =
    {
        ...
        .weight = 485,
        .description = COMPOUND_STRING(
            "Scorrazza per il mondo muovendosi\n"
    ...
    [SPECIES_MELOETTA_ARIA] =
    {
        ...
        .weight = 65,
        .description = COMPOUND_STRING(
            "Canta una melodia che ha il potere\n"
            "di portare la gioia o la tristezza\n"
            "nel cuore dei Pokémon che l'ascoltano."),
        .pokemonScale = 422,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
