...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_TURTWIG] =
    {
        ...
        .categoryName = _("Fogliolina"),
        .height = 4,
        .weight = 102,
        .description = COMPOUND_STRING(
            "Fa la fotosintesi su tutto il corpo\n"
            "esponendosi ai raggi solari. La\n"
            "sua corazza è fatta di terra compatta."),
        .pokemonScale = 491,
        .pokemonOffset = 20,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GROTLE] =
    {
        ...
        .categoryName = _("Boschetto"),
        .height = 11,
        .weight = 970,
        .description = COMPOUND_STRING(
            "Vive nelle foreste vicino\n"
            "all'acqua, ma esce di giorno per far\n"
    ...
    [SPECIES_TORTERRA] =
    {
        ...
        .weight = 3100,
        .description = COMPOUND_STRING(
            "In tempi antichissimi la gente\n"
            "pensava che sottoterra\n"
    ...
    [SPECIES_CHIMCHAR] =
    {
        ...
        .categoryName = _("Scimpanzé"),
        .height = 5,
        .weight = 62,
        .description = COMPOUND_STRING(
            "Le fiamme sulla coda, alimentate\n"
            "dai gas della pancia, non\n"
            "si spengono neppure quando piove."),
        .pokemonScale = 432,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MONFERNO] =
    {
        ...
        .weight = 220,
        .description = COMPOUND_STRING(
            "Controlla abilmente l'intensità\n"
    ...
    [SPECIES_INFERNAPE] =
    {
        ...
        .weight = 550,
        .description = COMPOUND_STRING(
            "La sua criniera di fuoco è indice\n"
            "della sua natura violenta.\n"
    ...
    [SPECIES_PIPLUP] =
    {
        ...
        .weight = 52,
        .description = COMPOUND_STRING(
            "Molto orgoglioso. Difficile\n"
            "farci amicizia perché non\n"
            "ascolta mai i consigli dell'Allenatore."),
        .pokemonScale = 491,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_EMPOLEON] =
    {
        ...
        .categoryName = _("Imperatore"),
        .height = 17,
        .weight = 845,
        .description = COMPOUND_STRING(
            "Nuota veloce come una moto\n"
            "d'acqua. Le estremità delle ali sono\n"
            "aguzze e spaccano anche il ghiaccio."),
        .pokemonScale = 259,
        .pokemonOffset = 0,
        .trainerScale = 290,
        .trainerOffset = 1,
    ...
    [SPECIES_STARLY] =
    {
        ...
        .categoryName = _("Storno"),
        .height = 3,
        .weight = 20,
        .description = COMPOUND_STRING(
            "Si muove in grandi gruppi.\n"
            "Anche se piccolo, batte\n"
    ...
    [SPECIES_STARAVIA] =
    {
        ...
        .weight = 155,
        .description = COMPOUND_STRING(
            "Ha l'abitudine di riunirsi in\n"
            "grandi gruppi. Le zuffe tra\n"
            "gruppi sono particolarmente vivaci."),
        .pokemonScale = 422,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_STARAPTOR] =
    {
        ...
        .weight = 249,
        .description = COMPOUND_STRING(
            "I muscoli di ali e zampe sono molto\n"
            "sviluppati. Vola senza fatica\n"
            "anche portando un piccolo Pokémon."),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BIDOOF] =
    {
        ...
        .categoryName = _("Topaffuto"),
        .height = 5,
        .weight = 200,
        .description = COMPOUND_STRING(
            "Ha i nervi d'acciaio e\n"
            "niente può turbarlo. È\n"
    ...
    [SPECIES_BIBAREL] =
    {
        ...
        .categoryName = _("Castoro"),
        .height = 10,
        .weight = 315,
        .description = COMPOUND_STRING(
            "Costruisce con zelo la tana in\n"
            "riva ai corsi d'acqua, levigando\n"
    ...
    [SPECIES_KRICKETOT] =
    {
        ...
        .weight = 22,
        .description = COMPOUND_STRING(
            "Comunica con il suono prodotto\n"
            "dallo scontro delle sue antenne.\n"
            "Esso indica l'arrivo dell'autunno."),
        .pokemonScale = 530,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_KRICKETUNE] =
    {
        ...
        .weight = 255,
        .description = COMPOUND_STRING(
            "Quando canta tiene le zampe incrociate\n"
            "al petto. Sa improvvisare melodie."),
        .pokemonScale = 305,
        .pokemonOffset = 8,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_SHINX] =
    {
        ...
        .categoryName = _("Baleno"),
        .height = 5,
        .weight = 95,
        .description = COMPOUND_STRING(
            "Produce elettricità contraendo\n"
    ...
    [SPECIES_LUXIO] =
    {
        ...
        .categoryName = _("Favilla"),
        .height = 9,
        .weight = 305,
        .description = COMPOUND_STRING(
            "Dagli artigli rilascia un'elettricità\n"
            "talmente intensa da mandare\n"
    ...
    [SPECIES_LUXRAY] =
    {
        ...
        .categoryName = _("Occhiluce"),
        .height = 14,
        .weight = 420,
        .description = COMPOUND_STRING(
            "Se i suoi occhi sono dorati,\n"
            "può individuare le prede, anche\n"
            "quelle che si nascondono dietro i muri."),
        .pokemonScale = 265,
        .pokemonOffset = 2,
        .trainerScale = 262,
        .trainerOffset = 0,
    ...
    [SPECIES_CRANIDOS] =
    {
        ...
        .categoryName = _("Cranioso"),
        .height = 9,
        .weight = 315,
        .description = COMPOUND_STRING(
            "È stato fatto rivivere da un fossile\n"
            "di ferro simile a una palla. Abbatte\n"
            "le prede con le punte sulla testa."),
        .pokemonScale = 338,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_RAMPARDOS] =
    {
        ...
        .weight = 1025,
        .description = COMPOUND_STRING(
            "Il suo spesso cranio, che\n"
            "sopporta qualunque impatto, è\n"
            "ridotto, e il cervello non si è sviluppato."),
        .pokemonScale = 259,
        .pokemonOffset = 1,
        .trainerScale = 296,
        .trainerOffset = 1,
    ...
    [SPECIES_SHIELDON] =
    {
        ...
        .categoryName = _("Schermo"),
        .height = 5,
        .weight = 570,
        .description = COMPOUND_STRING(
            "Si pulisce il muso strofinandolo\n"
            "contro i tronchi degli alberi. È\n"
            "vulnerabile agli attacchi alle spalle."),
        .pokemonScale = 432,
        .pokemonOffset = 16,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BASTIODON] =
    {
        ...
        .weight = 1495,
        .description = COMPOUND_STRING(
            "Se si mettono uno di fianco\n"
            "all'altro nessun nemico riesce a\n"
            "passare. Proteggono così i loro cuccioli."),
        .pokemonScale = 272,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BURMY_PLANT] =
    {
        ...
        .weight = 34,
        .description = COMPOUND_STRING(
            "Per ripararsi dal freddo e\n"
            "dai venti invernali si copre\n"
    ...
    [SPECIES_WORMADAM_PLANT] =
    {
        ...
        .weight = 65,
        .description = COMPOUND_STRING(
            "Il suo aspetto dipende dal luogo\n"
            "in cui si evolve. Tutto ciò che\n"
            "ha intorno va a costituire il suo corpo."),
        .pokemonScale = 432,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define MOTHIM_SPECIES_INFO(rzMode)                                         \
    ...
    [SPECIES_COMBEE] =
    {
        ...
        .categoryName = _("Apetta"),
        .height = 3,
        .weight = 55,
        .description = COMPOUND_STRING(
            "Il trio è insieme dalla\n"
            "nascita. È sempre impegnato a\n"
            "portare il nettare dei fiori a Vespiquen."),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_VESPIQUEN] =
    {
        ...
        .categoryName = _("Alveare"),
        .height = 12,
        .weight = 385,
        .description = COMPOUND_STRING(
            "Nell'addome ospita la sua progenie,\n"
            "sulla quale esercita un controllo\n"
            "assoluto tramite i feromoni che rilascia."),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BUIZEL] =
    {
        ...
        .categoryName = _("Maridonnola"),
        .height = 7,
        .weight = 295,
        .description = COMPOUND_STRING(
            "Nuota roteando le due code\n"
            "come fossero viti. Quando si\n"
    ...
    [SPECIES_FLOATZEL] =
    {
        ...
        .weight = 335,
        .description = COMPOUND_STRING(
            "Nuota con il suo grosso galleggiante e\n"
            "aiuta a soccorrere chi sta per annegare."),
        .pokemonScale = 320,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CHERUBI] =
    {
        ...
        .categoryName = _("Ciliegia"),
        .height = 4,
        .weight = 33,
        .description = COMPOUND_STRING(
            "La luce solare lo tinge di rosso. Se\n"
            "la pallina esaurisce i nutrimenti,\n"
            "si avvizzisce indicando l'evoluzione."),
        .pokemonScale = 491,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CHERRIM_OVERCAST] =
    {
        ...
        .categoryName = _("Bocciolo"),
        .height = 5,
        .weight = 93,
        .description = COMPOUND_STRING(
            "Sboccia quando si espone\n"
            "ai raggi solari, espandendo\n"
            "la corolla e diventando molto attivo."),
        .pokemonScale = 432,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SHELLOS_WEST] =
    {
        ...
        .categoryName = _("Lumacomare"),
        .height = 3,
        .weight = 63,
        .description = COMPOUND_STRING(
            "Se si esercita una forte\n"
            "pressione sul suo corpo, ne\n"
            "fuoriesce un misterioso liquido viola."),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GASTRODON_WEST] =
    {
        ...
        .weight = 299,
        .description = COMPOUND_STRING(
            "Se minacciato da un nemico\n"
            "naturale rilascia un liquido\n"
            "viola e se la dà a gambe, per così dire..."),
        .pokemonScale = 338,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DRIFLOON] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "persone e Pokémon. Ama le stagioni umide."),
        .pokemonScale = 491,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DRIFBLIM] =
    {
        ...
        .categoryName = _("Dirigibile"),
        .height = 12,
        .weight = 150,
        .description = COMPOUND_STRING(
            "Vola trascinando persone e\n"
            "Pokémon. Poiché si fa portare\n"
    ...
    [SPECIES_BUNEARY] =
    {
        ...
        .categoryName = _("Coniglio"),
        .height = 4,
        .weight = 55,
        .description = COMPOUND_STRING(
            "Le sue orecchie sono sempre\n"
            "arrotolate. Può estenderle con\n"
            "forza per distruggere qualsiasi cosa."),
        .pokemonScale = 491,
        .pokemonOffset = 16,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LOPUNNY] =
    {
        ...
        .weight = 333,
        .description = COMPOUND_STRING(
            "È un Pokémon estremamente\n"
            "cauto. Se avverte un pericolo,\n"
    ...
    [SPECIES_GLAMEOW] =
    {
        ...
        .categoryName = _("Felide"),
        .height = 5,
        .weight = 39,
        .description = COMPOUND_STRING(
            "Se disturbato, tira fuori gli\n"
            "artigli; se soddisfatto, fa le\n"
            "fusa. La sua incostanza piace a molti."),
        .pokemonScale = 432,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_STUNKY] =
    {
        ...
        .categoryName = _("Moffetta"),
        .height = 4,
        .weight = 192,
        .description = COMPOUND_STRING(
            "Emette un fluido puzzolente dal\n"
            "posteriore. Il tanfo si sparge\n"
    ...
    [SPECIES_SKUNTANK] =
    {
        ...
        .weight = 380,
        .description = COMPOUND_STRING(
            "Attacca spruzzando un\n"
            "fluido puzzolente dalla coda.\n"
            "Ha un raggio d'azione di oltre 50 m."),
        .pokemonScale = 305,
        .pokemonOffset = 9,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_BRONZOR] =
    {
        ...
        .categoryName = _("Bronzo"),
        .height = 5,
        .weight = 605,
        .description = COMPOUND_STRING(
            "Nell'antichità si credeva che\n"
            "una forza misteriosa dimorasse\n"
    ...
    [SPECIES_BRONZONG] =
    {
        ...
        .categoryName = _("Squibronzo"),
        .height = 13,
        .weight = 1870,
        .description = COMPOUND_STRING(
            "È stato venerato per secoli come\n"
            "Pokémon che porta la pioggia. A\n"
            "volte lo si trova sepolto nel terreno."),
        .pokemonScale = 272,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CHATOT] =
    {
        ...
        .categoryName = _("Musicale"),
        .height = 5,
        .weight = 19,
        .description = COMPOUND_STRING(
            "Imita la voce dei nemici per\n"
            "far credere che è dei loro,\n"
    ...
    [SPECIES_SPIRITOMB] =
    {
        ...
        .categoryName = _("Proibito"),
        .height = 10,
        .weight = 1080,
        .description = COMPOUND_STRING(
            "Pokémon formato da 108\n"
            "spiriti. È stato imprigionato\n"
    ...
    [SPECIES_GIBLE] =
    {
        ...
        .categoryName = _("Squaloterra"),
        .height = 7,
        .weight = 205,
        .description = COMPOUND_STRING(
            "Vive in gallerie scaldate dal\n"
            "calore geotermico. Se sente un\n"
    ...
    [SPECIES_GABITE] =
    {
        ...
        .categoryName = _("Grotta"),
        .height = 14,
        .weight = 560,
        .description = COMPOUND_STRING(
            "Adora gli oggetti luccicanti.\n"
            "Va a caccia di tesori nelle\n"
            "grotte e li trasporta nel suo nido."),
        .pokemonScale = 265,
        .pokemonOffset = 2,
        .trainerScale = 262,
        .trainerOffset = 0,
    ...
    [SPECIES_GARCHOMP] =
    {
        ...
        .weight = 950,
        .description = COMPOUND_STRING(
            "Quando si piega e distende le ali, sembra\n"
            "un jet. Vola a una velocità supersonica."),
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 326,
        .trainerOffset = 4,
    ...
    [SPECIES_RIOLU] =
    {
        ...
        .categoryName = _("Emanazione"),
        .height = 7,
        .weight = 202,
        .description = COMPOUND_STRING(
            "Comunica con i suoi simili tramite\n"
            "delle onde che cambiano forma\n"
            "a seconda del sentimento che prova."),
        .pokemonScale = 365,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LUCARIO] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "e i movimenti del nemico\n"
            "decifrando l'aura che questo emette."),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_HIPPOPOTAS] =
    {
        ...
        .weight = 495,
        .description = COMPOUND_STRING(
            "Vive in territori aridi.\n"
            "Invece del sudore,\n"
            "espelle dal corpo sabbia granulosa."),
        .pokemonScale = 366,
        .pokemonOffset = 11,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_HIPPOWDON] =
    {
        ...
        .categoryName = _("Grandepeso"),
        .height = 20,
        .weight = 3000,
        .description = COMPOUND_STRING(
            "Mostra la propria forza\n"
            "spalancando le fauci. Attacca\n"
            "sollevando immani quantità di sabbia."),
        .pokemonScale = 261,
        .pokemonOffset = 2,
        .trainerScale = 334,
        .trainerOffset = 4,
    ...
    [SPECIES_SKORUPI] =
    {
        ...
        .categoryName = _("Scorpione"),
        .height = 8,
        .weight = 120,
        .description = COMPOUND_STRING(
            "Afferra le prede con gli artigli\n"
            "della coda e non si allontana\n"
    ...
    [SPECIES_DRAPION] =
    {
        ...
        .weight = 615,
        .description = COMPOUND_STRING(
            "Va fiero della sua forza con cui può\n"
            "fare a pezzi il nemico, ma in genere\n"
            "preferisce finirlo usando le sue tossine."),
        .pokemonScale = 272,
        .pokemonOffset = 5,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CROAGUNK] =
    {
        ...
        .categoryName = _("Inveieleno"),
        .height = 7,
        .weight = 230,
        .description = COMPOUND_STRING(
            "Le sacche delle guance\n"
            "contengono veleno. Infilza i\n"
            "nemici con le sue unghie avvelenate."),
        .pokemonScale = 365,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TOXICROAK] =
    {
        ...
        .weight = 444,
        .description = COMPOUND_STRING(
            "Ha una sacca di veleno sulla\n"
            "gola. Quando gracida il veleno\n"
    ...
    [SPECIES_FINNEON] =
    {
        ...
        .categoryName = _("Pescealato"),
        .height = 4,
        .weight = 70,
        .description = COMPOUND_STRING(
            "La linea che contorna il suo corpo\n"
            "immagazzina la luce solare. Di\n"
            "notte si illumina di una luce splendente."),
        .pokemonScale = 491,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SNOVER] =
    {
        ...
        .categoryName = _("Albergelo"),
        .height = 10,
        .weight = 505,
        .description = COMPOUND_STRING(
            "In inverno scende a valle, ma\n"
            "in primavera se ne torna sulle\n"
            "cime montuose dove c'è ancora neve."),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_ABOMASNOW] =
    {
        ...
        .weight = 1355,
        .description = COMPOUND_STRING(
            "Crea bufere che ricoprono\n"
            "di neve ampissime aree. È\n"
            "noto anche come “Mostro dei ghiacci”."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 348,
        .trainerOffset = 6,
...
#define ROTOM_FAMILY_TYPES { TYPE_ELECTRIC, TYPE_GHOST }
    ...
    [SPECIES_ROTOM] =
    {
        ...
        .weight = 3,
        .description = COMPOUND_STRING(
            "Questo Pokémon è stato\n"
            "usato a lungo per ricerche\n"
    ...
    [SPECIES_UXIE] =
    {
        ...
        .categoryName = _("Sapienza"),
        .height = 3,
        .weight = 3,
        .description = COMPOUND_STRING(
            "Noto come “Essere della\n"
            "conoscenza”. Pare che faccia\n"
    ...
    [SPECIES_MESPRIT] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Ha insegnato agli uomini la\n"
            "nobiltà di tristezza, gioia e dolore."),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_AZELF] =
    {
        ...
        .categoryName = _("Volontà"),
        .height = 3,
        .weight = 3,
        .description = COMPOUND_STRING(
            "Detto “Essere della volontà”.\n"
            "Dorme sul fondo di un lago\n"
    ...
    [SPECIES_DIALGA] =
    {
        ...
        .categoryName = _("Tempo"),
        .height = 54,
        .weight = 6830,
        .description = COMPOUND_STRING(
            "Pokémon menzionato nelle\n"
            "leggende. Pare che il tempo abbia\n"
    ...
    [SPECIES_PALKIA] =
    {
        ...
        .categoryName = _("Spazio"),
        .height = 42,
        .weight = 3360,
        .description = COMPOUND_STRING(
            "Si dice che viva in una\n"
            "dimensione parallela\n"
            "alla nostra. Appare nella mitologia."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 650,
        .trainerOffset = 16,
    ...
    [SPECIES_REGIGIGAS] =
    {
        ...
        .categoryName = _("Colossale"),
        .height = 37,
        .weight = 4200,
        .description = COMPOUND_STRING(
            "Si dice che abbia creato dei\n"
            "Pokémon simili a sé usando una\n"
            "montagna ghiacciata, rocce e magma."),
        .pokemonScale = 256,
        .pokemonOffset = 2,
        .trainerScale = 610,
        .trainerOffset = 17,
    ...
    [SPECIES_GIRATINA_ALTERED] =
    {
        ...
        .categoryName = _("Ribelle"),
        .height = 45,
        .weight = 7500,
        .description = COMPOUND_STRING(
            "Vive nel Mondo Distorto che,\n"
            "sfidando l'ordine cosmico,\n"
    ...
    [SPECIES_CRESSELIA] =
    {
        ...
        .categoryName = _("Falcato"),
        .height = 15,
        .weight = 856,
        .description = COMPOUND_STRING(
            "Volando rilascia un velo di\n"
            "particelle brillanti. Si dice\n"
            "che rappresenti la luna crescente."),
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
        .trainerOffset = 0,
    ...
    [SPECIES_PHIONE] =
    {
        ...
        .categoryName = _("Oceanbondo"),
        .height = 4,
        .weight = 31,
        .description = COMPOUND_STRING(
            "Quando la temperatura del mare\n"
            "si alza, gonfia il galleggiante\n"
    ...
    [SPECIES_DARKRAI] =
    {
        ...
        .categoryName = _("Neropesto"),
        .height = 15,
        .weight = 505,
        .description = COMPOUND_STRING(
            "Respinge umani e Pokémon dal\n"
            "suo territorio inducendoli a un\n"
            "sonno profondo e provocando incubi."),
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
        .trainerOffset = 0,
    ...
    [SPECIES_SHAYMIN_LAND] =
    {
        ...
        .categoryName = _("Gratitudine"),
        .height = 2,
        .weight = 21,
        .description = COMPOUND_STRING(
            "Può dissolvere le tossine nell'aria\n"
            "per mutare all'istante una terra\n"
            "arida in un rigoglioso campo fiorito."),
        .pokemonScale = 682,
        .pokemonOffset = 24,
        .trainerScale = 256,
        .trainerOffset = 0,
