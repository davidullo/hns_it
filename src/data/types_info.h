...
const struct TypeInfo gTypesInfo[NUMBER_OF_MON_TYPES] =
{
    ...
    {
        .name = _("COLEOTTERO"),
        .generic = _("una mossa COLEOTTERO"),
        .palette = 15,
