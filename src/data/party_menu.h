...
static const u8 *const sActionStringTable[] =
{
    ...
    [PARTY_MSG_NO_POKEMON]             = COMPOUND_STRING("Non hai nessun POKéMON."),
...
static const u8 sText_Trade4[] = _("SCAMBIO");
...
} static const sCursorOptions[MENU_FIELD_MOVES] =
{
    ...
    [MENU_SHIFT]           = {COMPOUND_STRING("SPOSTA"),           CursorCb_SendMon},
    [MENU_SEND_OUT]        = {COMPOUND_STRING("MANDA"),        CursorCb_SendMon},
    [MENU_ENTER]           = {COMPOUND_STRING("ENTRA"),           CursorCb_Enter},
    [MENU_NO_ENTRY]        = {COMPOUND_STRING("NO"),        CursorCb_NoEntry},
    [MENU_STORE]           = {COMPOUND_STRING("NEGOZIO"),           CursorCb_Store},
    [MENU_REGISTER]        = {gText_Register,                     CursorCb_Register},
    [MENU_TRADE1]          = {sText_Trade4,                       CursorCb_Trade1},
    [MENU_TRADE2]          = {sText_Trade4,                       CursorCb_Trade2},
    [MENU_TOSS]            = {gMenuText_Toss,                     CursorCb_Toss},
    [MENU_LEVEL_UP_MOVES]  = {COMPOUND_STRING("MOSSE LIVELLO"),     CursorCb_ChangeLevelUpMoves},
    [MENU_EGG_MOVES]       = {COMPOUND_STRING("MOSSE UOVO"),       CursorCb_ChangeEggMoves},
    [MENU_TM_MOVES]        = {COMPOUND_STRING("MOSSE MT"),        CursorCb_ChangeTMMoves},
    [MENU_TUTOR_MOVES]     = {COMPOUND_STRING("MOSSE TUTOR"),     CursorCb_ChangeTutorMoves},
    [MENU_SUB_MOVES]       = {COMPOUND_STRING("IMPARA MOSSE"),     CursorCb_LearnMovesSubMenu},
    [MENU_CATALOG_BULB]    = {COMPOUND_STRING("Lampadina"),      CursorCb_CatalogBulb},
    [MENU_CATALOG_OVEN]    = {COMPOUND_STRING("Forno a microonde"),  CursorCb_CatalogOven},
    [MENU_CATALOG_WASHING] = {COMPOUND_STRING("Lavatrice"), CursorCb_CatalogWashing},
    [MENU_CATALOG_FRIDGE]  = {COMPOUND_STRING("Frigorifero"),    CursorCb_CatalogFridge},
    [MENU_CATALOG_FAN]     = {COMPOUND_STRING("Ventilatore"),    CursorCb_CatalogFan},
    [MENU_CATALOG_MOWER]   = {COMPOUND_STRING("Tagliaerba"),      CursorCb_CatalogMower},
    [MENU_CHANGE_FORM]     = {COMPOUND_STRING("Cambia forma"),     CursorCb_ChangeForm},
    [MENU_CHANGE_ABILITY]  = {COMPOUND_STRING("Cambia Abilità"),  CursorCb_ChangeAbility},
    [MENU_PKMN_FOLLOWER]   = {COMPOUND_STRING("{PKMN} SEGUACE"), CursorCb_PkmnFollower},
};
