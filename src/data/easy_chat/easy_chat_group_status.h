const struct EasyChatWordInfo gEasyChatGroup_Status[] = {
    ...
    {
        .text = COMPOUND_STRING("SINCRONISMO"),
    ...
    {
        .text = COMPOUND_STRING("LEGGIADRO"),
    ...
    {
        .text = COMPOUND_STRING("SVEGLIALAMPO"),
    ...
    {
        .text = COMPOUND_STRING("PELLEDURA"),
