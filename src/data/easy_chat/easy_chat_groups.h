...
const struct EasyChatGroup gEasyChatGroups[EC_NUM_GROUPS] = {
    ...
    [EC_GROUP_FEELINGS] =
    {
        .name = COMPOUND_STRING("SENTIMENTI"),
    ...
    [EC_GROUP_CONDITIONS] =
    {
        .name = COMPOUND_STRING("CONDIZIONI"),
    ...
    [EC_GROUP_HOBBIES] =
    {
        .name = COMPOUND_STRING("PASSATEMPI"),
    ...
    [EC_GROUP_ADJECTIVES] =
    {
        .name = COMPOUND_STRING("AGGETTIVI"),
    ...
    {
        .name = COMPOUND_STRING("MODO DI DIRE"),
