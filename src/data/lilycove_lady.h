...
static const struct LilycoveContestLadyValues sContestLadyValues[] =
{
    [CONTEST_CATEGORY_COOL] = {
        ...
        .monName = COMPOUND_STRING("BELLISSIMO"),
        .categoryName = COMPOUND_STRING("classe"),
    ...
    [CONTEST_CATEGORY_BEAUTY] = {
        ...
        .categoryName = COMPOUND_STRING("bellezza"),
    ...
    [CONTEST_CATEGORY_TOUGH] = {
        ...
        .categoryName = COMPOUND_STRING("forza"),
...
{
    {.request = COMPOUND_STRING("scivoloso"), .acceptedItems = sFavorLadyAcceptedItems_Slippery, .prize = ITEM_LUXURY_BALL},
    {.request = COMPOUND_STRING("tondetto"), .acceptedItems = sFavorLadyAcceptedItems_Roundish, .prize = ITEM_NUGGET},
    {.request = COMPOUND_STRING("boom"), .acceptedItems = sFavorLadyAcceptedItems_Whamish,  .prize = ITEM_PROTEIN},
    {.request = COMPOUND_STRING("brillante"),    .acceptedItems = sFavorLadyAcceptedItems_Shiny,    .prize = ITEM_HEART_SCALE},
    {.request = COMPOUND_STRING("appiccicoso"),   .acceptedItems = sFavorLadyAcceptedItems_Sticky,   .prize = ITEM_RARE_CANDY},
    {.request = COMPOUND_STRING("appuntito"),   .acceptedItems = sFavorLadyAcceptedItems_Pointy,   .prize = ITEM_PP_MAX},
};
