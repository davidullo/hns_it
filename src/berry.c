...
const struct Berry gBerries[] =
{
    [ITEM_CHERI_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description1 = COMPOUND_STRING("Sboccia con delicati e bei fiori."),
        .description2 = COMPOUND_STRING("La Bacca rossa brillante è piccante."),
    ...
    [ITEM_CHESTO_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(6, 5, 15, 20),
        .minYield = YIELD_RATE(5, 2, 4, 4),
        .description1 = COMPOUND_STRING("La buccia spessa e la polpa della"),
        .description2 = COMPOUND_STRING("dura. Ha un sapore aspro ovunque."),
        .growthDuration = GROWTH_DURATION(12, 12, 18, 24, 16, 24),
        .spicy = 0,
        .dry = 10,
        .sweet = 0,
    ...
    [ITEM_PECHA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(6, 5, 15, 20),
        .minYield = YIELD_RATE(5, 2, 4, 4),
        .description1 = COMPOUND_STRING("Molto dolce e deliziosa."),
        .description2 = COMPOUND_STRING("Anche molto tenera, maneggiare con cura."),
        .growthDuration = GROWTH_DURATION(12, 12, 18, 24, 16, 24),
        .spicy = 0,
        .dry = 0,
        .sweet = 10,
    ...
    [ITEM_RAWST_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(6, 5, 15, 20),
        .minYield = YIELD_RATE(5, 2, 4, 4),
        .description1 = COMPOUND_STRING("Se le foglie crescono lunghe e ricce,"),
        .description2 = COMPOUND_STRING("la Bacca sembra crescere molto amara."),
        .growthDuration = GROWTH_DURATION(12, 12, 18, 24, 16, 24),
        .spicy = 0,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_ASPEAR_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(6, 5, 15, 20),
        .minYield = YIELD_RATE(5, 2, 4, 4),
        .description1 = COMPOUND_STRING("La Bacca dura è densa di un ricco"),
        .description2 = COMPOUND_STRING("succo. È piuttosto aspra."),
        .growthDuration = GROWTH_DURATION(12, 12, 18, 24, 16, 24),
        .spicy = 0,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_LEPPA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description1 = COMPOUND_STRING("Cresce più lentamente della Ciliegia."),
        .description2 = COMPOUND_STRING("Più la Bacca è piccola, più è gustosa."),
    ...
    [ITEM_ORAN_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(6, 5, 15, 20),
        .minYield = YIELD_RATE(5, 2, 4, 4),
        .description1 = COMPOUND_STRING("Bacca singolare dai mille sapori."),
        .description2 = COMPOUND_STRING("Le bacche crescono in mezza giornata."),
    ...
    [ITEM_PERSIM_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(6, 5, 15, 20),
        .minYield = YIELD_RATE(5, 2, 4, 4),
        .description1 = COMPOUND_STRING("Ama il sole. Il colore della Bacca"),
        .description2 = COMPOUND_STRING("si accende se esposta al sole."),
        .growthDuration = GROWTH_DURATION(12, 16, 24, 24, 16, 24),
        .spicy = 10,
        .dry = 10,
        .sweet = 10,
    ...
    [ITEM_LUM_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description1 = COMPOUND_STRING("Cresce lenta. Se curata con amore,"),
        .description2 = COMPOUND_STRING("può dare due Bacche."),
    ...
    [ITEM_SITRUS_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description1 = COMPOUND_STRING("Simile alla Oran. La bacca"),
        .description2 = COMPOUND_STRING("ha un sapore molto equilibrato."),
    ...
    [ITEM_FIGY_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description1 = COMPOUND_STRING("La bacca, che sembra masticata,"),
        .description2 = COMPOUND_STRING("è piena di sostanze piccanti."),
    ...
    [ITEM_WIKI_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(6, 5, 15, 15),
        .minYield = YIELD_RATE(5, 1, 3, 3),
        .description1 = COMPOUND_STRING("Si dice che la bacca sia cresciuta"),
        .description2 = COMPOUND_STRING("irregolare per farsi afferrare."),
        .growthDuration = GROWTH_DURATION(24, 20, 30, 24, 16, 24),
        .spicy = 0,
        .dry = 10,
        .sweet = 0,
    ...
    [ITEM_MAGO_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(6, 5, 15, 15),
        .minYield = YIELD_RATE(5, 1, 3, 3),
        .description1 = COMPOUND_STRING("La bacca diventa curva crescendo."),
        .description2 = COMPOUND_STRING("Più è curva, più è dolce e gustosa."),
        .growthDuration = GROWTH_DURATION(24, 20, 30, 24, 16, 24),
        .spicy = 0,
        .dry = 0,
        .sweet = 10,
    ...
    [ITEM_AGUAV_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(6, 5, 15, 15),
        .minYield = YIELD_RATE(5, 1, 3, 3),
        .description1 = COMPOUND_STRING("Il fiore è delicato. È raro che"),
        .description2 = COMPOUND_STRING("cresca senza luce."),
        .growthDuration = GROWTH_DURATION(24, 20, 30, 24, 16, 24),
        .spicy = 0,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_IAPAPA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(6, 5, 15, 15),
        .minYield = YIELD_RATE(5, 1, 3, 3),
        .description1 = COMPOUND_STRING("La bacca è molto grande e aspra."),
        .description2 = COMPOUND_STRING("Cresce in almeno un giorno."),
        .growthDuration = GROWTH_DURATION(24, 20, 30, 24, 16, 24),
        .spicy = 0,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_RAZZ_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description1 = COMPOUND_STRING("La bacca rossa è un po' piccante."),
        .description2 = COMPOUND_STRING("Cresce in fretta, in quattro ore."),
    ...
    [ITEM_BLUK_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(6, 10, 15, 20),
        .minYield = YIELD_RATE(5, 2, 3, 4),
        .description1 = COMPOUND_STRING("La bacca è blu di fuori, ma molto"),
        .description2 = COMPOUND_STRING("ma mangiata annerisce la bocca."),
        .growthDuration = GROWTH_DURATION(4, 8, 12, 24, 16, 24),
        .spicy = 0,
        .dry = 10,
        .sweet = 10,
    ...
    [ITEM_NANAB_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(6, 10, 15, 20),
        .minYield = YIELD_RATE(5, 2, 3, 4),
        .description1 = COMPOUND_STRING("Questa bacca fu la settima"),
        .description2 = COMPOUND_STRING("scoperta al mondo. È dolce."),
        .growthDuration = GROWTH_DURATION(4, 8, 12, 24, 16, 24),
        .spicy = 0,
        .dry = 0,
        .sweet = 10,
    ...
    [ITEM_WEPEAR_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(6, 10, 15, 20),
        .minYield = YIELD_RATE(5, 2, 3, 4),
        .description1 = COMPOUND_STRING("Il fiore è piccolo e bianco. Ha un"),
        .description2 = COMPOUND_STRING("delicato equilibrio di amaro e aspro."),
        .growthDuration = GROWTH_DURATION(4, 8, 12, 24, 16, 24),
        .spicy = 0,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_PINAP_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(6, 10, 15, 20),
        .minYield = YIELD_RATE(5, 2, 3, 4),
        .description1 = COMPOUND_STRING("Debole contro vento e freddo."),
        .description2 = COMPOUND_STRING("Il frutto è piccante, la buccia aspra."),
        .growthDuration = GROWTH_DURATION(4, 8, 12, 24, 16, 24),
        .spicy = 10,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_POMEG_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description1 = COMPOUND_STRING("Per quanto la si annaffi,"),
        .description2 = COMPOUND_STRING("cresce al massimo sei bacche."),
    ...
    [ITEM_KELPSY_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(11, 5, 20, 26),
        .minYield = YIELD_RATE(10, 1, 1, 2),
        .description1 = COMPOUND_STRING("Rara varietà a forma di radice."),
        .description2 = COMPOUND_STRING("Fa sbocciare un fiore enorme."),
        .growthDuration = GROWTH_DURATION(12, 32, 48, 48, 32, 48),
        .spicy = 0,
        .dry = 10,
        .sweet = 0,
    ...
    [ITEM_QUALOT_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(11, 5, 20, 26),
        .minYield = YIELD_RATE(10, 1, 1, 2),
        .description1 = COMPOUND_STRING("Ama l'acqua. Cresce forte anche nei"),
        .description2 = COMPOUND_STRING("luoghi con piogge costanti."),
        .growthDuration = GROWTH_DURATION(12, 32, 48, 48, 32, 48),
        .spicy = 10,
        .dry = 0,
        .sweet = 10,
    ...
    [ITEM_HONDEW_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(11, 5, 20, 26),
        .minYield = YIELD_RATE(10, 1, 1, 2),
        .description1 = COMPOUND_STRING("Una bacca molto preziosa e rara."),
        .description2 = COMPOUND_STRING("È davvero deliziosa."),
        .growthDuration = GROWTH_DURATION(12, 32, 48, 48, 32, 48),
        .spicy = 10,
        .dry = 10,
        .sweet = 0,
    ...
    [ITEM_GREPA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(11, 5, 20, 26),
        .minYield = YIELD_RATE(10, 1, 1, 2),
        .description1 = COMPOUND_STRING("Nonostante la sua tenerezza e la"),
        .description2 = COMPOUND_STRING("forma rotonda, è incredibilmente aspra."),
        .growthDuration = GROWTH_DURATION(12, 32, 48, 48, 32, 48),
        .spicy = 0,
        .dry = 10,
        .sweet = 10,
    ...
    [ITEM_TAMATO_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(11, 5, 20, 26),
        .minYield = YIELD_RATE(10, 1, 1, 2),
        .description1 = COMPOUND_STRING("La bacca è così piccante da stordire."),
        .description2 = COMPOUND_STRING("Cresce lentamente."),
        .growthDuration = GROWTH_DURATION(24, 32, 48, 48, 32, 48),
        .spicy = 20,
        .dry = 10,
        .sweet = 0,
    ...
    [ITEM_CORNN_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .minYield = YIELD_RATE(5, 2, 3, 3),
        .description1 = COMPOUND_STRING("Bacca di un'era antica. Forse non"),
        .description2 = COMPOUND_STRING("cresce se non piantata in gran quantità."),
    ...
    [ITEM_MAGOST_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(6, 10, 15, 15),
        .minYield = YIELD_RATE(5, 2, 3, 3),
        .description1 = COMPOUND_STRING("Una bacca che si dice abbia un"),
        .description2 = COMPOUND_STRING("sapore ben bilanciato."),
        .growthDuration = GROWTH_DURATION(24, 24, 36, 24, 16, 24),
        .spicy = 0,
        .dry = 0,
        .sweet = 20,
    ...
    [ITEM_RABUTA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(6, 10, 15, 15),
        .minYield = YIELD_RATE(5, 2, 3, 3),
        .description1 = COMPOUND_STRING("Rara varietà ricoperta di peli."),
        .description2 = COMPOUND_STRING("È piuttosto amara."),
        .growthDuration = GROWTH_DURATION(24, 24, 36, 24, 16, 24),
        .spicy = 0,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_NOMEL_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(6, 10, 15, 15),
        .minYield = YIELD_RATE(5, 2, 3, 3),
        .description1 = COMPOUND_STRING("Molto aspra. Un solo morso rende"),
        .description2 = COMPOUND_STRING("impossibile da gustare per tre giorni."),
        .growthDuration = GROWTH_DURATION(24, 24, 36, 24, 16, 24),
        .spicy = 10,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_SPELON_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .minYield = YIELD_RATE(5, 2, 3, 3),
        .description1 = COMPOUND_STRING("La bacca rosso vivo è molto piccante."),
    ...
    [ITEM_PAMTRE_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description1 = COMPOUND_STRING("Vaga sul mare da chissà dove."),
        .description2 = COMPOUND_STRING("Si pensa che cresca altrove."),
        .growthDuration = GROWTH_DURATION(72, 60, 90, 24, 16, 24),
        .spicy = 0,
        .dry = 40,
        .sweet = 10,
    ...
    [ITEM_WATMEL_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(6, 15, 15, 15),
        .minYield = YIELD_RATE(5, 2, 3, 3),
        .description1 = COMPOUND_STRING("Una bacca enorme, alcune superano"),
        .description2 = COMPOUND_STRING("i 50 cm. Estremamente dolce."),
        .growthDuration = GROWTH_DURATION(72, 60, 90, 24, 16, 24),
        .spicy = 0,
        .dry = 0,
        .sweet = 40,
    ...
    [ITEM_DURIN_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(6, 15, 15, 15),
        .minYield = YIELD_RATE(5, 3, 3, 3),
        .description1 = COMPOUND_STRING("Amara anche solo a guardarla. È così"),
        .description2 = COMPOUND_STRING("amara che nessuno l'ha mai mangiata così."),
        .growthDuration = GROWTH_DURATION(72, 60, 90, 24, 16, 24),
        .spicy = 0,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_BELUE_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(6, 15, 15, 15),
        .minYield = YIELD_RATE(5, 2, 3, 3),
        .description1 = COMPOUND_STRING("È lucida e sembra deliziosa, ma"),
        .description2 = COMPOUND_STRING("è terribilmente aspra. Cresce lentamente."),
        .growthDuration = GROWTH_DURATION(72, 60, 90, 24, 16, 24),
        .spicy = 10,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_CHILAN_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description1 = COMPOUND_STRING("Si può fare un fischietto che"),
        .description2 = COMPOUND_STRING("produce un suono indescrivibile."),
    ...
    [ITEM_OCCA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("Si dice che cresca ai tropici,"),
        .description2 = COMPOUND_STRING("ha un sapore piccante intensissimo."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 15,
        .dry = 0,
        .sweet = 10,
    ...
    [ITEM_PASSHO_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("La polpa è punteggiata di tante piccole"),
        .description2 = COMPOUND_STRING("bolle che la tengono a galla nell'acqua."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 0,
        .dry = 15,
        .sweet = 0,
    ...
    [ITEM_WACAN_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("L'energia dei fulmini fa crescere"),
        .description2 = COMPOUND_STRING("questa Bacca grande e ricca."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 0,
        .dry = 0,
        .sweet = 15,
    ...
    [ITEM_RINDO_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("Ha un sapore di verdura,"),
        .description2 = COMPOUND_STRING("ma è ricca di fibre salutari."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 10,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_YACHE_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("Questa bacca ha un sapore secco e"),
        .description2 = COMPOUND_STRING("aspro rinfrescante. Meglio fredda."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 0,
        .dry = 10,
        .sweet = 0,
    ...
    [ITEM_CHOPLE_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("Contiene una sostanza che genera"),
        .description2 = COMPOUND_STRING("calore. Scalda anche un cuore freddo."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 15,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_KEBIA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("Verde brillante fuori, dentro"),
        .description2 = COMPOUND_STRING("è piena di polpa nera."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 0,
        .dry = 15,
        .sweet = 0,
    ...
    [ITEM_COBA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("Si dice che questa Bacca sia nata"),
        .description2 = COMPOUND_STRING("dall'incrocio di due Bacche lontane."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 0,
        .dry = 10,
        .sweet = 0,
    ...
    [ITEM_PAYAPA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("Percepisce le emozioni umane e si gonfia"),
        .description2 = COMPOUND_STRING("quando una persona si avvicina."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 0,
        .dry = 0,
        .sweet = 10,
    ...
    [ITEM_TANGA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("Sulla punta cresce un fiore che attira"),
        .description2 = COMPOUND_STRING("i POKéMON Coleottero con i petali."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 20,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_CHARTI_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("Spesso usata per i sottaceti per il suo"),
        .description2 = COMPOUND_STRING("sapore secco. A volte si mangia cruda."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 10,
        .dry = 20,
        .sweet = 0,
    ...
    [ITEM_KASIB_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("Vecchie superstizioni le attribuiscono"),
        .description2 = COMPOUND_STRING("strani poteri. È un portafortuna."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 0,
        .dry = 10,
        .sweet = 20,
    ...
    [ITEM_HABAN_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("Bollita a lungo, questa Bacca è meno"),
        .description2 = COMPOUND_STRING("amara. Ottima per le confetture."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 0,
        .dry = 0,
        .sweet = 10,
    ...
    [ITEM_COLBUR_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("Piccoli uncini sulla buccia si agganciano"),
        .description2 = COMPOUND_STRING("POKéMON per raggiungere luoghi lontani."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 0,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_BABIRI_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("Molto dura, dal sapore intenso. Si"),
        .description2 = COMPOUND_STRING("si usava per preparare medicine."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 25,
        .dry = 10,
        .sweet = 0,
    ...
    [ITEM_ROSELI_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("In natura crescono in ampi anelli"),
        .description2 = COMPOUND_STRING("per motivi ancora sconosciuti."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 0,
        .dry = 0,
        .sweet = 25,
    ...
    [ITEM_LIECHI_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description2 = COMPOUND_STRING("racchiuda il potere del mare."),
    ...
    [ITEM_GANLON_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .minYield = YIELD_RATE(5, 1, 1, 2),
        .description1 = COMPOUND_STRING("Una Bacca misteriosa. Si dice che"),
        .description2 = COMPOUND_STRING("racchiuda il potere della terra."),
        .growthDuration = GROWTH_DURATION(96, 96, 144, 96, 48, 72),
        .spicy = 0,
        .dry = 40,
        .sweet = 0,
    ...
    [ITEM_SALAC_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .minYield = YIELD_RATE(5, 1, 1, 2),
        .description1 = COMPOUND_STRING("Una Bacca misteriosa. Si dice che"),
        .description2 = COMPOUND_STRING("racchiuda il potere del cielo."),
        .growthDuration = GROWTH_DURATION(96, 96, 144, 96, 48, 72),
        .spicy = 0,
        .dry = 0,
        .sweet = 40,
    ...
    [ITEM_APICOT_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(6, 5, 10, 13),
        .minYield = YIELD_RATE(5, 1, 1, 2),
        .description1 = COMPOUND_STRING("Bacca molto misteriosa. Non si sa"),
        .description2 = COMPOUND_STRING("cosa possa accadere o a che serva."),
        .growthDuration = GROWTH_DURATION(96, 96, 144, 96, 48, 72),
        .spicy = 0,
        .dry = 40,
        .sweet = 0,
    ...
    [ITEM_LANSAT_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description1 = COMPOUND_STRING("Bacca leggendaria, si dice."),
        .description2 = COMPOUND_STRING("Pare che tenerla porti gioia."),
    ...
    [ITEM_STARF_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(6, 5, 5, 7),
        .minYield = YIELD_RATE(5, 1, 1, 1),
        .description1 = COMPOUND_STRING("Così forte da essere abbandonata"),
        .description2 = COMPOUND_STRING("ai confini del mondo. Un miraggio."),
        .growthDuration = GROWTH_DURATION(96, 96, 144, 120, 48, 72),
        .spicy = 10,
        .dry = 10,
        .sweet = 10,
    ...
    [ITEM_ENIGMA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .minYield = YIELD_RATE(5, 1, 1, 1),
        .description1 = COMPOUND_STRING("Bacca del tutto enigmatica."),
        .description2 = COMPOUND_STRING("Sembra avere il potere delle stelle."),
    ...
    [ITEM_MICLE_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description1 = COMPOUND_STRING("Rende dolce il cibo mangiato"),
        .description2 = COMPOUND_STRING("insieme a essa."),
        .growthDuration = GROWTH_DURATION(96, 96, 144, 72, 48, 72),
        .spicy = 0,
        .dry = 40,
        .sweet = 10,
    ...
    [ITEM_CUSTAP_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(2, 5, 5, 13),
        .minYield = YIELD_RATE(1, 1, 1, 1),
        .description1 = COMPOUND_STRING("La polpa sotto la buccia della Bacca"),
        .description2 = COMPOUND_STRING("Custap è dolce e cremosa al tatto."),
        .growthDuration = GROWTH_DURATION(96, 96, 144, 72, 48, 72),
        .spicy = 0,
        .dry = 0,
        .sweet = 40,
    ...
    [ITEM_JABOCA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(2, 5, 5, 13),
        .minYield = YIELD_RATE(1, 1, 1, 1),
        .description1 = COMPOUND_STRING("Le drupeole che la compongono"),
        .description2 = COMPOUND_STRING("scoppiettano se la si maneggia male."),
        .growthDuration = GROWTH_DURATION(96, 96, 144, 72, 48, 72),
        .spicy = 0,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_ROWAP_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(2, 5, 5, 13),
        .minYield = YIELD_RATE(1, 1, 1, 1),
        .description1 = COMPOUND_STRING("Un tempo se ne ricavavano trottole"),
        .description2 = COMPOUND_STRING("da usare come giocattoli."),
        .growthDuration = GROWTH_DURATION(96, 96, 144, 72, 48, 72),
        .spicy = 10,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_KEE_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description1 = COMPOUND_STRING("Bacca incredibilmente piccante"),
        .description2 = COMPOUND_STRING("all'inizio, poi amarissima."),
        .growthDuration = GROWTH_DURATION(96, 96, 144, 96, 48, 72),
        .spicy = 30,
        .dry = 30,
        .sweet = 10,
    ...
    [ITEM_MARANGA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(2, 5, 10, 13),
        .minYield = YIELD_RATE(1, 1, 1, 2),
        .description1 = COMPOUND_STRING("Fuori è molto amara, ma dentro"),
        .description2 = COMPOUND_STRING("sa di bevanda dolce."),
        .growthDuration = GROWTH_DURATION(96, 96, 144, 96, 48, 72),
        .spicy = 10,
        .dry = 10,
        .sweet = 30,
