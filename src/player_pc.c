...
static const u8 sText_WithdrawItem[] = _("RITIRA STRUM.");
static const u8 sText_DepositItem[] = _("DEPOSITA STRUM.");
static const u8 sText_TossItem[] = _("GETTA STRUM.");
static const u8 sText_Mailbox[] = _("CASELLA");

static const u8 sText_WithdrawHowManyItems[] = _("Prelevarne quanti\n{STR_VAR_1}?");
static const u8 sText_WithdrawXItems[] = _("Prelevati {STR_VAR_2}\n{STR_VAR_1}.");
static const u8 sText_NoRoomInBag[] = _("Non c'è più\nposto nello ZAINO.");
static const u8 sText_TooImportantToToss[] = _("È troppo\nimportante per\nessere buttato!");

static const u8 *const sItemStorage_OptionDescriptions[] =
{
    [MENU_WITHDRAW] = COMPOUND_STRING("Preleva oggetti dal PC."),
    [MENU_DEPOSIT]  = COMPOUND_STRING("Deposita oggetti nel PC."),
    [MENU_TOSS]     = COMPOUND_STRING("Butta via gli strumenti salvati nel PC."),
    [MENU_EXIT]     = gText_GoBackPrevMenu,
};

static const struct MenuAction sPlayerPCMenuActions[] =
{
    [MENU_ITEMSTORAGE] = { COMPOUND_STRING("STRUMENTI"), {PlayerPC_ItemStorage} },
...
const struct MenuAction gMailboxMailOptions[] =
{
    ...
    { COMPOUND_STRING("METTI IN ZAINO"), {Mailbox_MoveToBag} },
