...
#if IS_HNS
    [HELPBAR_MAP_ZOOMED_OUT]        = COMPOUND_STRING("{B_BUTTON}ANNULLA"),
    [HELPBAR_MAP_ZOOMED_IN]         = COMPOUND_STRING("{B_BUTTON}ANNULLA"),
    [HELPBAR_MAP_ZOOMED_OUT_CANFLY] = COMPOUND_STRING("{B_BUTTON}ANNULLA {R_BUTTON}VOLA"),
    [HELPBAR_MAP_ZOOMED_IN_CANFLY]  = COMPOUND_STRING("{B_BUTTON}ANNULLA {R_BUTTON}VOLA"),
#else
    [HELPBAR_MAP_ZOOMED_OUT]        = COMPOUND_STRING("{A_BUTTON}ZOOM {B_BUTTON}ANNULLA"),
    [HELPBAR_MAP_ZOOMED_IN]         = COMPOUND_STRING("{A_BUTTON}INTERO {B_BUTTON}ANNULLA"),
    [HELPBAR_MAP_ZOOMED_OUT_CANFLY] = COMPOUND_STRING("{A_BUTTON}ZOOM {B_BUTTON}ANNULLA {R_BUTTON}VOLA"),
    [HELPBAR_MAP_ZOOMED_IN_CANFLY]  = COMPOUND_STRING("{A_BUTTON}INTERO {B_BUTTON}ANNULLA {R_BUTTON}VOLA"),
#endif
    [HELPBAR_CONDITION_MON_LIST]    = COMPOUND_STRING("{A_BUTTON}STATO {B_BUTTON}ANNULLA"),
    [HELPBAR_CONDITION_MON_STATUS]  = COMPOUND_STRING("{A_BUTTON}SEGNI {B_BUTTON}ANNULLA"),
    [HELPBAR_CONDITION_MARKINGS]    = COMPOUND_STRING("{A_BUTTON}SCEGLI SEGNO {B_BUTTON}ANNULLA"),
    [HELPBAR_MC_TRAINER_LIST]       = COMPOUND_STRING("{A_BUTTON}MENU {B_BUTTON}ANNULLA"),
    [HELPBAR_MC_CALL_MENU]          = COMPOUND_STRING("{A_BUTTON}OK {B_BUTTON}ANNULLA"),
    [HELPBAR_MC_CHECK_PAGE]         = COMPOUND_STRING("{B_BUTTON}ANNULLA"),
    [HELPBAR_RIBBONS_MON_LIST]      = COMPOUND_STRING("{A_BUTTON}NASTRI {B_BUTTON}ANNULLA"),
    [HELPBAR_RIBBONS_LIST]          = COMPOUND_STRING("{A_BUTTON}VEDI {B_BUTTON}ANNULLA"),
    [HELPBAR_RIBBONS_CHECK]         = COMPOUND_STRING("{B_BUTTON}ANNULLA"),
};
