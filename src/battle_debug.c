...
static const struct ListMenuItem sVolatileStatusListItems[] =
{
    ...
    {COMPOUND_STRING("Sotto Sale"),          VOLATILE_SALT_CURE},
    {COMPOUND_STRING("Bomba Sciroppata"),         VOLATILE_SYRUP_BOMB},
    {COMPOUND_STRING("Spadoncarica"),        VOLATILE_GLAIVE_RUSH},
    ...
    {COMPOUND_STRING("Gastroacido"),        VOLATILE_GASTRO_ACID},
    ...
    {COMPOUND_STRING("Magnetascesa"),        VOLATILE_MAGNET_RISE},
    {COMPOUND_STRING("Anticura"),         VOLATILE_HEAL_BLOCK},
    {COMPOUND_STRING("Acquanello"),          VOLATILE_AQUA_RING},
    {COMPOUND_STRING("Concentrazione"),        VOLATILE_LASER_FOCUS},
    {COMPOUND_STRING("Ingannoforza"),        VOLATILE_POWER_TRICK},
};

static const struct ListMenuItem sHazardsListItems[] =
{
    {COMPOUND_STRING("Punte"),       LIST_SIDE_SPIKES},
    {COMPOUND_STRING("Rete Vischiosa"),   LIST_SIDE_STICKY_WEB},
    {COMPOUND_STRING("Fielepunte"), LIST_SIDE_TOXIC_SPIKES},
    {COMPOUND_STRING("Levitoroccia"), LIST_SIDE_STEALTH_ROCK},
...
static const struct ListMenuItem sSideStatusListItems[] =
{
    ...
    {COMPOUND_STRING("Schermoluce"),     LIST_SIDE_LIGHTSCREEN},
    ...
    {COMPOUND_STRING("Fortuncanto"),      LIST_SIDE_LUCKY_CHANT},
...
static const u8 *const sHoldEffectNames[HOLD_EFFECT_COUNT] =
{
    ...
    [HOLD_EFFECT_MACHO_BRACE]      = COMPOUND_STRING("Crescicappa"),
    [HOLD_EFFECT_EXP_SHARE]        = COMPOUND_STRING("Exp Share"),
    [HOLD_EFFECT_QUICK_CLAW]       = COMPOUND_STRING("Rapidartigli"),
    [HOLD_EFFECT_FRIENDSHIP_UP]    = COMPOUND_STRING("Friendship Up"),
    [HOLD_EFFECT_MENTAL_HERB]      = COMPOUND_STRING("Mentalerba"),
    ...
    [HOLD_EFFECT_REPEL]            = COMPOUND_STRING("Repellente"),
    [HOLD_EFFECT_SOUL_DEW]         = COMPOUND_STRING("Cuorugiada"),
    [HOLD_EFFECT_DEEP_SEA_TOOTH]   = COMPOUND_STRING("Dente Abissi"),
    [HOLD_EFFECT_DEEP_SEA_SCALE]   = COMPOUND_STRING("Squamabissi"),
    [HOLD_EFFECT_CAN_ALWAYS_RUN]   = COMPOUND_STRING("Can Always Run"),
    [HOLD_EFFECT_PREVENT_EVOLVE]   = COMPOUND_STRING("Prevent Evolve"),
    [HOLD_EFFECT_FOCUS_BAND]       = COMPOUND_STRING("Bandana"),
    [HOLD_EFFECT_LUCKY_EGG]        = COMPOUND_STRING("Fortunuovo"),
    [HOLD_EFFECT_SCOPE_LENS]       = COMPOUND_STRING("Mirino"),
    [HOLD_EFFECT_LEFTOVERS]        = COMPOUND_STRING("Avanzi"),
    [HOLD_EFFECT_LIGHT_BALL]       = COMPOUND_STRING("Elettropalla"),
    [HOLD_EFFECT_TYPE_POWER]       = COMPOUND_STRING("Type Power"),
    [HOLD_EFFECT_SHELL_BELL]       = COMPOUND_STRING("Conchinella"),
    [HOLD_EFFECT_LUCKY_PUNCH]      = COMPOUND_STRING("Fortunpugno"),
    [HOLD_EFFECT_METAL_POWDER]     = COMPOUND_STRING("Metalpolvere"),
    [HOLD_EFFECT_THICK_CLUB]       = COMPOUND_STRING("Ossospesso"),
    [HOLD_EFFECT_LEEK]             = COMPOUND_STRING("Gambo"),
    [HOLD_EFFECT_CHOICE_SCARF]     = COMPOUND_STRING("Stolascelta"),
    [HOLD_EFFECT_CHOICE_SPECS]     = COMPOUND_STRING("Lentiscelta"),
    [HOLD_EFFECT_DAMP_ROCK]        = COMPOUND_STRING("Rocciaumida"),
    ...
    [HOLD_EFFECT_METRONOME]        = COMPOUND_STRING("Metronomo"),
    ...
    [HOLD_EFFECT_STICKY_BARB]      = COMPOUND_STRING("Vischiopunta"),
    [HOLD_EFFECT_IRON_BALL]        = COMPOUND_STRING("Ferropalla"),
    [HOLD_EFFECT_BLACK_SLUDGE]     = COMPOUND_STRING("Fangopece"),
    [HOLD_EFFECT_DESTINY_KNOT]     = COMPOUND_STRING("Destincomune"),
    [HOLD_EFFECT_SHED_SHELL]       = COMPOUND_STRING("Disfoguscio"),
    [HOLD_EFFECT_QUICK_POWDER]     = COMPOUND_STRING("Velopolvere"),
    [HOLD_EFFECT_ADAMANT_ORB]      = COMPOUND_STRING("Adamasfera"),
    [HOLD_EFFECT_LUSTROUS_ORB]     = COMPOUND_STRING("Splendisfera"),
    [HOLD_EFFECT_GRISEOUS_ORB]     = COMPOUND_STRING("Grigiosfera"),
    [HOLD_EFFECT_ENIGMA_BERRY]     = COMPOUND_STRING("Baccaenigma"),
    ...
    [HOLD_EFFECT_MICLE_BERRY]      = COMPOUND_STRING("Baccaracolo"),
    [HOLD_EFFECT_CUSTAP_BERRY]     = COMPOUND_STRING("Baccacrela"),
    [HOLD_EFFECT_JABOCA_BERRY]     = COMPOUND_STRING("Baccajaba"),
    [HOLD_EFFECT_ROWAP_BERRY]      = COMPOUND_STRING("Baccaroam"),
    [HOLD_EFFECT_KEE_BERRY]        = COMPOUND_STRING("Baccalighia"),
    [HOLD_EFFECT_MARANGA_BERRY]    = COMPOUND_STRING("Baccapane"),
    [HOLD_EFFECT_PLATE]            = COMPOUND_STRING("Plate"),
    [HOLD_EFFECT_FLOAT_STONE]      = COMPOUND_STRING("Pietralieve"),
    [HOLD_EFFECT_EVIOLITE]         = COMPOUND_STRING("Evolcondensa"),
    [HOLD_EFFECT_ASSAULT_VEST]     = COMPOUND_STRING("Corpetto assalto"),
    [HOLD_EFFECT_DRIVE]            = COMPOUND_STRING("Drive"),
    [HOLD_EFFECT_GEMS]             = COMPOUND_STRING("Gems"),
    [HOLD_EFFECT_ROCKY_HELMET]     = COMPOUND_STRING("Bitorzolelmo"),
    [HOLD_EFFECT_AIR_BALLOON]      = COMPOUND_STRING("Palloncino"),
    [HOLD_EFFECT_RED_CARD]         = COMPOUND_STRING("Cartelrosso"),
    [HOLD_EFFECT_RING_TARGET]      = COMPOUND_STRING("Facilsaglio"),
    [HOLD_EFFECT_BINDING_BAND]     = COMPOUND_STRING("Legafascia"),
    [HOLD_EFFECT_EJECT_BUTTON]     = COMPOUND_STRING("Pulsantefuga"),
    [HOLD_EFFECT_ABSORB_BULB]      = COMPOUND_STRING("Bulbo"),
    [HOLD_EFFECT_CELL_BATTERY]     = COMPOUND_STRING("Ricaripila"),
    [HOLD_EFFECT_MEGA_STONE]       = COMPOUND_STRING("Mega Stone"),
    [HOLD_EFFECT_SAFETY_GOGGLES]   = COMPOUND_STRING("Visierantisabbia"),
    [HOLD_EFFECT_LUMINOUS_MOSS]    = COMPOUND_STRING("Muschioluce"),
    [HOLD_EFFECT_SNOWBALL]         = COMPOUND_STRING("Palla di neve"),
    [HOLD_EFFECT_WEAKNESS_POLICY]  = COMPOUND_STRING("Vulneropolizza"),
    [HOLD_EFFECT_PRIMAL_ORB]       = COMPOUND_STRING("Primal Orb"),
    [HOLD_EFFECT_PROTECTIVE_PADS]  = COMPOUND_STRING("Smorzaurti"),
    [HOLD_EFFECT_TERRAIN_EXTENDER] = COMPOUND_STRING("Fissacampo"),
    [HOLD_EFFECT_TERRAIN_SEED]     = COMPOUND_STRING("Seeds"),
    [HOLD_EFFECT_ADRENALINE_ORB]   = COMPOUND_STRING("Fifasfera"),
    [HOLD_EFFECT_MEMORY]           = COMPOUND_STRING("Memory"),
    [HOLD_EFFECT_Z_CRYSTAL]        = COMPOUND_STRING("Z-Crystal"),
    [HOLD_EFFECT_UTILITY_UMBRELLA] = COMPOUND_STRING("Superombrello"),
    [HOLD_EFFECT_EJECT_PACK]       = COMPOUND_STRING("Zainofuga"),
    [HOLD_EFFECT_ROOM_SERVICE]     = COMPOUND_STRING("Distorservizio"),
    [HOLD_EFFECT_BLUNDER_POLICY]   = COMPOUND_STRING("Fiascopolizza"),
    [HOLD_EFFECT_HEAVY_DUTY_BOOTS] = COMPOUND_STRING("Heavy Duty Boots"),
    [HOLD_EFFECT_THROAT_SPRAY]     = COMPOUND_STRING("Spray gola"),
    [HOLD_EFFECT_ABILITY_SHIELD]   = COMPOUND_STRING("Scudo abilità"),
    [HOLD_EFFECT_CLEAR_AMULET]     = COMPOUND_STRING("Ciondolochiaro"),
    [HOLD_EFFECT_MIRROR_HERB]      = COMPOUND_STRING("Foglia carbone"),
    [HOLD_EFFECT_PUNCHING_GLOVE]   = COMPOUND_STRING("Guantone"),
    [HOLD_EFFECT_COVERT_CLOAK]     = COMPOUND_STRING("Anonimanto"),
    [HOLD_EFFECT_LOADED_DICE]      = COMPOUND_STRING("Dado truccato"),
    [HOLD_EFFECT_BOOSTER_ENERGY]   = COMPOUND_STRING("Capsula energetica"),
