...
// const rom data
static const u8 sText_Ability[] = _("Abilità");
static const u8 sText_HeldItem[] = _("Strumento");
static const u8 sText_HoldEffect[] = _("Effetto");
...
{
    {COMPOUND_STRING("Mosse"),        LIST_ITEM_MOVES},
    {sText_Ability,                   LIST_ITEM_ABILITY},
    {sText_HeldItem,                  LIST_ITEM_HELD_ITEM},
    {COMPOUND_STRING("PP"),           LIST_ITEM_PP},
    {COMPOUND_STRING("Tipi"),        LIST_ITEM_TYPES},
    {COMPOUND_STRING("Statistiche"),        LIST_ITEM_STATS},
    {COMPOUND_STRING("Livelli Stat."),  LIST_ITEM_STAT_STAGES},
    {COMPOUND_STRING("Stato1"),      LIST_ITEM_STATUS1},
    {COMPOUND_STRING("Volatili"),    LIST_ITEM_VOLATILE},
    {COMPOUND_STRING("Trappole"),      LIST_ITEM_HAZARDS},
    {COMPOUND_STRING("Stato Lato"),  LIST_ITEM_SIDE_STATUS},
    {COMPOUND_STRING("IA"),           LIST_ITEM_AI},
    {COMPOUND_STRING("IA Pti/Dan"),   LIST_ITEM_AI_MOVES_PTS},
    {COMPOUND_STRING("Info IA"),      LIST_ITEM_AI_INFO},
    {COMPOUND_STRING("Squadra IA"),     LIST_ITEM_AI_PARTY},
    {COMPOUND_STRING("Vari"),      LIST_ITEM_VARIOUS},
    {COMPOUND_STRING("Vittoria Istantanea"),  LIST_ITEM_INSTANT_WIN},
};

static const struct ListMenuItem sStatsListItems[] =
{
    {COMPOUND_STRING("PS Attuali"), LIST_STAT_HP_CURRENT},
    {COMPOUND_STRING("PS max"),     LIST_STAT_HP_MAX},
    {COMPOUND_STRING("Attacco"),     LIST_STAT_ATTACK},
    {COMPOUND_STRING("Difesa"),    LIST_STAT_DEFENSE},
    {COMPOUND_STRING("Velocità"),      LIST_STAT_SPEED},
    {COMPOUND_STRING("Att. Sp."),    LIST_STAT_SP_ATK},
    {COMPOUND_STRING("Dif. Sp."),    LIST_STAT_SP_DEF},
};

static const struct ListMenuItem sStatus1ListItems[] =
{
    {COMPOUND_STRING("Sonno"),         LIST_STATUS1_SLEEP},
    {COMPOUND_STRING("Veleno"),        LIST_STATUS1_POISON},
    {COMPOUND_STRING("Scottatura"),          LIST_STATUS1_BURN},
    {COMPOUND_STRING("Gelo"),        LIST_STATUS1_FREEZE},
...
{
    {COMPOUND_STRING("Confusione"),          VOLATILE_CONFUSION},
    {COMPOUND_STRING("Tentenn."),           VOLATILE_FLINCHED},
    {COMPOUND_STRING("Attaccalite"),            VOLATILE_TORMENT},
    {COMPOUND_STRING("Pulviscoppio"),             VOLATILE_POWDER},
    {COMPOUND_STRING("Ricciolscudo"),        VOLATILE_DEFENSE_CURL},
    {COMPOUND_STRING("Ira"),               VOLATILE_RAGE},
    {COMPOUND_STRING("Destincomune"),        VOLATILE_DESTINY_BOND},
    {COMPOUND_STRING("Blocafuga"),   VOLATILE_ESCAPE_PREVENTION},
    {COMPOUND_STRING("Maledetto"),             VOLATILE_CURSED},
    {COMPOUND_STRING("Preveggenza"),          VOLATILE_FORESIGHT},
    {COMPOUND_STRING("Cuordrago"),        VOLATILE_DRAGON_CHEER},
    {COMPOUND_STRING("Focalenergia"),        VOLATILE_FOCUS_ENERGY},
    {COMPOUND_STRING("Caricavolt"),        VOLATILE_ELECTRIFIED},
    {COMPOUND_STRING("Fangata"),           VOLATILE_MUD_SPORT},
    {COMPOUND_STRING("Docciascudo"),         VOLATILE_WATER_SPORT},
    {COMPOUND_STRING("Confusione infinita"), VOLATILE_INFINITE_CONFUSION},
    {COMPOUND_STRING("Sale"),          VOLATILE_SALT_CURE},
    {COMPOUND_STRING("Punta su"),         VOLATILE_SYRUP_BOMB},
    {COMPOUND_STRING("Carica Lame"),        VOLATILE_GLAIVE_RUSH},
    {COMPOUND_STRING("Parassiseme"),         VOLATILE_LEECH_SEED},
    {COMPOUND_STRING("Occhiolino"),            VOLATILE_LOCK_ON},
    {COMPOUND_STRING("Ultimocanto"),        VOLATILE_PERISH_SONG},
    {COMPOUND_STRING("Minimizzato"),           VOLATILE_MINIMIZE},
    {COMPOUND_STRING("Sottocarica"),             VOLATILE_CHARGE_TIMER},
    {COMPOUND_STRING("Radici"),               VOLATILE_ROOT},
    {COMPOUND_STRING("Sbadiglio"),               VOLATILE_YAWN},
    {COMPOUND_STRING("Esclusiva"),           VOLATILE_IMPRISON},
    {COMPOUND_STRING("Rancore"),             VOLATILE_GRUDGE},
    {COMPOUND_STRING("Acidogastrico"),        VOLATILE_GASTRO_ACID},
    {COMPOUND_STRING("Divieto"),            VOLATILE_EMBARGO},
    {COMPOUND_STRING("Abbattimento"),         VOLATILE_SMACK_DOWN},
    {COMPOUND_STRING("Telecinesi"),        VOLATILE_TELEKINESIS},
    {COMPOUND_STRING("Miracolvista"),        VOLATILE_MIRACLE_EYE},
    {COMPOUND_STRING("Levitamagnete"),        VOLATILE_MAGNET_RISE},
    {COMPOUND_STRING("Anticura"),         VOLATILE_HEAL_BLOCK},
    {COMPOUND_STRING("Acquanello"),          VOLATILE_AQUA_RING},
    {COMPOUND_STRING("Fuoco Concentrato"),        VOLATILE_LASER_FOCUS},
    {COMPOUND_STRING("Raggiro-forza"),        VOLATILE_POWER_TRICK},
};

static const struct ListMenuItem sHazardsListItems[] =
{
    {COMPOUND_STRING("Punzoni"),       LIST_SIDE_SPIKES},
    {COMPOUND_STRING("Rete Vischiosa"),   LIST_SIDE_STICKY_WEB},
    {COMPOUND_STRING("Punzoni Tossici"), LIST_SIDE_TOXIC_SPIKES},
    {COMPOUND_STRING("Rocce Furtive"), LIST_SIDE_STEALTH_ROCK},
    {COMPOUND_STRING("Ferroscudo"),   LIST_SIDE_STEELSURGE},
};

static const struct ListMenuItem sSideStatusListItems[] =
{
    {COMPOUND_STRING("Riflesso"),          LIST_SIDE_REFLECT},
    {COMPOUND_STRING("Schermo Luce"),     LIST_SIDE_LIGHTSCREEN},
    {COMPOUND_STRING("Salvaguardia"),        LIST_SIDE_SAFEGUARD},
    {COMPOUND_STRING("Nebbia"),             LIST_SIDE_MIST},
    {COMPOUND_STRING("Ventoincoda"),         LIST_SIDE_TAILWIND},
    {COMPOUND_STRING("Velaurora"),      LIST_SIDE_AURORA_VEIL},
    {COMPOUND_STRING("Canto Fortunato"),      LIST_SIDE_LUCKY_CHANT},
    {COMPOUND_STRING("Danni Non-tipi"), LIST_SIDE_DAMAGE_NON_TYPES},
    {COMPOUND_STRING("Arcobaleno"),          LIST_SIDE_RAINBOW},
    {COMPOUND_STRING("Mare Fuoco"),      LIST_SIDE_SEA_OF_FIRE},
    {COMPOUND_STRING("Palude"),            LIST_SIDE_SWAMP},
};
...
static const struct ListMenuItem sAIListItems[] =
{
    ...
    {COMPOUND_STRING("Lotta in doppio"),              LIST_AI_DOUBLE_BATTLE},
    {COMPOUND_STRING("Bada ai PS"),                   LIST_AI_HP_AWARE},
    {COMPOUND_STRING("Stato potente"),            LIST_AI_POWERFUL_STATUS},
    {COMPOUND_STRING("Nega Imprudenza"),             LIST_AI_NEGATE_UNAWARE},
    {COMPOUND_STRING("Si sacrifica"),               LIST_AI_WILL_SUICIDE},
    {COMPOUND_STRING("Preferisci Status"),        LIST_AI_PREFER_STATUS_MOVES},
    {COMPOUND_STRING("Rallentatore"),                      LIST_AI_STALL},
    {COMPOUND_STRING("Cambi furbi"),            LIST_AI_SMART_SWITCHING},
    {COMPOUND_STRING("Asso"),                LIST_AI_ACE_POKEMON},
    {COMPOUND_STRING("Onnisciente"),                 LIST_AI_OMNISCIENT},
    {COMPOUND_STRING("Scelte POKéMON"),          LIST_AI_SMART_MON_CHOICES},
    {COMPOUND_STRING("Prudente"),               LIST_AI_CONSERVATIVE},
    {COMPOUND_STRING("Cambi in serie"),         LIST_AI_SEQUENCE_SWITCHING},
    {COMPOUND_STRING("Doppio Asso"),         LIST_AI_DOUBLE_ACE_POKEMON},
    {COMPOUND_STRING("Valuta abilità"),   LIST_AI_WEIGH_ABILITY_PREDICTION},
    {COMPOUND_STRING("Mossa più forte"), LIST_AI_PREFER_HIGHEST_DAMAGE_MOVE},
    {COMPOUND_STRING("Prevedi cambi"),             LIST_AI_PREDICT_SWITCH},
    {COMPOUND_STRING("Prevedi entrata"),       LIST_AI_PREDICT_INCOMING_MON},
    {COMPOUND_STRING("Dinamica"),               LIST_AI_DYNAMIC_FUNC},
    {COMPOUND_STRING("Errante"),                    LIST_AI_ROAMING},
    {COMPOUND_STRING("Safari"),                     LIST_AI_SAFARI},
    {COMPOUND_STRING("Prima lotta"),               LIST_AI_FIRST_BATTLE},
};

static const struct ListMenuItem sVariousListItems[] =
{
    {COMPOUND_STRING("Vedi PS"),       VARIOUS_SHOW_HP},
    {COMPOUND_STRING("PS Sostituto"), VARIOUS_SUBSTITUTE_HP},
    {COMPOUND_STRING("Infatuato"),       VARIOUS_IN_LOVE},
};
...
static void PutMovesPointsText(struct BattleDebugMenu *data)
{
    ...
    AddTextPrinterParameterized(data->aiMovesWindowId, FONT_NORMAL, COMPOUND_STRING("Punti/Danno"), 3, 0, 0, NULL);
    ...
    if (gAiLogicData->shouldSwitch & (1u << data->aiBattlerId))
    {
        ...
        AddTextPrinterParameterized3(data->aiMovesWindowId, FONT_NORMAL, 74, 79, sTextColorTable[COLORID_RED], 0, COMPOUND_STRING("Passo a "));
...
static const u8 sTextAll[] = _("Tutti");
...
static const u8 *const sHoldEffectNames[HOLD_EFFECT_COUNT] =
{
    ...
    [HOLD_EFFECT_RESTORE_HP]       = COMPOUND_STRING("Cura PS"),
    [HOLD_EFFECT_CURE_PAR]         = COMPOUND_STRING("Cura Paral"),
    [HOLD_EFFECT_CURE_SLP]         = COMPOUND_STRING("Cura Sonno"),
    [HOLD_EFFECT_CURE_PSN]         = COMPOUND_STRING("Cura Velen"),
    [HOLD_EFFECT_CURE_BRN]         = COMPOUND_STRING("Cura Ustio"),
    [HOLD_EFFECT_CURE_FRZ]         = COMPOUND_STRING("Cura Congel"),
    [HOLD_EFFECT_RESTORE_PP]       = COMPOUND_STRING("Riprist PP"),
    [HOLD_EFFECT_CURE_CONFUSION]   = COMPOUND_STRING("Cura Confus"),
    [HOLD_EFFECT_CURE_STATUS]      = COMPOUND_STRING("Cura Stato"),
    [HOLD_EFFECT_CONFUSE_SPICY]    = COMPOUND_STRING("Confus Picc"),
    [HOLD_EFFECT_CONFUSE_DRY]      = COMPOUND_STRING("Confus Secc"),
    [HOLD_EFFECT_CONFUSE_SWEET]    = COMPOUND_STRING("Confus Dolce"),
    [HOLD_EFFECT_CONFUSE_BITTER]   = COMPOUND_STRING("Confus Amar"),
    [HOLD_EFFECT_CONFUSE_SOUR]     = COMPOUND_STRING("Confus Aspr"),
    [HOLD_EFFECT_ATTACK_UP]        = COMPOUND_STRING("Attacco+"),
    [HOLD_EFFECT_DEFENSE_UP]       = COMPOUND_STRING("Difesa+"),
    [HOLD_EFFECT_SPEED_UP]         = COMPOUND_STRING("Veloc.+"),
    [HOLD_EFFECT_SP_ATTACK_UP]     = COMPOUND_STRING("Att. Sp.+"),
    [HOLD_EFFECT_SP_DEFENSE_UP]    = COMPOUND_STRING("Dif. Sp.+"),
    [HOLD_EFFECT_CRITICAL_UP]      = COMPOUND_STRING("Critico+"),
    [HOLD_EFFECT_RANDOM_STAT_UP]   = COMPOUND_STRING("Stat a caso+"),
    [HOLD_EFFECT_EVASION_UP]       = COMPOUND_STRING("Elusione+"),
    [HOLD_EFFECT_WHITE_HERB]       = COMPOUND_STRING("Ripristino"),
    [HOLD_EFFECT_MACHO_BRACE]      = COMPOUND_STRING("Peso Musc."),
    [HOLD_EFFECT_EXP_SHARE]        = COMPOUND_STRING("Quota Exp"),
    [HOLD_EFFECT_QUICK_CLAW]       = COMPOUND_STRING("Art Rapido"),
    [HOLD_EFFECT_FRIENDSHIP_UP]    = COMPOUND_STRING("Amicizia+"),
    [HOLD_EFFECT_MENTAL_HERB]      = COMPOUND_STRING("Erbe Mental"),
    [HOLD_EFFECT_CHOICE_BAND]      = COMPOUND_STRING("Bendascelta"),
    [HOLD_EFFECT_FLINCH]           = COMPOUND_STRING("Tent."),
    [HOLD_EFFECT_DOUBLE_PRIZE]     = COMPOUND_STRING("Premio x2"),
    [HOLD_EFFECT_REPEL]            = COMPOUND_STRING("Rep."),
    [HOLD_EFFECT_SOUL_DEW]         = COMPOUND_STRING("Rugiada"),
    [HOLD_EFFECT_DEEP_SEA_TOOTH]   = COMPOUND_STRING("Dente abissi"),
    [HOLD_EFFECT_DEEP_SEA_SCALE]   = COMPOUND_STRING("Squama abissi"),
    [HOLD_EFFECT_CAN_ALWAYS_RUN]   = COMPOUND_STRING("Fuggi sempre"),
    [HOLD_EFFECT_PREVENT_EVOLVE]   = COMPOUND_STRING("Blocca evoluzione"),
    [HOLD_EFFECT_FOCUS_BAND]       = COMPOUND_STRING("Fascia"),
    [HOLD_EFFECT_LUCKY_EGG]        = COMPOUND_STRING("Uovo Fortun"),
    [HOLD_EFFECT_SCOPE_LENS]       = COMPOUND_STRING("Lente"),
    [HOLD_EFFECT_LEFTOVERS]        = COMPOUND_STRING("Avanzi"),
    [HOLD_EFFECT_LIGHT_BALL]       = COMPOUND_STRING("Luce"),
    [HOLD_EFFECT_TYPE_POWER]       = COMPOUND_STRING("Potere Tipo"),
    [HOLD_EFFECT_SHELL_BELL]       = COMPOUND_STRING("Campanella"),
    [HOLD_EFFECT_LUCKY_PUNCH]      = COMPOUND_STRING("Pugno Fortuna"),
    [HOLD_EFFECT_METAL_POWDER]     = COMPOUND_STRING("Polvere Metal"),
    [HOLD_EFFECT_THICK_CLUB]       = COMPOUND_STRING("Osso Spesso"),
    [HOLD_EFFECT_LEEK]             = COMPOUND_STRING("Gambo"),
    [HOLD_EFFECT_CHOICE_SCARF]     = COMPOUND_STRING("Sciarpa"),
    [HOLD_EFFECT_CHOICE_SPECS]     = COMPOUND_STRING("Lenti"),
    [HOLD_EFFECT_DAMP_ROCK]        = COMPOUND_STRING("Roccia Umidità"),
    [HOLD_EFFECT_GRIP_CLAW]        = COMPOUND_STRING("Presartigli"),
    [HOLD_EFFECT_HEAT_ROCK]        = COMPOUND_STRING("Rocciacalda"),
    [HOLD_EFFECT_ICY_ROCK]         = COMPOUND_STRING("Rocciafredda"),
    [HOLD_EFFECT_LIGHT_CLAY]       = COMPOUND_STRING("Creta Luce"),
    [HOLD_EFFECT_SMOOTH_ROCK]      = COMPOUND_STRING("Roccialiscia"),
    [HOLD_EFFECT_POWER_HERB]       = COMPOUND_STRING("Vigorerba"),
    [HOLD_EFFECT_BIG_ROOT]         = COMPOUND_STRING("Granradice"),
    [HOLD_EFFECT_EXPERT_BELT]      = COMPOUND_STRING("Abilcintura"),
    [HOLD_EFFECT_LIFE_ORB]         = COMPOUND_STRING("Assorbisfera"),
    [HOLD_EFFECT_METRONOME]        = COMPOUND_STRING("Plessimetro"),
    [HOLD_EFFECT_MUSCLE_BAND]      = COMPOUND_STRING("Muscolbanda"),
    [HOLD_EFFECT_WIDE_LENS]        = COMPOUND_STRING("Grandelente"),
    [HOLD_EFFECT_WISE_GLASSES]     = COMPOUND_STRING("Saviocchiali"),
    [HOLD_EFFECT_ZOOM_LENS]        = COMPOUND_STRING("Zoomlente"),
    [HOLD_EFFECT_LAGGING_TAIL]     = COMPOUND_STRING("Rallentocoda"),
    [HOLD_EFFECT_FOCUS_SASH]       = COMPOUND_STRING("Focalnastro"),
    [HOLD_EFFECT_FLAME_ORB]        = COMPOUND_STRING("Fiammosfera"),
    [HOLD_EFFECT_TOXIC_ORB]        = COMPOUND_STRING("Tossicsfera"),
    [HOLD_EFFECT_STICKY_BARB]      = COMPOUND_STRING("Bendascura"),
    [HOLD_EFFECT_IRON_BALL]        = COMPOUND_STRING("Bendanera"),
    [HOLD_EFFECT_BLACK_SLUDGE]     = COMPOUND_STRING("Stolascelta"),
    [HOLD_EFFECT_DESTINY_KNOT]     = COMPOUND_STRING("Fascialotta"),
    [HOLD_EFFECT_SHED_SHELL]       = COMPOUND_STRING("Sciarpascelta"),
    [HOLD_EFFECT_QUICK_POWDER]     = COMPOUND_STRING("Pulviscoppio"),
    [HOLD_EFFECT_ADAMANT_ORB]      = COMPOUND_STRING("Sfera Decisa"),
    [HOLD_EFFECT_LUSTROUS_ORB]     = COMPOUND_STRING("Sfera Splendida"),
    [HOLD_EFFECT_GRISEOUS_ORB]     = COMPOUND_STRING("Sfera Grigia"),
    [HOLD_EFFECT_ENIGMA_BERRY]     = COMPOUND_STRING("Bacca Enigma"),
    [HOLD_EFFECT_RESIST_BERRY]     = COMPOUND_STRING("Bacca Resist"),
    [HOLD_EFFECT_POWER_ITEM]       = COMPOUND_STRING("Oggetto Pot."),
    [HOLD_EFFECT_RESTORE_PCT_HP]   = COMPOUND_STRING("Ripristino % PS"),
    [HOLD_EFFECT_MICLE_BERRY]      = COMPOUND_STRING("Bacca Micle"),
    [HOLD_EFFECT_CUSTAP_BERRY]     = COMPOUND_STRING("Bacca Custap"),
    [HOLD_EFFECT_JABOCA_BERRY]     = COMPOUND_STRING("Bacca Jaboca"),
    [HOLD_EFFECT_ROWAP_BERRY]      = COMPOUND_STRING("Bacca Rowap"),
    [HOLD_EFFECT_KEE_BERRY]        = COMPOUND_STRING("Bacca Kee"),
    [HOLD_EFFECT_MARANGA_BERRY]    = COMPOUND_STRING("Bacca Maranga"),
    [HOLD_EFFECT_PLATE]            = COMPOUND_STRING("Piastra"),
    [HOLD_EFFECT_FLOAT_STONE]      = COMPOUND_STRING("Pietrafluttuante"),
    [HOLD_EFFECT_EVIOLITE]         = COMPOUND_STRING("Evolcondensa"),
    [HOLD_EFFECT_ASSAULT_VEST]     = COMPOUND_STRING("Corazza"),
    [HOLD_EFFECT_DRIVE]            = COMPOUND_STRING("Modulo"),
    [HOLD_EFFECT_GEMS]             = COMPOUND_STRING("Gemme"),
    [HOLD_EFFECT_ROCKY_HELMET]     = COMPOUND_STRING("Elmetto Roccia"),
    [HOLD_EFFECT_AIR_BALLOON]      = COMPOUND_STRING("Pallone"),
    [HOLD_EFFECT_RED_CARD]         = COMPOUND_STRING("Cartellino Rosso"),
    [HOLD_EFFECT_RING_TARGET]      = COMPOUND_STRING("Anello"),
    [HOLD_EFFECT_BINDING_BAND]     = COMPOUND_STRING("Fascia"),
    [HOLD_EFFECT_EJECT_BUTTON]     = COMPOUND_STRING("Pulsante Fuga"),
    [HOLD_EFFECT_ABSORB_BULB]      = COMPOUND_STRING("Radice"),
    [HOLD_EFFECT_CELL_BATTERY]     = COMPOUND_STRING("Cellula"),
    [HOLD_EFFECT_MEGA_STONE]       = COMPOUND_STRING("Megapietra"),
    [HOLD_EFFECT_SAFETY_GOGGLES]   = COMPOUND_STRING("Visierasalva"),
    [HOLD_EFFECT_LUMINOUS_MOSS]    = COMPOUND_STRING("Muschio"),
    [HOLD_EFFECT_SNOWBALL]         = COMPOUND_STRING("Palla di neve"),
    [HOLD_EFFECT_WEAKNESS_POLICY]  = COMPOUND_STRING("Debolezza"),
    [HOLD_EFFECT_PRIMAL_ORB]       = COMPOUND_STRING("Orbe Primal"),
    [HOLD_EFFECT_PROTECTIVE_PADS]  = COMPOUND_STRING("Protezione"),
    [HOLD_EFFECT_TERRAIN_EXTENDER] = COMPOUND_STRING("Campo+"),
    [HOLD_EFFECT_TERRAIN_SEED]     = COMPOUND_STRING("Semi"),
    [HOLD_EFFECT_ADRENALINE_ORB]   = COMPOUND_STRING("Orbe Adrenalina"),
    [HOLD_EFFECT_MEMORY]           = COMPOUND_STRING("Memoria"),
    [HOLD_EFFECT_Z_CRYSTAL]        = COMPOUND_STRING("Cristallo"),
    [HOLD_EFFECT_UTILITY_UMBRELLA] = COMPOUND_STRING("Ombrello"),
    [HOLD_EFFECT_EJECT_PACK]       = COMPOUND_STRING("Kit Fuga"),
    [HOLD_EFFECT_ROOM_SERVICE]     = COMPOUND_STRING("Servizio"),
    [HOLD_EFFECT_BLUNDER_POLICY]   = COMPOUND_STRING("Distrazione"),
    [HOLD_EFFECT_HEAVY_DUTY_BOOTS] = COMPOUND_STRING("Stivali Pesanti"),
    [HOLD_EFFECT_THROAT_SPRAY]     = COMPOUND_STRING("Gola Spray"),
    [HOLD_EFFECT_ABILITY_SHIELD]   = COMPOUND_STRING("Scudo Abilità"),
    [HOLD_EFFECT_CLEAR_AMULET]     = COMPOUND_STRING("Amuleto Puro"),
    [HOLD_EFFECT_MIRROR_HERB]      = COMPOUND_STRING("Erbe Specchio"),
    [HOLD_EFFECT_PUNCHING_GLOVE]   = COMPOUND_STRING("Guanti Tirapugni"),
    [HOLD_EFFECT_COVERT_CLOAK]     = COMPOUND_STRING("Manto Furtivo"),
    [HOLD_EFFECT_LOADED_DICE]      = COMPOUND_STRING("Dadi Truccati"),
    [HOLD_EFFECT_BOOSTER_ENERGY]   = COMPOUND_STRING("Energia Booster"),
    [HOLD_EFFECT_OGERPON_MASK]     = COMPOUND_STRING("Maschera Ogerpon"),
    [HOLD_EFFECT_BERSERK_GENE]     = COMPOUND_STRING("Gene Furore"),
};
