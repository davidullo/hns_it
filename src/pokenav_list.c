...
static const u8 gText_PokenavMatchCall_Strategy[] = _("STRATEGIA");
static const u8 gText_PokenavMatchCall_TrainerPokemon[] = _("POKéMON ALLENATORE");
static const u8 gText_PokenavMatchCall_SelfIntroduction[] = _("AUTOPRESENTAZIONE");
