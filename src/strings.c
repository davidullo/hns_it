...
const u8 gText_EggNickname[POKEMON_NAME_LENGTH + 1] = _("UOVO BOLLITO");
...
const u8 gText_Jam[] = _("CONFETTURA DI BOSCO");
...
const u8 gText_Decorate[] = _("DECORAZIONE");
...
const u8 gText_Powder[] = _("PULVISCOPPIO");
...
const u8 gText_MoveRelearnerJam[] = _("CONFETTURA DI BOSCO");
